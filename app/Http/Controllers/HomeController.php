...
//            }
    ...
    public function sendConversionApiFB(Request $request) {
        ...
        if($domain === "dailysharkpena.com") {
            ...
            $token = 'EAAOuqmKBZBMMBAOM6SN5PpM1ZCOwI31QwCybbdxn6l0TXrOTU93BfnvSaxI1IZCxStTFxN3WisBHK5y6wgZCitFaaZBTzZB80B2Gp0T5fc8ZCIGuNNoN87SDJZBnsVo7ZCoBVBES2u8IqwmZCKmaciZCtyukd2HlBPgu6VjRUBatKyWjhg1A1uO4ORp';
        }
