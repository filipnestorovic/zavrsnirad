...
//     var i = '<div class="cd__tile"><div class="cd__time-wrapper"><div class="cd__time"><div class="cd__time-number">' + hours.substr(0, 1) + '</div></div><div class="cd__time"><div class="cd__time-number">' + hours.substr(1, 1) + '</div></div></div><div class="cd__label">Ð§Ð°ÑÐ¾Ð²</div></div>',
//         s = '<div class="cd__tile"><div class="cd__time-wrapper"><div class="cd__time"><div class="cd__time-number">' + minutes.substr(0, 1) + '</div></div><div class="cd__time"><div class="cd__time-number">' + minutes.substr(1, 1) + '</div></div></div><div class="cd__label">ÐœÐ¸Ð½ÑƒÑ‚</div></div>',
//         n = '<div class="cd__tile"><div class="cd__time-wrapper"><div class="cd__time"><div class="cd__time-number">' + seconds.substr(0, 1) + '</div></div><div class="cd__time"><div class="cd__time-number">' + seconds.substr(1, 1) + '</div></div></div><div class="cd__label">Ð¡ÐµÐºÑƒÐ½Ð´</div></div>';
...
! function(t) {
    ...
    function(t, e, i) {
        ...
        s.prototype.init = function() {
            ...
            })), i = r + "_icon", "" === a.label && (i += " " + r + "_no-text"), "a" == a.parentTag && (a.parentTag = 'a href="#scroll-des"'), n.mobileNav.attr("class", r + "_nav"), s = t('<div class="' + r + '_menu"></div>'), "" !== a.brand) {
...
$(function(){
    $('a[href^="#scroll-"]:not([href="#scroll-des"]').click(function (){
