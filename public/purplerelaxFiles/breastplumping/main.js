(function($) {
    ...
    Landing.prototype.initEvents = function() {
        ...
        $('.menu').click(function() {
            $('.menu-true').toggleClass('show');
        });

        $('.menu1').click(function() {
            $('.dop-menu').toggleClass('fade');
        });


        $('#show-otz').click(function() {
            $('.open-otz').css('display', 'block');
            $('#show-otz').css('display', 'none');
        });
        ...
        $('.lips-menu').addClass('animated fadeInDown');
