$(document).ready(function () {
    var butIn = $(".detail .butIn");
    var butOut = $(".detail .butOut");
    var list = $(".detail ol");
    ...
    var butInX = $(".garant .butIn");
    var butOutX = $(".garant .butOut");
    var listX = $(".glist");
    var garant = $(".garant");
    butInX.click(function () {
        garant.addClass("active");
        listX.slideDown();
        butInX.hide();
        butOutX.show();
        return false;
    });
    butOutX.click(function () {
        garant.removeClass("active");
        listX.slideUp();
        butInX.show();
        butOutX.hide();
        return false;
    });
    var swiper = new Swiper(".swiper-container", { pagination: ".swiper-pagination", paginationClickable: true, nextButton: ".swiper-button-next", prevButton: ".swiper-button-prev", spaceBetween: 30 });
