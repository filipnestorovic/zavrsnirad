...
{{--                                <div class="step-title js-customer-title">--}}
{{--                                    <h2 class="title">--}}
{{--                                        Korak 3: <strong>Online plaćanje</strong>--}}
{{--                                    </h2>--}}
{{--                                </div>--}}
...
{{--<script>--}}
{{--    var stripe = Stripe('pk_test_51L0ODfCEzic3CBJLvmxMigP5Df56AdeyFt2tCdRTbSrxAjdabF3pF8D1XThCU3DpZxHSYqPUbIBOhnM15YX5ZaOX006vNwSxbF');--}}
...
<body>
<form action="{{$orderRoute}}" method="post" id="payment-form" style="width: 300px;">
    @csrf
    <div class="form-row">
        <div id="card-element" style="height: 50px;">
            <!-- a Stripe Element will be inserted here. -->
        </div>
        <!-- Used to display form errors -->
        <div id="card-errors"></div>
