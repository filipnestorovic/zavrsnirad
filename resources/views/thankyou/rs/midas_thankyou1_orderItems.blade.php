...
<script>!function(){if(window.midasPixel)midasPixel.setConversion();else var e=0,i=setInterval( function(){if(window.midasPixel)return clearInterval(i),void midasPixel.setConversion(); e>100&&clearInterval(i),e++},50)}();</script>
</body>
</html>
