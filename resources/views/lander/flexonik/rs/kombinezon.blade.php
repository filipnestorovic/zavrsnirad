...
<head>
    ...
    <style>
        ...
        .top-block-v2{
            padding: 432px 0 0;
            background: url('{{ asset('/') }}flexonikFiles/kombinezon/top-block-v2.jpg') 50% 0 no-repeat;
        }
    </style>
</head>
<body>
<div class="main-wrap">
    ...
    <section class="title-block">
        <div class="sub-main-title">NOSITE I MRŠAVITE <br>KOMBINEZON ZA SAGOREVANJE MASTI</div>
        <h1 class="main-title">Hot Shapers</h1>
    </section>
    ...
    <section class="sup-block-v3 benefits1_section">
        <h2 class="lvl-title">HOT SHAPERS <br/>SE PREPORUČUJE <br/>UKOLIKO:</h2>
        <ul class="sup-cont clearfix">
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/sup-block-v3_1.jpg" alt="Hot Shapers">
                <p>Želite lepu figuru u najkraćem mogućem roku</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/sup-block-v3_2.jpg" alt="Hot Shapers">
                <p>Odlučili ste da dovedete svoje telo do savršenstva bez izgladnjivanja i dijeta</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/sup-block-v3_3.jpg" alt="Hot Shapers">
                <p>Hoćete da imate idealnu kilažu</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/sup-block-v3_4.jpg" alt="Hot Shapers">
    ...
    <section class="detail-block about_section">
        <h2 class="lvl-title">HOT SHAPERS KOMBINEZON ZA SAGOREVANJE MASTI</h2>
        <div class="text-cont">
            <p>Posebno je dizajniran za <b>siguran i brz</b> gubitak težine.</p>
            <p>Hot Shapers Kombinezon za sagorevanje masti dobro pristaje vašem telu,
            ...
            <p>Ova akcija izaziva povećanje znojenja, i to <b>do 4 puta više</b> nego u
                ...
                i toksina.</p>
            <img src="{{ asset('/') }}flexonikFiles/kombinezon/pic-1.jpg" alt="Hot Shapers">
        </div>
    </section>

    <!-- -v2 -->
    <section class="sup-block-v2">
        <h2 class="lvl-title">EFIKASNOST KOMBINEZONA <br/> HOT SHAPERS</h2>
    ...
    <section class="sup-block-v3 use_section">
        <h2 class="lvl-title">KADA I GDE MOŽE DA SE KORISTI HOT SHAPERS KOMBINEZON?</h2>
        <ul class="sup-cont clearfix">
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/use1.jpg" alt="Hot Shapers">
                <p>ODMOR</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/use2.jpg" alt="Hot Shapers">
                <p>KUĆNI POSLOVI</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/use3.jpg" alt="Hot Shapers">
                <p>ŠOPING</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/use4.jpg" alt="Hot Shapers">
                <p>TRČANJE</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/use5.jpg" alt="Hot Shapers">
                <p>FITNES</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/use6.jpg" alt="Hot Shapers">
                <p>ČUVANJE DECE</p>
            </li>
        </ul>
    ...
    <section class="delivery-block-v1">
        <h2 class="lvl-title">KAKO PORUČITI <br/> HOT SHAPERS KOMBINEZON?</h2>
    ...
    <section class="rev-block-v3">
        ...
        <div class="rev-cont clearfix">
            <div class="rev-item">
                <img src="{{ asset('/') }}naturapharmFiles/korset/rev-block-v3_1.jpg" alt="Hot Shapers">
            ...
            <div class="rev-item">
                <img src="{{ asset('/') }}naturapharmFiles/korset/rev-block-v3_2.jpg" alt="Hot Shapers">
                <h4>Boriša Gavrić , 31 godina</h4>
                <p>Kupio sam kombinezon za svoju suprugu, jer je dugo pokušavala da izgubi kilograme.
            ...
            <div class="rev-item">
                <img src="{{ asset('/') }}naturapharmFiles/korset/rev-block-v3_3.jpg" alt="Hot Shapers">
                <h4>Dragana Marković, 29 godina</h4>
                <p>Kombinezon je isporučen 2 dana nakon što sam ga poručila. Koristim ga već 9 nedelja. Nosim ga gde god je to moguće – u šetnji sa detetom, kod kuće, na trčanju.
