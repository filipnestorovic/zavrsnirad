...
<head>
    ...
    <style>
        ...
        .top-block-v2{
            padding: 432px 0 0;
            background: url('{{ asset('/') }}flexonikFiles/tummytuck/top-block-v2.png') 50% 0 no-repeat;
        }
    </style>
</head>
<body>
...
<!-- -v2 -->
    <section class="title-block">
        ...
        <h1 class="main-title">Tummy Tuck</h1>
    </section>
    ...
    <section class="sup-block-v3 benefits1_section">
        <h2 class="lvl-title">TUMMY TUCK <br/>SE PREPORUČUJE <br/>UKOLIKO:</h2>
        <ul class="sup-cont clearfix">
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/sup-block-v3_1.jpg" alt="Tummy Tuck">
                <p>Želite lepu figuru u najkraćem mogućem roku</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/sup-block-v3_2.jpg" alt="Tummy Tuck">
                <p>Odlučili ste da dovedete svoje telo do savršenstva bez izgladnjivanja i dijeta</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/sup-block-v3_3.jpg" alt="Tummy Tuck">
                <p>Hoćete da imate idealnu kilažu</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/sup-block-v3_4.jpg" alt="Tummy Tuck">
    ...
    <section class="detail-block about_section">
        <h2 class="lvl-title">TUMMY TUCK POJAS ZA SAGOREVANJE MASTI</h2>
        <div class="text-cont">
            <p>Posebno je dizajniran za <b>siguran i brz</b> gubitak težine.</p>
            <p>Tummy Tuck za sagorevanje masti dobro pristaje vašem telu,
            ...
            <p>Ova akcija izaziva povećanje znojenja, i to <b>do 4 puta više</b> nego u
                ...
                i toksina.</p>
            <img src="{{ asset('/') }}flexonikFiles/tummytuck/pic-1.png" alt="Tummy Tuck">
        </div>
    </section>

    <!-- -v2 -->
    <section class="sup-block-v2">
        <h2 class="lvl-title">EFIKASNOST POJASA <br/> TUMMY TUCK</h2>
    ...
    <section class="sup-block-v3 use_section">
        <h2 class="lvl-title">KADA I GDE MOŽE DA SE KORISTI TUMMY TUCK?</h2>
        <ul class="sup-cont clearfix">
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/use1.jpg" alt="Tummy Tuck">
                <p>ODMOR</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/use2.jpg" alt="Tummy Tuck">
                <p>KUĆNI POSLOVI</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/use3.jpg" alt="Tummy Tuck">
                <p>ŠOPING</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/use4.jpg" alt="Tummy Tuck">
                <p>TRČANJE</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/use5.jpg" alt="Tummy Tuck">
                <p>FITNES</p>
            </li>
            <li>
                <img src="{{ asset('/') }}naturapharmFiles/korset/use6.jpg" alt="Tummy Tuck">
                <p>ČUVANJE DECE</p>
            </li>
        </ul>
    ...
    <section class="delivery-block-v1">
        <h2 class="lvl-title">KAKO PORUČITI <br/> TUMMY TUCK?</h2>
    ...
    <section class="rev-block-v3">
        ...
        <div class="rev-cont clearfix">
            <div class="rev-item">
                <img src="{{ asset('/') }}naturapharmFiles/korset/rev-block-v3_1.jpg" alt="Tummy Tuck">
            ...
            <div class="rev-item">
                <img src="{{ asset('/') }}naturapharmFiles/korset/rev-block-v3_2.jpg" alt="Tummy Tuck">
                <h4>Boriša Gavrić , 31 godina</h4>
                <p>Kupio sam ovo za svoju suprugu, jer je dugo pokušavala da izgubi kilograme.
            ...
            <div class="rev-item">
                <img src="{{ asset('/') }}naturapharmFiles/korset/rev-block-v3_3.jpg" alt="Tummy Tuck">
                <h4>Dragana Marković, 29 godina</h4>
                <p>Tummy tuck je isporučen 2 dana nakon što sam ga poručila. Koristim ga već 9 nedelja. Nosim ga gde god je to moguće – u šetnji sa detetom, kod kuće, na trčanju.
