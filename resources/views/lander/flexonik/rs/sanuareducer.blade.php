...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/') }}flexonikFiles/sanuareducer/styles.css">
    <script>
...
<header class="offer_section offer_top">
    <div class="wrapper clearfix">
        <div class="title_block">
            <h1 class="main_title">SANUA REDUCER</h1>
            <p class="subtitle">POJAS ZA TOPLJENJE <br> MASNIH NASLAGA</p>
        </div>
        <img class="mobile_product" src="{{ asset('/') }}flexonikFiles/sanuareducer/mobile__offer_product.png" alt="Vibroaction">
        <ul class="benefits_list">
            <li>SMANJUJE <span> STRUK</span></li>
            <li>OSLOBAĐA <span> VIŠKA TEŽINE</span></li>
            <li>ČINI FIGURU <span> ZGODNOM I <br>PRIVLAČNOM</span></li>
        </ul>
...
<section class="about_section">
    <div class="wrapper clearfix">
        <img src="{{ asset('/') }}flexonikFiles/sanuareducer/about__image.jpg" alt="Vibroaction">
        <div class="content_block">
            <h2>JEDINSTVENI POJAS ZA TOPLJENJE <span>MASNIH NASLAGA</span></h2>
            <p><b>Sanua Reduce je neizostavan proizvod koji pomaže smanjenju struka, zadnjice i bokova.</b></p>
            <p>Koristeći ga, mogu se sagoreti masti čak i bez intenzivnog treninga. Pojas će učiniti da se mišići zategnu bolje nego na bilo kojoj spravi u teretani.</p>
            <p>Proizvođači su obezbedili 2 različita režima:</p>
            <ul>
                <li>1. Automatski režim ima <span>4 različita predefinisana programa</span> koje možete da birate</li>
                <li>2. Manuelni režim u kome sami možete da podešavate <b>temperaturu zagrevanja</b></li>
            </ul>
            <p>Specijalno dizajnirani kaiševi olakšavaju nošenje i učvršćivanje na telo. Može se staviti za nekoliko sekundi i spreman je za upotrebu bilo gde:</p>
            <ul>
                <li>Na poslu</li>
                <li>Kod kuće</li>
                <li>U šetnji</li>
...
<section class="benefits_section">
    <div class="wrapper">
        ...
        <div class="benefits_block">
            <img src="{{ asset('/') }}flexonikFiles/sanuareducer/benefits__image.jpg" alt="Vibroaction">
            <ul>
                <li>Tehnologija dvostruke kompresije - čvrsto obavija leđa, struk i stomak</li>
                <li>Ne steže mišiće zahvaljujući visokotehnološkom materijalu</li>
                <li>Može se koristiti na različitim delovima tela, ležeći, sedeći za računarom ili bilo kom drugom položaju</li>
                <li>Inovativni materijal obezbeđuje dobru ventilaciju</li>
                <li>Temperatura je podesiva, a vi sami birate željenu temperaturu</li>
                <li>Nežan je prijatan na koži</li>
            </ul>
        </div>
        <a href="#order_form" class="button">Poručite sada</a>
    </div>
...
<section class="use_section">
    <div class="wrapper">
        <h2>ZAŠTO LJUDI ŠIROM SVETA KORISTE <span>SANUA REDUCE POJAS?</span></h2>
        <div class="use_list clearfix">
            <div class="use_item">
                <div class="image_block">
                    <img src="{{ asset('/') }}flexonikFiles/sanuareducer/use__use1_image.jpg" alt="Vibroaction">
                    <p>POSLE TRUDNOĆE</p>
                </div>
                <div class="text_block">
                    <ul>
                        <li>Skida višak masnih naslaga</li>
                        <li>Zateže kožu</li>
                    </ul>
                </div>
            </div>
            <div class="use_item">
                <div class="image_block">
                    <img src="{{ asset('/') }}flexonikFiles/sanuareducer/use__use2_image.jpg" alt="Vibroaction">
                    <p>RAD U SEDEĆEM POLOŽAJU</p>
                </div>
                <div class="text_block">
                    <ul>
                        <li>Eliminiše celulit</li>
                        <li>Topi višak koji se stvara na butinama, zadnjici i stomaku</li>
                    </ul>
                </div>
            </div>
            <div class="use_item">
                <div class="image_block">
                    <img src="{{ asset('/') }}flexonikFiles/sanuareducer/use__use3_image.jpg" alt="Vibroaction">
    ...
    <div class="wrapper">
        ...
        <div class="steps_list clearfix">
            <div class="step_item">
                ...
                <img src="{{ asset('/') }}flexonikFiles/sanuareducer/order_steps__step1_image.jpg" alt="Vibroaction">
                <h4>PORUČITE</h4>
                <p>Ostavite vaše podatke na našem sajtu i smatrajte da ste poručili proizvod.</p>
            </div>
            <div class="step_item">
                <div class="number">2</div>
                <img src="{{ asset('/') }}flexonikFiles/sanuareducer/order_steps__step2_image.jpg" alt="Vibroaction">
                <h4>KONTATIRAĆEMO VAS</h4>
                <p>Naš tim za komunikaciju sa kupcima će vas kontaktirati da potvri porudžbinu.</p>
            </div>
            <div class="step_item">
                <div class="number">3</div>
                <img src="{{ asset('/') }}flexonikFiles/sanuareducer/order_steps__step3_image.jpg" alt="Vibroaction">
                <h4>ISPORUKA</h4>
    ...
    <div class="wrapper">
        ...
        <div class="reviews_list">
            <div class="review_item clearfix">
                <div class="image_block">
                    <img src="{{ asset('/') }}flexonikFiles/sanuareducer/reviews__review1_photo.jpg" alt="Vibroaction">
                </div>
                <div class="text_block">
                    <h4>TATJANA NIKOLIĆ, 29 GODINA</h4>
                    <p>Kada sam sa 27 godina rodila drugo dete, nisam se više nadala da ću vratiti nekadašnju figuru.
                        Pre par meseci došao je prijatelj iz Nemačke i rekao da većina devojaka tamo nosi Sanua Reducer pojas.
                        Otišla sam na vaš sajt i pročitala sve o proizvodu. Nažalost, tada nije bio nikakav popust ali sam ga kupila po punoj ceni i nisam se pokajala.
                        Već sutradan mi je stigao pojas i odmah sam počela da ga koristim. Za manje od mesec dana bila sam prezadovoljna mojom figurom. Koristila sam i na zadnjici koja se zategla i podigla.
                        <br/>PREPORUČUJEM SVIMA KUPOVINU OVOG PROIZVODA!</p>
                </div>
            </div>
            <div class="review_item clearfix">
                <div class="image_block">
                    <img src="{{ asset('/') }}flexonikFiles/sanuareducer/reviews__review2_photo.jpg" alt="Vibroaction">
                </div>
                <div class="text_block">
                    ...
                    <p>Dugo sam sanjala o tankom struku koji će poželeti da zagrli svaki muškarac. Pokušavala sam sa raznim dijetama i izgladnjivanjima ali efekat je bio loš.
                        Iskočila mi je reklama za Sanua Reduce pojas i rekoh da pokušam. Moj struk nakon 20 dana korišćenja je bio WOW. Savršeno zategnut stomak, konačno mi se vide i pločice na stomaku.
                        Moj dečko obožava moj novi struk. :)</p>
                </div>
            </div>
            <div class="review_item clearfix">
                <div class="image_block">
                    <img src="{{ asset('/') }}flexonikFiles/sanuareducer/reviews__review3_photo.jpg" alt="Vibroaction">
                </div>
                <div class="text_block">
                    <h4>DARIJA BOGDANOVIĆ, 41 GODINA</h4>
                    <p>PO PRVI PUT MOGU DA BIRAM MUŠKARCA ZAHVALJUJUĆI SAVRŠENOM STRUKU. <br/>
                        Ovaj pojas je Božji dar. Stavite ga i figura se trenutno transformiše. Nosim ga već drugi mesec i rezultat je neverovatan.
                        Struk mi je postao uzak, stomak se smanjio a grudi došle do izražaja. Objavila sam sliku na drušvene mreže i zatrpavaju me poruke od udvarača, koje su mi moram priznati ranije mnogo nedostajale.</p>
                </div>
            </div>
        </div>
    </div>
