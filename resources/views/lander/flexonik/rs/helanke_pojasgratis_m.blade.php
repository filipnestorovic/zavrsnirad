...
<div class="main-wrap">
    ...
    <div class="section block-1">
        ...
        <div style="font-family: 'Montserrat Black', sans-serif; font-size: 27px; margin-bottom: 20px; text-align: center;"><span style="color: #ff4e00">+ VRUĆI POJAS </span><span style="color: #ff0000">GRATIS</span></div>
        <div class="container-2">
            <div class="center"><a href="#order" class="button-m"></a></div>
        </div>
    </div>
    <div class="section block-2">
        <h2>Efikasnost<br><span>helanki</span></h2>
        <div class="container">
            <ul>
                <li>
                    <h4>Povećavaju znojenje <span>4 puta</span></h4>
                    <p>Smanjiće masne naslage na nepotrebnim mestima, a mišići će postati istaknutiji.</p>
                </li>
                <li>
                    <h4>Napravljene su od <span>NEOTEX tkanine</span></h4>
                    <p>čiji unutrašnji sloj pojačava rad znojnih žlezda, a spoljašnji sloj upija znoj sprečavajući vlaženje tkanine.</p>
                </li>
                <li>
                    <h4><span>Udobne</span> u svakodnevnom životu</h4>
                    <p>Nevidljive su ispod odeće, ne propuštaju znoj i ne ostavljaju tragove na telu.</p>
                </li>
            </ul>
            <h3>ZATEGNUTA ZADNJICA I KUKOVI ZA SAMO MESEC DANA!</h3>
        </div>
    </div>
    <div class="section block-3">
        <h2>KADA NOSITI VRUĆE HELANKE:</h2>
        <div class="container"></div>
    </div>
    <div class="section block-4">
        <h2><span>VRUĆE HELANKE</span><br>VAM TREBAJU UKOLIKO:</h2>
        <div class="container">
            <div class="clearfix">
                <div class="elem-item">
    ...
    <div class="section block-5" >
        <div class="container">
            ...
            <div class="center"><a href="#order" class="button-m"></a></div>
            <div style="font-family: 'Montserrat Black', sans-serif; font-size: 27px; margin-top: 20px; text-align: center;"><span style="color: #ff4e00">+ VRUĆI POJAS </span><span style="color: #ff0000">GRATIS</span></div>
        </div>
    </div>
    <div class="section block-7">
        <h2>Utisci kupaca<br><span> ovog pojasa</span></h2>
        <div class="container">
            <div class="rev rev-1">
            ...
            <div class="rev rev-2">
                <div class="rev-pic"></div>
                <p class="rev-title">Bojan Popović , 42 godine</p>
                <p class="rev-text">Kupio sam joj vruće helanke, jer je dugo pokušavala da izgubi kilograme. Imao sam sreću da sam proizvod kupio sa popustom, ona je izgubila kilograme i srećna je kao nikada do sada, a i ja sa njom! Hvala Vam!</p>
            </div>
            <div class="rev rev-3">
                <div class="rev-pic"></div>
                <p class="rev-title">Jelena Popović, 30 godina</p>
                <p class="rev-text">Vruće helanke su isporučene 2 dana nakon što sam ih poručila. Koristim ih već 8 nedelja. Nosim ih gde god je to moguće – u šetnji sa detetom, kod kuće, na trčanju. Rezultat je kao što i sami vidite. Obim kukova mi je uži za 14 centimetara. Ne želim da stanem na ovome, nastaviću da ih nosim.</p>
            </div>
            <div style="text-align:center; margin-top:50px;">
                <img style="display:inline-block; vertical-align:top;" src="{{ asset('/') }}flexonikFiles/hotshaper/conversation4.png">
                <br><br>
                <img style="display:inline-block; vertical-align:top;" src="{{ asset('/') }}flexonikFiles/hotshaper/conversation3.png">
                <br><br>
            </div>
        </div>
    </div>
    ...
    <div class="section block-1" >
        ...
        <div style="font-family: 'Montserrat Black', sans-serif; font-size: 27px; text-align: center;"><span style="color: #ff4e00">+ VRUĆI POJAS </span><span style="color: #ff0000">GRATIS</span></div>
