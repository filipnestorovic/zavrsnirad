...
<div class="main-wrap">
    ...
    <section class="top-block-v2">
        ...
        <div class="describe-cont">
            {{--<div class="timer-cont">--}}
                {{--<h3>TEMPO ATÉ O FINAL DA PROMOÇÃO:</h3>--}}
    ...
    <section class="detail-block about_section">
        <h2 class="lvl-title">HOT SHAPERS KORSET ZA SAGOREVANJE MASTI</h2>
        <div class="text-cont">
            <p>Posebno je dizajniran za <b>siguran i brz</b> gubitak težine.</p>
            <p>Hot Shapers korset za sagorevanje masti dobro pristaje vašem telu,
            ...
            <p>Ova akcija izaziva povećanje znojenja, i to <b>do 4 puta više</b> nego u
                ...
                i toksina.</p>
            <img src="{{ asset('/') }}naturapharmFiles/korset/pic-1.jpg" alt="Hot Shapers">
        </div>
    </section>

    <!-- -v2 -->
    <section class="sup-block-v2">
        <h2 class="lvl-title">EFIKASNOST KORSETA <br/> HOT SHAPERS</h2>
    ...
    <section class="sup-block-v3 use_section">
        <h2 class="lvl-title">KADA I GDE MOŽE DA SE KORISTI HOT SHAPERS KORSET?</h2>
        <ul class="sup-cont clearfix">
            <li>
    ...
    <section class="delivery-block-v1">
        <h2 class="lvl-title">KAKO PORUČITI <br/> HOT SHAPERS KORSET?</h2>
