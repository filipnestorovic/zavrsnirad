...
<div class="s__main">
    ...
    <section class="block3">
        <div>
            <h2 class="title">POGLEDAJTE KAKO RADI EMS TRENAŽER</h2>
            <div class="video-wrap">
                <video controls webkit-playsinline loop controlsList="nodownload">
                    <source src="{{ asset('/') }}flexonikFiles/ems/ems-video.mp4" type="video/mp4">
                </video>
                <div class="playpause">
