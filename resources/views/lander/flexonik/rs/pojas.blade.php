...
<head>
    ...
    <link rel="icon" href="{{ asset('/') }}flexonikFiles/pojas/favicon.ico" type="image/x-icon">
    <link rel="stylesheet" href="{{ asset('/') }}flexonikFiles/pojas/css1.css"/>
    <link href="{{ asset('/') }}flexonikFiles/pojas/css2.css" rel="stylesheet" type="text/css"/>
    ...
    <script src="{{ asset('/') }}flexonikFiles/pojas/slider.js"></script>
...
<div class="block-2" id="about">
    <div class="container clearfix">
        ...
        <div class="fact">
            <img src="{{ asset('/') }}flexonikFiles/pojas/fact-1.png" alt=""/>
            <p>Ubrzava metabolizam</p>
        </div>
        <div class="fact">
            <img src="{{ asset('/') }}flexonikFiles/pojas/roundx4.png" alt=""/>
            <p>4 puta brže uklanja višak vode iz tela</p>
        </div>
        <div class="fact">
            <img src="{{ asset('/') }}flexonikFiles/pojas/fact-3.png" alt=""/>
            <p>Sagorevajte 72% više masti tokom treninga</p>
        </div>
        <div class="fact">
            <img src="{{ asset('/') }}flexonikFiles/pojas/fact-4.png" alt=""/>
            <p>Redovnom upotrebom daje 100% rezultat (i do minus 6 kilograma mesečno)!</p>
        </div>
        <div class="fact">
            <img src="{{ asset('/') }}flexonikFiles/pojas/round2w.png" alt=""/>
...
<div class="block-3">
    <div class="container">
        ...
        <div class="questions clearfix">
            <div class="left">
                <div>
                    <img src="{{ asset('/') }}flexonikFiles/pojas/pregnant.png" alt="Hot Shapers" class="icon" />
                    <p>
                        Kako zategnuti stomak nakon porođaja?
                    </p>
                </div>
                <div>
                    <img src="{{ asset('/') }}flexonikFiles/pojas/medicine.png" alt="Hot Shapers" class="icon" />
                    <p>
                        Kako brzo smršati bez dijeta i tableta?
                    </p>
                </div>
                <div>
                    <img src="{{ asset('/') }}flexonikFiles/pojas/4kg.png" class="icon" />
                    <p>
                        Kako skinuti poslednja, najteža, 2-3-4 kilograma?
                    </p>
                </div>
                <div>
                    <img src="{{ asset('/') }}flexonikFiles/pojas/question.png" alt="Hot Shapers" class="icon" />
                    <p>
            ...
            <div class="right">
                <div>
                    <img src="{{ asset('/') }}flexonikFiles/pojas/health.png" alt="Hot Shapers" class=icon />
                    <p>
                        Zašto sačuvati zdravlje izbacivanjem toksina iz tela?
                    </p>
                </div>
                <div>
                    <img src="{{ asset('/') }}flexonikFiles/pojas/sport.png" alt="Hot Shapers" class=icon />
                    <p>
                        Koliko je vremena potrebno da bi bavljanje sportom imalo efekta?
                    </p>
                </div>
                <div>
                    <img src="{{ asset('/') }}flexonikFiles/pojas/jeans.png" alt="Hot Shapers" class=icon />
                    <p>
...
<div class="block-4">
    <div class="container">
        <div class="clearfix">
            <img src="{{ asset('/') }}flexonikFiles/pojas/package.png" alt="HOT SHAPERS"/>
        ...
        <img src="{{ asset('/') }}flexonikFiles/pojas/arrow-red-left.webp" alt="Hot Shapers" class="arrow"/>
    </div>
</div>
<div class="block-5" id="advise">
    <div class="container">
        ...
        <ul class="list">
            <li>
                <img src="{{ asset('/') }}flexonikFiles/pojas/feature-1.png" alt="Hot Shapers" />
                <p><b>Povećava znojenje <span>4 puta</span></b>
                    <br/>Smanjiće masne naslage na nepotrebnim mestima, a mišići će postati istaknutiji.
                </p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/pojas/feature-2.png" alt="Hot Shapers" />
            ...
            <li>
                <img src="{{ asset('/') }}flexonikFiles/pojas/feature-3.png" alt="Hot Shapers" />
...
<div class="block-7">
    <div class="container">
        ...
        <img src="{{ asset('/') }}flexonikFiles/pojas/hotshapersDt1.png" alt="Hot Shapers"/>
        <img src="{{ asset('/') }}flexonikFiles/pojas/hotshapersDt2.png" alt="Hot Shapers"/>
        <img src="{{ asset('/') }}flexonikFiles/pojas/hotshapersDt3.png" alt="Hot Shapers"/>
        <img src="{{ asset('/') }}flexonikFiles/pojas/hotshapersDt4.png" alt="Hot Shapers"/>
        <img src="{{ asset('/') }}flexonikFiles/pojas/hotshapersDt5.png" alt="Hot Shapers"/>
        <img src="{{ asset('/') }}flexonikFiles/pojas/hotshapersDt6.png" alt="Hot Shapers"/>
        <img src="{{ asset('/') }}flexonikFiles/pojas/hotshapersDt7.png" alt="Hot Shapers"/>
        <img src="{{ asset('/') }}flexonikFiles/pojas/hotshapersDt8.png" alt="Hot Shapers"/>
    ...
    <div class="container">
        ...
        <div class="slider-cont clearfix">
            <div class="slider-item">
                <img src="{{ asset('/') }}flexonikFiles/pojas/darya.jpg" alt="Hot Shapers" class=girl />
            ...
            <div class="slider-item">
                <img src="{{ asset('/') }}flexonikFiles/pojas/sergey.jpg" alt="Hot Shapers" class=girl />
            ...
            <div class="slider-item">
                <img src="{{ asset('/') }}flexonikFiles/pojas/tatyana.jpg" alt="Hot Shapers" class=girl />
...
<div class="block-12">
    <div class="container">
        ...
        <div class=clearfix>
            <div class="fact">
                <img src="{{ asset('/') }}flexonikFiles/pojas/coin.png" alt="Hot Shapers"/>
            ...
            <div class="fact">
                <img src="{{ asset('/') }}flexonikFiles/pojas/prepayment.png" alt="Hot Shapers"/>
                <h4>NE PLAĆA SE UNAPRED</h4>
                <p>Nije potrebno da proizvod plaćate unapred. Porudžbinu plaćate po prijemu robe.</p>
            </div>
            <div class="fact">
                <img src="{{ asset('/') }}flexonikFiles/pojas/delivery.png" alt="Hot Shapers"/>
        ...
        <div class="offer">
            <div class="steps">
                <div class="step step-1 clearfix">
                    <img src="{{ asset('/') }}flexonikFiles/pojas/step-1.png" alt="Hot Shapers"/>
                    <div>
                ...
                <div class="step step-2 clearfix">
                    <img src="{{ asset('/') }}flexonikFiles/pojas/step-2.png" alt="Hot Shapers"/>
                    <div>
                ...
                <div class="step step-3 clearfix">
                    <img src="{{ asset('/') }}flexonikFiles/pojas/step-3.png" alt="Hot Shapers"/>
                    <div>
                        <h4>Dostava</h4>
                ...
                <div class="step step-4 clearfix">
                    <img src="{{ asset('/') }}flexonikFiles/pojas/step-4.png" alt="Hot Shapers" />
                    <div>
            ...
            <img src="{{ asset('/') }}flexonikFiles/pojas/arrow-dashed-down.png" alt="Hot Shapers" class="dashed-arrow-1" />
            <img src="{{ asset('/') }}flexonikFiles/pojas/arrow-dashed-up.png" alt="Hot Shapers" class="dashed-arrow-2" />
            <img src="{{ asset('/') }}flexonikFiles/pojas/arrow-dashed-down.png" alt="Hot Shapers" class="dashed-arrow-3" />
        </div>
    </div>
</div>
<div class="block-14">
    <div class="container">
        ...
        <div class="sale clearfix">
            ...
            <div class="left">
                ...
                <img src="{{ asset('/') }}flexonikFiles/pojas/arrow-dark-left.png" class="arrow" alt="Hot Shapers" >
