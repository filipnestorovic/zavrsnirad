...
<div class="main-wrap">
    <div class="section block-1">
        ...
        <div style="font-family: 'Montserrat Black', sans-serif; font-size: 27px; margin-bottom: 20px; text-align: center;"><span style="color: #ff4e00">+ VRUĆE HELANKE </span><span style="color: #ff0000">GRATIS</span></div>
    ...
    <div class="section block-5" >
        <div class="container">
            ...
            <div class="center"><a href="#order" class="button-m"></a></div>
            <div style="font-family: 'Montserrat Black', sans-serif; font-size: 27px; margin-top: 20px; text-align: center;"><span style="color: #ff4e00">+ VRUĆE HELANKE </span><span style="color: #ff0000">GRATIS</span></div>
        </div>
    </div>
    ...
    <div class="section block-1" >
        ...
        <div style="font-family: 'Montserrat Black', sans-serif; font-size: 27px; text-align: center;"><span style="color: #ff4e00">+ VRUĆE HELANKE </span><span style="color: #ff0000">GRATIS</span></div>
