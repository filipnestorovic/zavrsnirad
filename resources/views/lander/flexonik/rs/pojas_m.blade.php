...
<div class="main-wrap">
    <div class="section block-1">
        ...
        <div class="container-2">
            <div class="center"><a href="{{$checkoutView}}" class="button-m"></a></div>
        </div>
    </div>
    ...
    <div class="section block-7">
        ...
        <div class="container">
            ...
            <div style="text-align:center; margin-top:50px;">
                <img style="display:inline-block; vertical-align:top;" src="{{ asset('/') }}flexonikFiles/pojas/conversation2.png">
                <br><br>
                <img style="display:inline-block; vertical-align:top;" src="{{ asset('/') }}flexonikFiles/pojas/conversation1.png">
                <br><br>
            </div>
        </div>
    </div>
