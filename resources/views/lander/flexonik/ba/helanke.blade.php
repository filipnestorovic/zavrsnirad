...
<div class="block-1">
    <div class="container">
        ...
        <div class="block-info">
            <h1>Vruće helanke za <br/>sagorijevanje masnoće</h1>
            <div class="sale">
                <h2>Vruće helanke</h2>
...
<div class="block-5" id="advise">
    <div class="container">
        <h2>ZATEGNUTA ZADNJICA I KUKOVI ZA SAMO MJESEC DANA!</h2>
        ...
        <ul class="list">
            ...
            <li>
                ...
                <p><b><span>Udobne</span> u svakodnevnom životu</b>
                    <br/>Nevidljive su ispod odjeće, ne propuštaju znoj i ne ostavljaju tragove na tijelu.
                </p>
            </li>
        </ul>
    </div>
...
<div class="block-14">
    <div class="container">
        ...
        <div class="sale clearfix">
            <span class="orange"><strong>{{ $discount != null ? "-".(40+$discount)."%" : "-40%" }}</strong></span>
            <div class="left">
                <h3>Vruće helanke za sagorijevanje masnoće</h3>
