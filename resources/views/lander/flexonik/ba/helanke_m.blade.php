        ...
        <div class="container">
            <ul>
                <li>
                    ...
                    <p>Smanjiće masne naslage na nepotrebnim mjestima, a mišići će postati istaknutiji.</p>
                </li>
                <li>
                    <h4>Napravljene su od <span>NEOTEX tkanine</span></h4>
                    <p>čiji unutrašnji sloj pojačava rad znojnih žlijezda, a spoljašnji sloj upija znoj spriječavajući vlaženje tkanine.</p>
                </li>
                <li>
                    <h4><span>Udobne</span> u svakodnevnom životu</h4>
                    <p>Nevidljive su ispod odjeće, ne propuštaju znoj i ne ostavljaju tragove na tijelu.</p>
                </li>
            </ul>
            <h3>ZATEGNUTA ZADNJICA I KUKOVI ZA SAMO MJESEC DANA!</h3>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="clearfix">
                <div class="elem-item">
                    ...
                    <div class="elem-text">
                        Nikako ne uspjevate da skinete poslednjih par kilograma
                    </div>
                </div>
                <div class="elem-item">
    ...
    <div class="section block-7">
        ...
        <div class="container">
            ...
            <div class="rev rev-3">
                ...
                <p class="rev-text">Vruće helanke su isporučene 2 dana nakon što sam ih poručila. Koristim ih već 8 nedelja. Nosim ih gdje god je to moguće – u šetnji sa djetetom, kod kuće, na trčanju. Rezultat je kao što i sami vidite. Obim kukova mi je uži za 14 centimetara. Ne želim da stanem na ovome, nastaviću da ih nosim.</p>
            </div>
