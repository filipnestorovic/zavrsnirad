    ...
    <div class="wrapper clearfix">
        ...
        <div class="info">
            ...
            <form class="order_form" action="{{$orderRoute}}" method="post">
                ...
                <div class="sizeDiv">
                    <input type="radio" name="size" class="size" value="Male (<40)" id="size-small-1" checked/>
                    <label for="size-small-1">
                        Male (<40)
                    </label>
                    <input type="radio" name="size" class="size" value="Velike (41>)" id="size-large-1"/>
                    <label for="size-large-1">
                        Velike (41>)
                    </label>
                </div>
    ...
    <div class="wrapper clearfix">
        ...
        <div class="info">
            ...
            <form id="order_form" class="order_form" action="{{$orderRoute}}" method="post">
                ...
                <input class="input" type="text" name="shipping_city" placeholder="Grad" required>
                <div class="sizeDiv">
                    <input type="radio" name="size" class="size" value="Male (<40)" id="size-small-2" checked/>
                    <label for="size-small-2">
                        Male (<40)
                    </label>
                    <input type="radio" name="size" class="size" value="Velike (41>)" id="size-large-2"/>
                    <label for="size-large-2">
                        Velike (41>)
                    </label>
                </div>
                <button class="button">PORUČI SADA</button>
