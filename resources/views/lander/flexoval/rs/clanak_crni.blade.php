...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('/') }}flexovalFiles/clanak_crni/favicon.ico" >
    <link rel="icon" type="image/x-icon" href="{{ asset('/') }}flexovalFiles/clanak_crni/favicon.ico" >
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/') }}flexovalFiles/clanak_crni/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('/') }}flexovalFiles/clanak_crni/style.css">
    <style>
        @font-face {
            font-family: "Raleway";
...
<header>
    <div class="header">
        <div class="header_item">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/h1.png">
            <span>EVROPSKI <br>KVALITET</span>
        </div>
        <div class="header_item">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/h2.png">
            <span>PREKO 13000 <br>ZADOVOLJNIH <br>KUPACA</span>
        </div>
        <div class="header_item">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/h3.png">
        ...
        <div class="sale_block_wrap">
            ...
            <div class="sale_block">
                ...
                <form class="main-order-form sale_form" action="{{$orderRoute}}" method="POST">
                    ...
                    <div class="secure">
                        <img src="{{ asset('/') }}flexovalFiles/clanak_crni/lock.png">
...
<section class="base show">
    ...
    <div class="container show_slider">
        <div class="slide"><img src="{{ asset('/') }}flexovalFiles/clanak_crni/s1.jpg"></div>
        <div class="slide"><img src="{{ asset('/') }}flexovalFiles/clanak_crni/s2.jpg"></div>
        <div class="slide"><img src="{{ asset('/') }}flexovalFiles/clanak_crni/s3.jpg"></div>
        <div class="slide"><img src="{{ asset('/') }}flexovalFiles/clanak_crni/s4.jpg"></div>
        <div class="slide"><img src="{{ asset('/') }}flexovalFiles/clanak_crni/s5.jpg"></div>
        {{--<div class="slide"><img src="{{ asset('/') }}flexovalFiles/clanak_crni/s6.jpg"></div>--}}
    </div>
</section>
<section class="base problems">
    ...
    <div class="container problems_inner">
        <div class="problems_item">
            <div><img src="{{ asset('/') }}flexovalFiles/clanak_crni/p1.jpg"></div>
            <p>Bol u zglobu tokom kretanja i mirovanja</p>
        </div>
        <div class="problems_item">
            <div><img src="{{ asset('/') }}flexovalFiles/clanak_crni/p2.jpg"></div>
            <p>Česte modrice, povrede i dislokacije članka</p>
        </div>
        <div class="problems_item">
            <div><img src="{{ asset('/') }}flexovalFiles/clanak_crni/p3.jpg"></div>
            <p>Otok i crvenilo</p>
        </div>
        <div class="problems_item">
            <div><img src="{{ asset('/') }}flexovalFiles/clanak_crni/p4.jpg"></div>
            <p>Bolno oslanjanje na stopalo</p>
        </div>
        <div class="problems_item">
            <div><img src="{{ asset('/') }}flexovalFiles/clanak_crni/p5.jpg"></div>
    ...
    <div class="container">
        ...
        <div class="emergency_inner">
            <div class="emergency_item">
                <div><img src="{{ asset('/') }}flexovalFiles/clanak_crni/check_for_circle.png"></div>
...
<section class="base unique">
    ...
    <div class="container unique_gif">
        ...
        <div class="gif_wrap">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/gif_replacement.jpg">
        </div>
    </div>
...
<section class="base necessary">
    ...
    <div class="container necessary_inner">
        <div class="necessary_item">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/n1.png">
            <p>Svima koji se bave sportom</p>
        </div>
        <div class="necessary_item">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/n2.png">
            <p>Ljudima koji imaju "težinu" i umor u nogama</p>
        </div>
        <div class="necessary_item">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/n3.png">
            <p>Onima koji mnogo vremena provode na nogama</p>
        </div>
        <div class="necessary_item">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/n4.png">
...
<section class="base how">
    <div class="container">
        ...
        <a href="#footer" class="extra btn">PORUČITE ODMAH</a>
        <div class="how_inner">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/m1.jpg">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/m2.jpg">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/m3.jpg">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/m4.jpg">
        </div>
    </div>
</section>
    ...
    <div class="container why_inner">
        <table>
            ...
            <tr>
                ...
                <td><img src="{{ asset('/') }}flexovalFiles/clanak_crni/check_w.png"/></td>
                <td><img src="{{ asset('/') }}flexovalFiles/clanak_crni/cross.png"></td>
                <td><img src="{{ asset('/') }}flexovalFiles/clanak_crni/check_g.png"></td>
            </tr>
            <tr>
...
<section class="base feedback">
    ...
    <div class="feedback_slider">
        <div class="feedback_slide">
            <div class="img_wrapper"><img src="{{ asset('/') }}flexovalFiles/clanak_crni/f1.jpg"></div>
            <div class="comment">
        ...
        <div class="feedback_slide">
            <div class="img_wrapper"><img src="{{ asset('/') }}flexovalFiles/clanak_crni/f2.jpg"></div>
            <div class="comment">
        ...
        <div class="feedback_slide">
            <div class="img_wrapper"><img src="{{ asset('/') }}flexovalFiles/clanak_crni/f3.jpg"></div>
            <div class="comment">
...
<section class="base simple_steps">
    ...
    <div class="container steps">
        <div class="step">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/step1.png" alt="картинка">
            <p>Unesite svoje podatke na našem sajtu</p>
        </div>
        <div class="step">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/step2.png" alt="картинка">
            <p>Kontaktiraćemo vas da potvrdimo porudžbinu</p>
        </div>
        <div class="step">
            <img src="{{ asset('/') }}flexovalFiles/clanak_crni/step3.png" alt="картинка">
...
<script src="{{ asset('/') }}flexovalFiles/clanak_crni/owl.carousel.min.js"></script>
<script src="{{ asset('/') }}flexovalFiles/clanak_crni/main.js"></script>
