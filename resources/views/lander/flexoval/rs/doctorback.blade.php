...
<section class="base banner">
    <div class="container main_title">
        <h1 class="h1">INOVATIVNI <br class="mobileRow">MAGNETNI KOREKTOR DRŽANJA<br><span>Doctor <span>Back</span></span></h1>
    </div>
...
<section class="base show">
    ...
    <p class="container">Korektor držanja <b>Doctor Back</b> je najnoviji izum. Najbolji svetski ortopedi učestvovali su u njegovom razvoju.</p>
...
<section class="base problems">
    <h2 class="titles white"><span class="orange">Doctor Back</span> ĆE ZAUVEK REŠITI PROBLEME SA LEĐIMA</h2>
...
{{--<section class="base gallery">--}}
{{--<img src="{{ asset('/') }}flexovalFiles/doctorback/gallery1.jpg">--}}
{{--<img src="{{ asset('/') }}flexovalFiles/doctorback/gallery2.jpg">--}}
{{--<img src="{{ asset('/') }}flexovalFiles/doctorback/gallery3.jpg">--}}
{{--<img src="{{ asset('/') }}flexovalFiles/doctorback/gallery4.jpg">--}}
{{--</section>--}}
<section class="base how">
    <div class="container">
        <h2 class="titles"><span class="blue">KAKO DELUJE</span> MAGNETNI KOREKTOR DRŽANJA <span class="blue">DOCTOR BACK?</span></h2>
        <div class="container how_inner">
            ...
            <div class="how_item">
                ...
                <h3>UGRAĐENI AKTIVNI MAGNETI</h3>
                <p>stvaraju snažno magnetno polje, poboljšava cirkulaciju i tonira mišiće leđa</p>
            </div>
            <div class="how_item">
                <img src="{{ asset('/') }}flexovalFiles/doctorback/m4.png">
                <h3>MAGNETNO <br>ZRAČENJE</h3>
                <p>pomaže u smanjenju otoka, oslobađa bolova i blagotvorno obnavlja nervni sistem</p>
            </div>
        </div>
...
<section class="base how2">
    <h2 class="titles white">KAKO KORISTITI <br><span class="orange">DOCTOR BACK KOREKTOR DRŽANJA TELA</span></h2>
    <p class="container"><b>Doctor back</b> ne samo da pomaže u ispravljanju leđa, već i ublažava bolove, uklanja upale i obnavlja nervni i kardiovaskularni sistem.
        Podesivi čičak pomaže da se korektor postavi na telo čvrsto i udobno, bez smanjenja pokretljivosti.</p>
...
<section class="base why">
    <h2 class="titles"><span class="blue">PREDNOSTI</span> MAGNETNOG KOREKTORA DRŽANJA <br><span class="blue">DOCTOR BACK</span></h2>
    <div class="container why_inner">
        <table>
            <thead>
            <tr>
                <th><p></p></th>
                <th><p>Doctor Back</p></th>
...
<section class="base expert">
    <div class="container expert_inner">
        ...
        {{--<div class="caption">--}}
        {{--<p>IVANIĆ PETAR</p>--}}
        {{--<p>Ortopedski hirurg-traumatolog, sa 24 godine profesionalnog iskustva </p>--}}
        {{--</div>--}}
        <div class="expert_text">
            <p>Držanje tela podrazumeva uobičajeno držanje osobe koja stoji mirno. Uz pravilno držanje tela, svi delovi tela smešteni su simetrično u odnosu na kičmu, ramena su raširena,
                glava je malo podignuta, ruke i noge su ravne i ispružene, a stomak je uvučen. Kod velikog broja ljudi držanje nije pravilno,
                a ono negativno utiče na rad celog organizma, ne samo mišića leđa i vrata.
            </p>
            <p>Većina korektora držanja funkcioniše na principu ukrućenja i jako su neprijatni. Fiksiraju figuru i daju telu određeni stav, ograničavajući kretanje.
                Princip <b>Doctor back</b> korektora je drugačiji. Ne utiče direktno na kičmu i jača mišiće leđa koji sami daju telu prirodan položaj.
                Zahvaljujući tom principu je znatno efikasniji u poređenju sa ostalim korektorima.
            </p>
            <p>Doctor Back pomogao je mnogima čiji su problemi bili uzrokovani konstantnim lošim držanjem.
                Primetili su velika poboljšanja u svom zdravlju, nisu se više manifestovali bolovi u leđima i ustanovljeno je
                veliko popravljanje samog držanja. Preporučuje se upotreba ovog korektora u kombinaciji sa dodatnim vežbama i masažom,
                što vrlo brzo dovodi do dobrih rezultata.
            </p>
        </div>
    </div>
</section>
<section class="base feedback">
    <h2 class="titles"><span class="orange">UTISCI </span> ONIH KOJI SU VEĆ PROBALI <span class="orange">Doctor Back</span></h2>
    <div class="feedback_slider">
        <div class="feedback_slide">
            ...
            <div class="comment">
                ...
                <p>Nedavno su me počela boleti leđa, imao sam užasne bolove. Pio sam lekove i dok su oni delovali nisam imao bolove. Čim prestane dejstvo, bolovi su se vraćali.
                    Otišao sam kiropraktičaru i ustanovio je da mi problem pravi loše držanje zbog viška kilograma. Preporučio mi je Doctor Back korektor držanja i ja sam ga poručio preko interneta.
                    Nosim ga već 20 dana i mogu vam reći da mi je dosta bolje. Prva 2-3 dana mi je bilo neobično, ali sam se brzo navikao. Odličan je i mogu svakome da ga preporučim.</p>
            </div>
        </div>
        <div class="feedback_slide">
            ...
            <div class="comment">
                ...
                <p>Za leđa mi puno pomaže, prestao sam da imam bolove pri sedenju.
                    Doctor Back je udoban, drži mi leđa pravim i ne osetim da ga nosim.
                    Konačno hodam pravih leđa. Sve preporuke, odličan proizvod!</p>
            </div>
        </div>
        <div class="feedback_slide">
            ...
            <div class="comment">
                ...
                <p>Ja sam penzioner i problemi s leđima pojavili su mi se pre skoro 10 godina.
                    Celu karijeru sam radila u kancelariji, i mnogo sam sedela. Bolovi u leđima su me stalno pratili i imala sam velike probleme.
                    Doktor, koji je inače bio moj školski drug preporučio mi je da koristim ovaj steznik, ali se nije mogao kupiti u Srbiji tada.
                    Poslao mi ga je brat iz Nemačke, i osetila sam poboljšanje već nakon 15 dana nošenja. Sada kada sam videla ovu reklamu, kupila sam još 2 za slučaj da nestane ponovo,
                    jer ga je zaista teško nabaviti.</p>
            </div>
        </div>
    </div>
</section>
<section class="base simple_steps">
    <h2 class="titles white">3 JEDNOSTAVNA KORAKA DA PORUČITE <br><span class="black">Doctor Back</span></h2>
...
<section class="base banner bottom_block">
    <div class="container main_title">
        <h3 class="h1">INOVATIVNI <br class="mobileRow"> MAGNETNI KOREKTOR DRŽANJA <br><span>Doctor <span>Back</span></span></h3>
    </div>
    <div class="container smart">
        <ul class="list">
            <li>100% stabilizacija opterećenja kičme</li>
