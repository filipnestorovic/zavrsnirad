    ...
    <div class="wrapper clearfix">
        ...
        <div class="info">
            ...
            <form class="order_form" action="{{$orderRoute}}" method="post">
                ...
                <select name="quantity" class="quantity input" required>
...
<script>
    $('.quantity').click(function () {
        ...
        if(parseInt(fsh) === 1) {
            $(this).closest('.order_form').find('.freeShippingDiv').slideDown();
        } else {
            $(this).closest('.order_form').find('.freeShippingDiv').slideUp();
        }
    })
</script>
