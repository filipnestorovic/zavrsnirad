            ...
            <div class="innerContent col_left ui-resizable col-md-6" style="outline: none;">
                <div class="col-inner bgCover noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin">
                    <div class="de elImageWrapper de-image-block elMargin0 elAlign_center ui-droppable de-editable" style="margin-top: 0px; outline: none; cursor: pointer;" data-hide-on="desktop">
                        <img src="{{ asset('/') }}flexovalFiles/ledja/ba_ledja.png" class="elIMG ximg" height="400" width="" alt="" style="" tabindex="0">
                    </div>
                </div>
            </div>
                ...
                <div class="col-inner bgCover noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
                    <div class="de elHeadlineWrapper ui-droppable de-editable" style="margin-top: 3px; outline: none; cursor: pointer;">
                        <div class="ne elHeadline hsSize3 lh4 elMargin0 elBGStyle0 hsTextShadow0" style="text-align: left; font-size: 22px; color: rgb(0, 0, 0);">
                            <i>"Bol u leđima i vratu postaje sve češći kako starite, čak i od jednostavnih svakodnevnih aktivnosti. Tokom godina bol postaje sve učestaliji i intenzivniji – Nakon spavanja, prilikom sjedenja za računarom ili često bez ikakvog razloga."</i><div><i> - Medicinska škola Harvard</i></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-inner bgCover noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
                    ...
                    <div class="de elHeadlineWrapper ui-droppable de-editable" style="margin-top: 30px; outline: none; cursor: pointer;">
                        <div class="ne elHeadline hsSize3 lh4 elMargin0 elBGStyle0 hsTextShadow0" style="text-align: center; font-size: 16px; color: rgb(0, 0, 0);" >
                            <i>"Bol u leđima i vratu postaje sve češći kako starite, čak i od jednostavnih svakodnevnih aktivnosti. Tokom godina bol postaje sve učestaliji i intenzivniji – Nakon spavanja, prilikom sjedenja za računarom ili često bez ikakvog razloga." - Medicinska Škola Harvard</i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-inner bgCover noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
                    ...
                    <div class="de elHeadlineWrapper ui-droppable de-editable" style="margin-top: 25px; cursor: pointer; outline: none; display: block; font-family: 'Open Sans', Helvetica, sans-serif !important;" >
                        <div class="ne elHeadline hsSize3 lh4 elMargin0 elBGStyle0 hsTextShadow0" style="text-align: left; font-size: 20px; color: rgb(0, 0, 0);">
                            ...
                            <div><br></div>
                            <div>
                                <b>Ovaj pojas je savršen za one koji bi željeli da se vrate bezbolnom životu, ali takođe da poboljšaju svoje držanje i trajno se riješe bolova u vratnom i leđnom dijelu - bez posjeta ljekaru, rizičnih operacija ili skupih lijekova protiv bolova!</b>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-inner bgCover noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
                    <div class="de elBullet elMargin0 ui-droppable de-editable hiddenElementTools" style="margin-top: 20px; cursor: pointer; outline: none; font-family: 'Open Sans', Helvetica, sans-serif !important;">
                        <ul class="ne elBulletList listSize1 listIconBlack listBorder0 listIconSize0 listIcon6" style="color: rgb(0, 0, 0); bullet-color:rgb(30, 201, 1);">
                            ...
                            <li style="font-size: 20px;">Savršeno za one koji većinu dana provode sjedeći za računarom ili u kancelariji.</li>
                            ...
                            <li style="font-size: 20px;">Niskog profila i elegantnog dizajna, tako da niko neće znati da ovo nosite ispod odjeće.</li>
    ...
    <div class="containerInner ui-sortable">
        <div class="row bgCover noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding-top: 0px; padding-bottom: 20px; margin: 0px; outline: none;">
            <div class="col-md-12 innerContent col_left" style="outline: none;">
                <div class="col-inner bgCover noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
                    <div class="de elImageWrapper de-image-block elAlign_center elMargin0 ui-droppable de-editable" style="margin-top: 20px; outline: none; cursor: pointer;">
                        <img src="{{ asset('/') }}flexovalFiles/ledja/ba_ledja.png" class="elIMG ximg" alt="" height="300" tabindex="0">
                    </div>
                    <div class="de elImageWrapper de-image-block elAlign_center elMargin0 ui-droppable de-editable" style="margin-top: 20px; outline: none; cursor: pointer;">
                        <img src="{{ asset('/') }}flexovalFiles/shared_files/stars_ba.png" class="elIMG ximg" alt="" height="60" tabindex="0">
                    </div>
                    ...
                    <div class="de elHeadlineWrapper ui-droppable de-editable" style="margin-top: 25px; cursor: pointer; outline: none; display: block; font-family: 'Open Sans', Helvetica, sans-serif !important;">
                        <div class="ne elHeadline hsSize3 lh4 elMargin0 elBGStyle0 hsTextShadow0" style="text-align: left; font-size: 20px; color: rgb(0, 0, 0);">
                            ...
                            <div>
                                <b>Ovaj steznik je savršen za one koji bi željeli da se vrate bezbolnom životu, ali takođe da poboljšaju svoje držanje i trajno se riješe bolova u vratnom i leđnom dijelu - bez posjeta ljekaru, rizičnih operacija ili skupih lijekova protiv bolova!</b>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="container noTopMargin padding20-top padding20-bottom padding40H noBorder borderSolid border3px cornersAll radius0 shadow0 bgNoRepeat wideContainer emptySection addBonusBottomSpacing activeSection innerToolsTop" style="padding-top: 20px; padding-bottom: 20px; background-color: rgb(255, 255, 255); outline: none;" data-hide-on="">
    <div id="accordion">
        ...
        <div>
            <p>Pojas posjeduje 2 podesive rastegljive trake kojima možete da podesite dimenzije tako da se apsolutno prilagođava Vašoj građi.</p>
        </div>
        <h3>Mogu li nositi pojas za leđa cijeli dan?</h3>
        <div>
            <p>Apsolutno, možete nositi pojas za leđa tokom cijelog dana. Bilo da se opuštate kod kuće, vježbate ili ste na poslu. Dizajniran je da Vam obezbijedi pravilno držanje I olakša svakodnevne obaveze.</p>
        </div>
        <h3>Ne želim nešto glomazno - Hoće li steznik stati ispod odjeće?</h3>
        <div>
            <p>Da, steznik je vrhunskog niskoprofilnog dizajna. Možete ga nositi ispod bilo koje majice, košulje, džempera – apsolutno je neprimjetan. Toliko je tanak i diskretan - niko neće znati da ga nosite</p>
        </div>
        <h3>Koje pogodnosti mogu da očekujem od pojasa za leđa?</h3>
        <div>
            <p>Prije svega pojas za leđa će Vas riješiti bolova u leđima i vratnom dijelu kao i ramenima. Takođe, bez obzira na to koliko lijepo izgledate, loše držanje tijela se ne može sakriti. Ne samo da povijena leđa doprinose skrnavljenu sveukupne vizuelne slike o vama, već u značajnoj mjeri utiču, kako na fizičko, tako i na psihičko stanje. Loše držanje sa sobom nosi i rizike od degenerativnih bolesti kičme koje mogu ostaviti trajne posljedice na Vaš organizam, a ovaj pojas će Vam sa sigurnošću pomoći da popravite svoje držanje u vrlo kratkom vremenskom roku.</p>
        </div>
        ...
        <div class="row bgCover noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding-top: 20px; padding-bottom: 20px; margin: 0px; outline: none;">
            <div class="col-md-12 innerContent col_left" style="outline: none;">
                <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
                    ...
                    <div class="de elHeadlineWrapper ui-droppable de-editable" style="margin-top: 0px; outline: none; cursor: pointer; font-family: 'Open Sans', Helvetica, sans-serif !important;">
                        <div class="ne elHeadline hsSize3 lh4 elMargin0 elBGStyle0 hsTextShadow0" style="text-align: left; font-size: 24px;">
                            <b>⭐⭐⭐⭐⭐ "Osjećam se kao ponovo rođen"</b>
                        </div>
                    </div>
                    <div class="de elHeadlineWrapper ui-droppable de-editable" style="margin-top: 15px; outline: none; cursor: pointer; font-family: 'Open Sans', Helvetica, sans-serif !important;">
                        <div class="ne elHeadline hsSize3 lh4 elMargin0 elBGStyle0 hsTextShadow0" style="text-align: left; font-size: 20px;">
                            Isprobao sam toliko različitih vrsti pojaseva. Pošto radim kancelarijski posao imao sam velikih problema sa bolovima u vratu I ukočenošću. Ovaj pojas me je preporodio. Ranije sam kupovao jeftine pojaseve koji su bili beskorisni. Na kraju sam zaključio je ovo najbolja stvar koju sam priuštio sebi u posljednjih 5 godina..
                        </div>
                    </div>

                    <div class="de elHeadlineWrapper ui-droppable de-editable" style="margin-top: 30px; outline: none; cursor: pointer; font-family: 'Open Sans', Helvetica, sans-serif !important;">
                        <div class="ne elHeadline hsSize3 lh4 elMargin0 elBGStyle0 hsTextShadow0" style="text-align: right; font-size: 24px;">
                            <b>"Neophodan proizvod za sve koji sjede za kompjuterom"  ⭐⭐⭐⭐⭐</b>
                        </div>
                    </div>
                    <div class="de elHeadlineWrapper ui-droppable de-editable" style="margin-top: 15px; outline: none; cursor: pointer; font-family: 'Open Sans', Helvetica, sans-serif !important;">
                        <div class="ne elHeadline hsSize3 lh4 elMargin0 elBGStyle0 hsTextShadow0" style="text-align: left; font-size: 20px;">
                            Za kompjuterom sam u prosjeku više od 8h dnevno i zbog toga sam do skoro osjećao jake bolove u vratu. Zahvaljujući ovom pojasu držanje se popravilo i nemam više tih problema.
                        </div>
                    </div>
                ...
                <div class="col-inner bgCover noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin" style="padding: 0 10px">
                    ...
                    <div class="de elHeadlineWrapper ui-droppable de-editable" style="margin-top: 0px; outline: none; cursor: pointer; font-family: 'Open Sans', Helvetica, sans-serif !important;">
                        <div class="ne elHeadline hsSize3 lh4 elMargin0 elBGStyle0 hsTextShadow0" style="text-align: center; font-size: 24px;">
                            <b>⭐⭐⭐⭐⭐&nbsp;</b><div><b>"Osjećam se kao ponovo rođen"</b></div>
                        </div>
                    </div>
                    <div class="de elHeadlineWrapper ui-droppable de-editable" style="margin-top: 15px; outline: none; cursor: pointer; font-family: 'Open Sans', Helvetica, sans-serif !important;">
                        <div class="ne elHeadline hsSize3 lh4 elMargin0 elBGStyle0 hsTextShadow0" style="text-align: left; font-size: 20px;">
                    ...
                    <div class="de elHeadlineWrapper ui-droppable de-editable" style="margin-top: 30px; outline: none; cursor: pointer; font-family: 'Open Sans', Helvetica, sans-serif !important;">
                        <div class="ne elHeadline hsSize3 lh4 elMargin0 elBGStyle0 hsTextShadow0" style="text-align: center; font-size: 24px;">
                            <b>⭐⭐⭐⭐⭐</b><div>
                                <b>"Neophodan proizvod za sve koji sjede za kompjuterom"</b></div>
                        </div>
                    </div>
