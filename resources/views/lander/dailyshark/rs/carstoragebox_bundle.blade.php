...
<head>
    ...
    <style>
        ...
        .price_holder .priceLabel {
            font-size: 22px;
        }
        .price_holder .priceVal {
            width: 100%;
            font-size: 24px;
        }
        .price_holder .old-cost {
            text-decoration: none;
            margin-left: 10px;
        }
        .price_holder .new-cost {
            margin-left: 36px;
        }
        .pricesRadio {
            width: 100%;
...
<section class="block1">
    <div class="wrap">
        ...
        <div class="clear"></div>
        <div class="price clearfix price_holder">
            <table style="width: 100%;">
                <tr>
                    <td class="priceLabel">1 komad</td>
                    <td class="priceLabel">2 komada</td>
                </tr>
                <tr>
                    <td><span class="old-cost priceVal">{{ $prices[1]['amount'] }} {{ $prices[1]['currency'] }}</span></td>
                    <td><span class="new-cost priceVal">{{ $prices[2]['amount'] }} {{ $prices[2]['currency'] }}</span></td>
                </tr>
            </table>
        </div>
        <div class="clear"></div>
    ...
    <div class="wrap">
        ...
        <div class="formbox">
            ...
            <form id="buy" class="m1-form" action="{{$orderRoute}}" method="post">
                ...
                <div class="pricesRadio">
                    <p>Izaberite količinu</p>
                    <input type="radio" name="quantity" id="quantity1" value="1" required/>
                    <label for="quantity1">1 komad</label>
                    <input type="radio" name="quantity" id="quantity2" value="2" required checked/>
                    <label for="quantity2">2 komada</label>
                </div>
