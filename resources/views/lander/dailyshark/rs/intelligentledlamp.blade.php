...
<div id="wrapper">
        ...
        <div class="container navigation">
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#conocenos3" id="logo2">
                    <img src="{{ asset('/') }}dailysharkFiles/intelligentledlamp/logo.png" alt="" width="200" height="50">
                </a>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <p style="font-size:75px;font-weight:600;font-family:Roboto;color:#fff;text-align:initial;line-height:80px;margin-top:-15%"
                           class="refleja">Intelligent Led Lamp</p>
                        <p style="font-size:24px;font-family:Roboto;color:#fff;text-align:left;font-weight:600;line-height:29px"
                           class="crea full ayuda">Predstavljamo Vam inteligentnu led lampu - idealno osvetljenje u zatvorenim prostorijama koje se montira bez kablova i bušenja</p>
                    ...
                    <div class="col-lg-6" style="text-align:center">
                        <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                            <img src="{{ asset('/') }}dailysharkFiles/intelligentledlamp/solar.png" alt="" style="width:70%;margin-top:5%">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="service" class="home-section nopadding paddingtop-60 automatizar">
        <div class="container">
            <p style="font-size:42px;line-height: normal;font-family:Roboto;color:#000;text-align:center;margin-top:2%;font-weight:600"
               class="cont abs0 automatiza">Potpuno univerzalna lampa</p>
            <br>
            <div class="row">
                <div class="col-sm-6 col-md-6" style="text-align:center">
                    <p style="padding-top:35px;font-size:22px;font-family:Roboto;color:#000;text-align:justify;margin-top:2%;font-weight:400;line-height:30px"
                       class="estreno2 uso">
                        Intelligent Led Lamp je idealno rešenje za mračna mesta koja su teže
                ...
                <div class="col-sm-6 col-md-6" style="padding-right:0!important;padding-left:0!important">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <img src="{{ asset('/') }}dailysharkFiles/intelligentledlamp/solarl.png" style="width:100%" class="img-responsive" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row" style="text-align:center">
                <div class="col-sm-6 col-md-6">
                    <img src="{{ asset('/') }}dailysharkFiles/intelligentledlamp/r1.png" style="width:85%" alt="">
                </div>
                <div class="col-sm-6 col-md-6">
                    <img src="{{ asset('/') }}dailysharkFiles/intelligentledlamp/r2.png" style="width:85%" alt="">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row" style="text-align:center">
                <div class="col-sm-12 col-md-12">
                    <img src="{{ asset('/') }}dailysharkFiles/intelligentledlamp/piezas.png" style="width:85%" class="piezas" alt="">
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" style="text-align:center">
                                <div class="wow lightSpeedIn" data-wow-delay="0.1s">
                                    <img src="{{ asset('/') }}dailysharkFiles/intelligentledlamp/solarl.png" style="width:90%" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="space espacio cj" id="conocenos3"
             style="background-image: url({{ asset('/') }}dailysharkFiles/intelligentledlamp/fondo.png); background-repeat: no-repeat;background-size: cover; text-align:center;background-position-x: 57%;background-repeat: repeat;">
        <div class="container">
            <div class="row">
                <div class="col-md-6 space__text" style="margin-top:2.5%;">
                    <p>Poručite Intelligent Led Lamp odmah</p>
