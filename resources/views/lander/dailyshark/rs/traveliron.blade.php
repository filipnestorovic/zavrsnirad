    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-sm-3 col-xs-8">
                <div class="top-logo">TRAVEL IRON</div>
            </div>
            ...
            <div class="col-md-7 col-md-pull-3 col-sm-9 col-xs-4">
                <ul class="top-menu">
                    ...
                    <li><a href="#ex2"> ZAŠTO <span>TRAVEL IRON</span></a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-sm-12">
                <img class="main-img" src="{{ asset('/') }}dailysharkFiles/traveliron/body-brush.png">
            </div>
        </div>
    </div>
</div>
<div class="reason" id="#ex1">
    <div class="container">
        <div id="ex1" class="reason-top">8 RAZLOGA DA KUPITE TRAVEL IRON</div>
        <div class="row">
            <div class="col-md-4">
                <img class="reason-img" src="{{ asset('/') }}dailysharkFiles/traveliron/reason-img.png">
            </div>
            <div class="col-md-8">
...
<div class="why" id="ex2">
    <div class="container">
        <div class="why-top">ZAŠTO TRAVEL IRON?</div>
        <div class="row">
            <div class="col-sm-6">
                <div class="why-name">OBIČNE PEGLE</div>
                <img class="why-img" src="{{ asset('/') }}dailysharkFiles/handsteamer/why1.jpg">
                <div class="why-list">
            ...
            <div class="col-sm-6">
                <div class="why-name">TRAVEL IRON</div>
                <img class="why-img" src="{{ asset('/') }}dailysharkFiles/traveliron/why2.jpg">
                <div class="why-list2">
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <div class="expert-text">
                    ...
                    TRAVEL IRON radi na principu jake temperature i bočice za sprejno ovlaživanje tkanine.
                    Pegla je mala i ima oštre uglove, tako da konačno možete da doprete do svake ivice tkanine koju peglate.<br><br>
                    TRAVEL IRON ne ostavlja tragove na tretiranim površinama i efikasno pegla stvari. Nikada lakše nisam peglala haljinu.<br><br>
                ...
                <div class="carousel-slider owl-carousel">
                    <div class="item">
                        ...
                        <div class="item-body match_height">
                            <div class="thumb-wrap">
                                ...
                                <a href="{{ asset('/') }}dailysharkFiles/traveliron/1a.jpg"
                                   data-lightbox="first"><img
                                        src="{{ asset('/') }}dailysharkFiles/traveliron/1a_thumb.jpg" alt="thumb"
                                        class="thumb"></a>
                                <a href="{{ asset('/') }}dailysharkFiles/traveliron/1b.jpg"
                                   data-lightbox="first"><img
                                        src="{{ asset('/') }}dailysharkFiles/traveliron/1b_thumb.jpg" alt="thumb"
                                        class="thumb"></a>
                            </div>
                    ...
                    <div class="item">
                        ...
                        <div class="item-body match_height">
                            <div class="thumb-wrap">
                                ...
                                <a href="{{ asset('/') }}dailysharkFiles/traveliron/2a.jpg"
                                   data-lightbox="second"><img
                                        src="{{ asset('/') }}dailysharkFiles/traveliron/2a_thumb.jpg" alt="thumb"
                                        class="thumb"></a>
                                <a href="{{ asset('/') }}dailysharkFiles/traveliron/2b.jpg"
                                   data-lightbox="second"><img
                                        src="{{ asset('/') }}dailysharkFiles/traveliron/2b_thumb.jpg" alt="thumb"
                                        class="thumb"></a>
                                <a href="{{ asset('/') }}dailysharkFiles/traveliron/2c.jpg"
                                   data-lightbox="second"><img
                                        src="{{ asset('/') }}dailysharkFiles/traveliron/2c_thumb.jpg" alt="thumb"
                                        class="thumb"></a>
                            </div>
                    ...
                    <div class="item">
                        ...
                        <div class="item-body match_height">
                            <div class="thumb-wrap">
                                <span class="span"> 2 slike</span>
                                <a href="{{ asset('/') }}dailysharkFiles/traveliron/3a.jpg"
                                   data-lightbox="third"><img
                                        src="{{ asset('/') }}dailysharkFiles/traveliron/3a_thumb.jpg" alt="thumb"
                                        class="thumb"></a>
                                <a href="{{ asset('/') }}dailysharkFiles/traveliron/3b.jpg"
                                   data-lightbox="third"><img
                                        src="{{ asset('/') }}dailysharkFiles/traveliron/3b_thumb.jpg" alt="thumb"
                                        class="thumb"></a>
                            </div>
...
<div class="main2" id="order">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-sm-12">
                <img class="main-img" src="{{ asset('/') }}dailysharkFiles/traveliron/body2-brush.png">
            </div>
        </div>
    </div>
</div>
