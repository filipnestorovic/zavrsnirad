    ...
    <div class="row">
        <div class="container">
            <div id="eQEVU6WQLDdMoRkTXNVRCKr48cVWyW8Q" class="widget widget-text">
                <p>AKTIVNA PENA ZA SUVO PRANJE <br> <span style="color: rgb(66, 113, 134);">FOAM CLEANER</span>
                </p>
            </div>
            <div id="C2JMPRz3u1H8S2l5I4HErc1HzUXXPbO7" class="widget widget-text">
                <p>Foam Cleaner pena je sprej za suvo pranje i dezinfekciju svih površina – automobila, nameštaja, kuhinjskih stolica, tepiha pa čak i prljavih cipela!</p>
            </div>
            ...
            <img id="Nqtm0kFhH0hI9vbsH8uMOPS9gSN9TlUy" width="66" height="210"  class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/foamcleaner/dailyshark1.png"
                 alt="" >
            ...
            <div id="p83SwEIXxyhqDhEAdZWWrIlrqddLUW3J" class="widget widget-text">
                <p>AKTIVNA PENA ZA SUVO PRANJE <span style="color: rgb(215, 82, 38);">FOAM CLEANER</span></p>
            </div>
    ...
    <div class="row">
        <div class="container">
            ...
            <div id="UbgCoO3tq9RWbg6ZAGvoSHJWdsWSiAR8" class="widget widget-text">
                <p><span style="color: rgb(66, 113, 134);">FOAM CLEANER</span></p>
            </div>
            <div id="keH3aZUKLnccVAUuhTZwWS8G7e2Tpp0g" class="widget widget-text">
                <p><span style="color: rgb(255, 255, 255);">Gusta pena rastvara prljavštinu i čini je lakom za otklanjanje. Foam Cleaner je inovativno rešenje za brzo, lako i efikasno čišćenje najefikasnijih površina.</span></p>
            </div>
    ...
    <div class="row">
        <div class="container">
            ...
            <img id="T6TAw0wg0AExxx6EQdDSFDEO021evce1"  width="460" height="306"  class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/foamcleaner/DSCF3073.jpg"
                 alt="" >
            ...
            <div id="BTzIAe4v7bbpR5WhUfC7vfAKon6cgZSi" class="widget widget-text">
                <p>Inovativni Foam Cleaner sprej će se pobrinuti za to u roku od samo par minuta. </p>
            </div>
    ...
    <div class="row">
        <div class="container">
            ...
            <img id="AI0oAcV80XvTsVMCPkiXm8Lv84xsPppe"  width="214" height="214"  class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/foamcleaner/dailyshark2.jpg"
                 alt="" >
    ...
    <div class="row">
        <div class="container">
            ...
            <div id="yeK7ImHxUhzVJ9OrrqozL5BsS3lfP71F" class="widget widget-text">
                <p>ZAŠTO JE FOAM CLEANER BOLJI OD OSTALIH PROIZVODA?</p>
            </div>
    ...
    <div class="row">
        <div class="container">
            ...
            <div id="mGbsbUJAqk2FIKlA8mlIJSaPQP5S6mUq" class="widget widget-text">
                <p>Nisam verovao da ću ikada uspeti da uklonim mrlje sa cipela ali prevario sam se. Foam Cleaner čisti sve!</p>
            </div>
    ...
    <div class="row">
        <div class="container">
            ...
            <img id="eQwnZUeK7OrJyXMlfudcQLh0Aac1QRDT"  width="145" height="191"  class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/foamcleaner/2BR.png"
                 alt="" >
            <img id="W7RTfm5os75omrpK9AVLKTU1V6Bk1s9J"  width="134" height="177"  class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/foamcleaner/3BR.png"
                 alt="" >
    ...
    <div class="row">
        <div class="container">
            ...
            <img id="wE7DsScTvzQXGTWBEyfv9Nl74tH3opwr"  width="223" height="223" class="widget widget-image  "
                 src="{{ asset('/') }}dailysharkFiles/foamcleaner/dailyshark2.jpg" alt="" >
