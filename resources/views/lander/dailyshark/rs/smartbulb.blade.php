...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('/') }}dailysharkFiles/smartbulb/150.png" type="image/x-icon">
    ...
    <style>
        .block1 {
            background: #010003 url({{ asset('/') }}dailysharkFiles/smartbulb/bg1.jpg) no-repeat center top;
            padding: 40px 0 0;
        }
        .block2 {
            padding: 70px 0 50px;
            background: #010003 url({{ asset('/') }}dailysharkFiles/smartbulb/b2.jpg) no-repeat center 75px;
        }
        .block5 {
            padding: 60px 0 0;
            height: 480px;
            background: #010003 url({{ asset('/') }}dailysharkFiles/smartbulb/b4.jpg) no-repeat center top;
        }
        @media screen and (max-width: 659px) {
            .block1 {
                background-image: url({{ asset('/') }}dailysharkFiles/smartbulb/b1s.jpg);
...
<section class="block1">
    <div class="wrap topline">
        <div class="logo">
            ...
            <span class="gr-wrap"
            ><span class="gr-text">
                    <span class="gr-letter" style="color: rgb(255, 55, 15)">S</span
                    ><span class="gr-letter" style="color: rgb(255, 63, 14)">M</span
                    ><span class="gr-letter" style="color: rgb(255, 72, 13)">A</span
                    ><span class="gr-letter" style="color: rgb(255, 82, 12)">R</span
                    ><span class="gr-letter" style="color: rgb(255, 94, 10)">T</span
                    ><span class="gr-letter" style="color: rgb(255, 133, 5)"
                    ><span style="display: none">​</span> </span
                    ><span class="gr-letter" style="color: rgb(255, 103, 9)">B</span
                    ><span class="gr-letter" style="color: rgb(255, 114, 8)">U</span
                    ><span class="gr-letter" style="color: rgb(255, 124, 6)">L</span
                    ><span class="gr-letter" style="color: rgb(255, 137, 5)">B</span
                    ></span
                ></span>
            </h1>
        </div>
    ...
    <div class="wrap">
        ...
        <ul class="bullites">
            <li>
                ...
                355 stepeni vodoravno, 120 stepeni vertikalno
            </li>
            <li>
...
<section class="block2">
    <div class="wrap">
        <h2 class="title">
            <span>BEŽIČNA WI-FI KAMERA / SIJALICA sa rotirajućom glavom </span>i alarmom po potrebi
        </h2>
        ...
        <ul class="angles">
            <li>
                <img src="{{ asset('/') }}dailysharkFiles/smartbulb/170.png" alt />
                <p>Horizontalni prikaz:<b> 355°</b></p>
            </li>
            <li>
                <img src="{{ asset('/') }}dailysharkFiles/smartbulb/150.png" alt />
                <p>Vertikalni prikaz: <b> 120°</b></p>
            </li>
        </ul>
        <ul class="aboutimg">
            <li>
                <img src="{{ asset('/') }}dailysharkFiles/smartbulb/about1.jpg" alt />
            </li>
            <li>
                <img src="{{ asset('/') }}dailysharkFiles/smartbulb/about2.jpg" alt />
            </li>
            <li>
                <img src="{{ asset('/') }}dailysharkFiles/smartbulb/about3.jpg" alt />
            </li>
        </ul>
    </div>
</section>
<section class="block3">
    <div class="wrap">
        <div class="container">
            <img src="{{ asset('/') }}dailysharkFiles/smartbulb/product1.jpg" alt />
            <div class="info">
                <h2 class="title">
...
<section class="block4">
    <div class="wrap">
        ...
        <img src="{{ asset('/') }}dailysharkFiles/smartbulb/product2.jpg" alt />
...
<section class="block5">
    <div class="wrap">
        ...
        <ul class="gifki">
            <li>
                <img src="{{ asset('/') }}dailysharkFiles/smartbulb/3.jpg" class="b-lazy" alt />
                <p>
                    <span>Dnevni / noćni režim</span> Povećana propustljivost svetlosti omogućava snimanje svega što se dešava.
                </p>
            </li>
            <li>
                <img src="{{ asset('/') }}dailysharkFiles/smartbulb/2.jpg" class="b-lazy" alt />
                <p>
    ...
    <div class="wrap">
        <div class="container">
            <div class="char-left">
                ...
                <img src="{{ asset('/') }}dailysharkFiles/smartbulb/kit.jpg" alt />
            </div>
            <div class="char-right">
                ...
                <ul class="char">
                    ...
                    <li>Ugao gledanja<span> 355° - 120°</span></li>
                    <li>Napajanje<span> 100-240V</span></li>
...
<section class="block7">
    <div class="wrap">
        ...
        <div class="reviews">
            <div>
                <div class="rev-item">
                    <img src="{{ asset('/') }}dailysharkFiles/smartbulb/rev1.jpg" alt />
            ...
            <div>
                <div class="rev-item">
                    <img src="{{ asset('/') }}dailysharkFiles/smartbulb/rev2.jpg" alt />
                    <span>Vredi!</span>
            ...
            <div>
                <div class="rev-item">
                    <img src="{{ asset('/') }}dailysharkFiles/smartbulb/rev3.jpg" alt />
