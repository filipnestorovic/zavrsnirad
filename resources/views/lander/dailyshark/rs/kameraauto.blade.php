...
<head>
    ...
    <style>
        .block-1 {
            height: 490px;
            background: rgba(0, 0, 0, 0) url("{{ asset('/') }}dailysharkFiles/kameraauto/bg-top.jpg") no-repeat scroll center 0px;
        }
        .block-1 .sale {
            top: 65px;
            left: -20px;
        ...
        @media screen and (max-width: 639px) {
            .block-1 {
                height: auto;
                background: rgba(0, 0, 0, 0) url("{{ asset('/') }}dailysharkFiles/kameraauto/bg-top-320.jpg") no-repeat scroll left 43% top 0px;
            }
            .block-1 .sale {
                top: 60px;
                left: 35px;
...
<section class="block-3" id="blk3">
    <div class="wrap clearfix">
        ...
        <img class="pic-1" src="{{ asset('/') }}dailysharkFiles/kameraauto/b3-1.jpg" alt="HD Cam Mirror">
        ...
        <img class="pic-2" src="{{ asset('/') }}dailysharkFiles/kameraauto/b3-2.jpg" alt="HD Cam Mirror" style="margin-top: -30px;">
...
<section class="block-5">
    <div class="wrap">
        ...
        <div class="center"><img src="{{ asset('/') }}dailysharkFiles/kameraauto/b5-0.jpg" alt="HD Cam Mirror"></div>
        <div class="img-cont clearfix">
            <img src="{{ asset('/') }}dailysharkFiles/kameraauto/b5-1.jpg" alt="HD Cam Mirror">
            <img src="{{ asset('/') }}dailysharkFiles/kameraauto/b5-2.jpg" alt="HD Cam Mirror">
        </div>
        <a href="#order-form" class="button-m">PORUČITE SADA</a>
    </div>
</section>
            ...
            <div>
                <div>
                    <div class="rev-item" style="width: 291.2px;">
                        <div><img src="{{ asset('/') }}dailysharkFiles/kameraauto/rev-1.jpg" alt="HD Cam Mirror"></div>
                    ...
                    <div class="rev-item" style="width: 291.2px;">
                        <div><img src="{{ asset('/') }}dailysharkFiles/kameraauto/rev-2.jpg" alt="HD Cam Mirror"></div>
                        <h3>MARKO SIMANIĆ</h3>
                    ...
                    <div class="rev-item" style="width: 291.2px;">
                        <div><img src="{{ asset('/') }}dailysharkFiles/kameraauto/rev-3.jpg" alt="HD Cam Mirror"></div>
