...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/') }}dailysharkFiles/kamera4/main.css" type="text/css">
</head>
<body>
...
<section class="block-3" id="blk3">
    <div class="wrap clearfix">
        ...
        <img class="pic-1" src="{{ asset('/') }}dailysharkFiles/kamera4/b3-1.png" alt="HD Cam Mirror">
        ...
        <img class="pic-2" src="{{ asset('/') }}dailysharkFiles/kamera4/b3-2.png" alt="HD Cam Mirror" style="margin-top: -30px;">
...
<section class="block-5">
    <div class="wrap">
        ...
        <div class="center"><img src="{{ asset('/') }}dailysharkFiles/kamera4/b5-0.png" alt="HD Cam Mirror"></div>
        <div class="img-cont clearfix">
            <img src="{{ asset('/') }}dailysharkFiles/kamera4/b5-1.png" alt="HD Cam Mirror">
            <img src="{{ asset('/') }}dailysharkFiles/kamera4/b5-2.png" alt="HD Cam Mirror">
        </div>
        <a href="#order-form" class="button-m">PORUČITE SADA</a>
    </div>
</section>
            ...
            <div>
                <div>
                    <div class="rev-item" style="width: 291.2px;">
                        <div><img src="{{ asset('/') }}dailysharkFiles/kamera4/rev-1.png" alt="HD Cam Mirror"></div>
                    ...
                    <div class="rev-item" style="width: 291.2px;">
                        <div><img src="{{ asset('/') }}dailysharkFiles/kamera4/rev-2.png" alt="HD Cam Mirror"></div>
                        <h3>MARKO SIMANIĆ</h3>
                    ...
                    <div class="rev-item" style="width: 291.2px;">
                        <div><img src="{{ asset('/') }}dailysharkFiles/kamera4/rev-3.png" alt="HD Cam Mirror"></div>
