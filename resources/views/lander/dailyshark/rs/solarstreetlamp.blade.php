    ...
    <div class="row-3">
        <div class="mainProduct">
            <img class="label" src="{{ asset('/') }}dailysharkFiles/solarledlamp/hit.svg"> <img
                src="{{ asset('/') }}dailysharkFiles/solarstreetlamp/sec-1-product.png">
                ...
                <div class="form-box">
                    ...
                    <form method="POST" action="{{$orderRoute}}" class="al-form">
                        ...
                        <div class="form-group"><input type="text" class="form-control" name="name"
                                                       placeholder="Ime i prezime" required="" value=""></div>
        ...
        <div class="mainInfo">
            <div class="infoBox">
                ...
                <ul>
                    ...
                    <li>
                        <img src="{{ asset('/') }}dailysharkFiles/solarledlamp/check.svg">
                        <p><b>Napaja se solarnom energijom</b></p>
                    </li>
                    <li>
                        <img src="{{ asset('/') }}dailysharkFiles/solarledlamp/check.svg">
                        <p><b>Detektuje kretanje i automatski se pali</b></p>
                    </li>
                    <li>
                        <img src="{{ asset('/') }}dailysharkFiles/solarledlamp/check.svg">
                        <p><b>Može se brzo i lako pričvrstiti na bilo koju površinu</b></p>
                    </li>
                </ul>
            </div>
        </div>
...
<section class="sec-2">
    <div class="container">
        <div class="block-1">
            <h2>SOLAR STREET LAMP za svako dvorište</h2>
            <p class="font-m">Ovaj led reflektor poseduje 104 led sijalice koje su veoma jake a u isto vreme vrlo
                ekonomične.
            </p>
            <p>Nema potrebe da koristite strujne žice za ugradnju LED lampe, dolazi sa solarnim panelom koji prikupi
                sasvim dovoljno energije
...
<section class="sec-3">
    ...
    <div class="container">
        <div class="block-1"><img src="{{ asset('/') }}dailysharkFiles/solarstreetlamp/sec-3-product.png"></div>
        <div class="block-2">
            <p>Led lampa ima senzor koji se aktivira na najmanji pokret ispred ili sa bočne strane lampe. Momentalno se
                pali jako svetlo bilo da naiđe neko od ukućana, kućni ljubimac ili nezvani gost.
            </p>
            <ul class="itemList">
                <li>
                ...
                <li>
                    ...
                    <p><b>Noću ne morate da tražite prekidače za svetla u mraku.</b> Čim se pojavite ispred reflektora
                        on se aktivira.
                    </p>
                </li>
                <li>
...
<section class="sec-4">
    <div class="sec-t-cont">
        <div class="sec-t-wrap">
            <h2>Gde postaviti SOLAR STREET LAMP?</h2>
...
<section class="sec-5">
    <div class="sec-t-cont">
        <div class="sec-t-wrap">
            <h2>Prednosti Solar Street Lamp</h2>
            <div class="divided"><img src="{{ asset('/') }}dailysharkFiles/solarledlamp/divided.svg"></div>
        </div>
    </div>
    <div class="container">
        <div class="block">
            <div class="item">
                <div class="item-img"
                     style="background-image: url('{{ asset('/') }}dailysharkFiles/solarstreetlamp/sec-5-img.jpg')"><img
                        class="icon" src="{{ asset('/') }}dailysharkFiles/solarledlamp/sec-5-icon-1.svg"></div>
                <div class="item-text">
                    <h4>Dugotrajne led sijalice</h4>
                    <p>SOLAR STREET LAMP baca jako i lepo led svetlo. Led sijalice nisu samo ekonomične jer ne troše
                        energiju, nego se mogu i trajati jako dugo (radni vek oko 100 000 svetlećih sati). Uzevši u
                        obzir da se reflektor pali samo kada detektuje pokret,
        ...
        <div class="block">
            <div class="item">
                <div class="item-img"
                     style="background-image: url('{{ asset('/') }}dailysharkFiles/solarstreetlamp/sec-5-img-2.jpg')"><img
                ...
                <div class="item-text">
                    ...
                    <p>Led reflektor ima solarni sistem, pa radi besplatno bez ikakvog dodatnog napajanja.
                        Osvetljava do 15 metara ispred, a ima nastavke koji osvetljavaju i sa bočne strane tako da ovde
                        imate praktično 3 reflektora u jednom.
                    </p>
                </div>
            </div>
            <div class="shadow"><img src="{{ asset('/') }}dailysharkFiles/solarledlamp/shadow.svg"></div>
...
<section class="sec-6">
    <div class="sec-t-cont">
        <div class="sec-t-wrap">
            <h2>Solar Street Lamp je otporan na sve svetlosne uslove</h2>
...
<section class="sec-7">
    ...
    <div class="container">
        <div class="block">
            ...
            <ul class="stepList">
                <li>
                    <img src="{{ asset('/') }}dailysharkFiles/solarstreetlamp/sec-7-img-2.jpg">
                </li>
            </ul>
        </div>
        <div class="block">
            <div class="content">
                ...
                <div class="content-foot">
                    ...
                    <p>Solar Street Lamp se može montirati na sve navedene materijale, a u kompletu dolazi i set
                        tiplova i šrafova potrebnih za postavljanje.
                    </p>
                </div>
            </div>
        </div>
...
<section class="sec-8">
    <div class="container">
        <div class="block-1"><img src="{{ asset('/') }}dailysharkFiles/solarstreetlamp/sec-8-product.png"></div>
        <div class="block-2">
            <h2>Karakteristike Solar Street Lamp</h2>
            ...
            <a class="button" href="#buy" data-attach="scrollTo"
               style="margin-top:15px !important;width:100% !important;">Naručite odmah </a>
        </div>
    </div>
</section>
<section class="sec-9">
            ...
            <div>
                <div class="reviewItem">
                    <div class="reviewBox">
                        ...
                        <div class="userText">
                            <p>Nedavno smo završili izgradnju male vikendice, ali smo odmah postali meta lopova koji su
                                odneli mešalicu i još neki alat.
                                Razmišljali smo kako da osvetlimo jer još nismo uveli struju i komšinica nam je
                                predložila da uzmemo ovaj reflektor pošto ga i ona koristi.
                                Moram da priznam da je ovo fenomenalan proizvod, jako osvetli dvorište čim neko ili
                                nešto prođe pored. BRAVO!!! </p>
                            <img class="image"
                                 src="{{ asset('/') }}dailysharkFiles/solarstreetlamp/rev1.png"/>
                        </div>
                    </div>
                </div>
            </div>
            <div>
                <div class="reviewItem">
                    <div class="reviewBox">
                        ...
                        <div class="userText">
                            <p>Supruga i ja živimo u predgrađu i kada uveče dođemo kući prvo moramo da osvetlimo
                                telefonom, da bismo videli prići vratima i otključati ih. Nemamo izveden strujni kabal
                                ispred kuće i zbog toga nismo imali svetlo.
                                Od kada smo stavili ovaj reflektor, on se upali čim uđemo u dvorište i osvetli sa svih
                                strana. Ovo je prava stvar, dugo nismo ništa bolje kupili.
                            </p>
                            <img class="image"
                                 src="{{ asset('/') }}dailysharkFiles/solarstreetlamp/rev1.jpg"/>
                        </div>
                    </div>
                </div>
            </div>
            <div>
                <div class="reviewItem">
                    <div class="reviewBox">
                        ...
                        <div class="userText">
                            <p>Veoma je pogodna za ulaze u mračno dvorište. Kuća nam je malo zabačena i uvek me je bilo
                                strah kada ulazim u dvorište. Sada nemam tih problema, lampa osvetli kao da je dan. :))
                            </p>
                            <img class="image" src="{{ asset('/') }}dailysharkFiles/solarstreetlamp/rev2.jpg"/>
                        </div>
                    </div>
                </div>
            </div>
            <div>
                <div class="reviewItem">
                    <div class="reviewBox">
                        ...
                        <div class="userText">
                            <p>Naručio sam 4 ova reflektora. Imam veliko dvorište i deo imanja na kom su mi radne
                                mašine. Sada više ne moram noću da palim svetla i ujutru da ih gasim. Samo se pali noću
                                čak i kada kuće naiđe. Odlično je, mislim da će
                                lopovi zaobilaziti moju kuću. Konačno mirno spavam ha ha.
                            </p>
                            <img class="image"
                                 src="{{ asset('/') }}dailysharkFiles/solarstreetlamp/rev4.jpg"/>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="sec-10">
    <div class="sec-t-cont">
        <div class="sec-t-wrap">
            <h2>Kako poručiti Solar Street Lamp?</h2>
            <div class="divided"><img src="{{ asset('/') }}dailysharkFiles/solarledlamp/divided.svg"/></div>
        </div>
    </div>
    <div class="container">
...
<section class="sec-1">
    ...
    <div class="row-3">
        <div class="mainProduct">
            <img class="label" src="{{ asset('/') }}dailysharkFiles/solarledlamp/hit.svg"/>
            <img src="{{ asset('/') }}dailysharkFiles/solarstreetlamp/sec-1-product.png"/>
            <div class="daybuy"><span>Danas</span> 92 kupca</div>
        </div>
