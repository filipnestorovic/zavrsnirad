...
<head>
    ...
    <style>
        ...
        .section-2 {
            background: url({{ asset('/') }}dailysharkFiles/portablejuicingcup/top-bnr-mob.png) center 90% / cover no-repeat;
            padding: 40px 0 135vw;
        }
        @media (min-width: 768px) {
            .section-2 {
                padding-bottom: 40px;
                background-image: url({{ asset('/') }}dailysharkFiles/portablejuicingcup/top-banner.png);
        ...
        @media (min-width: 768px) {
            .section-9 {
                padding: 50px 0;
                background-image: url({{ asset('/') }}dailysharkFiles/portablejuicingcup/customer.png);
        ...
        @media (min-width: 768px) {
            .section-11 {
                padding: 50px 0;
                background-image: url({{ asset('/') }}dailysharkFiles/portablejuicingcup/offer.png);
                background-position-x: 35%;
            }
        }
        .section-13 {
            background: url({{ asset('/') }}dailysharkFiles/portablejuicingcup/bottom-bnr-mob.png) center bottom/cover no-repeat;
            padding: 35px 0 150vw;
        }
        @media (min-width: 768px) {
            .section-13 {
                padding: 40px 0;
                background-image: url({{ asset('/') }}dailysharkFiles/portablejuicingcup/bottom-banner.png);
...
<div class="wrapper">
            ...
            <div class="header-inner">
                <div class="logo">
                    <a href="#" class="tracking-link no-redirect">
                        <img src="{{ asset('/') }}dailysharkFiles/portablejuicingcup/logo.png" alt="Logo" class="no-lazy">
                    </a>
                </div>
            </div>
        </div>
    ...
    <main>
                    ...
                    <div class="grid-layout ">
                        <div class="wrap-inner layt-50-50">
                            <div class="columns col-left">
                                <div class="wrap-col">
                                    <p><img src="{{ asset('/') }}dailysharkFiles/portablejuicingcup/logo.png" alt="logo"></p>
        ...
        <section class="section-2">
            <div class="container">
                <div class="wysiwyg-content product-banner top-banner ">
                    <h2>ZDRAV OBROK ILI NAPITAK UVEK PRI RUCI,<br> NA BILO KOM MESTU</h2>
                        ...
                        <div class="w_inner">
                            <div class="w_item ">
                                ...
                                <div class="w_content_wrap">
                                    ...
                                    <div class="w_desc">
                                        <p>PORTABLE JUICING CUP je napravljen isključivo od najboljih materijala i dizajniran je za dugi vek trajanja</p>
                                    </div>
                                </div>
                            </div>
                            <div class="w_item ">
        ...
        <section class="section-5">
            <div class="container">
                <div class="wysiwyg-content middle-banner ">
                    <p><img src="{{ asset('/') }}dailysharkFiles/portablejuicingcup/mid-banner.png" alt=""><img src="{{ asset('/') }}dailysharkFiles/portablejuicingcup/mid-bnr-mob.png" alt=""></p>
                </div>
            </div> <!--/container-->
        </section> <!-- /row-wrapper-->
            ...
            <div class="container">
                <div class="editor functional">
                    <div class="usefull has-width">
                        ...
                        <p>Zaboravite sve tradicionalne kuhinjske blendere kojima je potrebna električna utičnica! PORTABLE JUICING CUP ima sopstvenu bateriju koja se puni, što znači da ga možete poneti sa sobom gde god idete - kampovanje, teretanu, dugu šetnju ili gde vam god padne na pamet!</p>
                    </div>
                        ...
                        <div class="wrap-inner layt-50-50">
                            <div class="columns col-left">
                                <div class="wrap-col">
                                    ...
                                    <p>Punjiva baterija omogućava da PORTABLE JUICING CUP nosite sa sobom gde god krenete! Možete napraviti i do deset smutija jednim punjenjem!</p>
                                    <h3>Snažan mikser</h3>
                                    <p>Sa svojim četvorokrakim nožem od nerđajućeg čelika, PORTABLE JUICING CUP će se nositi sa svime što u njega ubacite! Poseduje snažan motor koji muti brzo i lako.</p>
                            ...
                            <div class="columns col-right">
                                <div class="wrap-col">
                                    <p><img src="{{ asset('/') }}dailysharkFiles/portablejuicingcup/img-1.png" alt=""></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="grid-layout has-width">
                        <div class="wrap-inner layt-50-50">
                            ...
                            <div class="columns col-right">
                                <div class="wrap-col">
                                    <p><img src="{{ asset('/') }}dailysharkFiles/portablejuicingcup/img-2.png" alt=""></p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="w_item ">
                                ...
                                <div class="w_desc">
                                    <p>Uz ovaj blender možete brzo i jednostavno praviti smutije kakve god želite.
                                        ...
                                        Savršen je poklon za studente i one koji žive u prenatrpanim stanovima jer PORTABLE JUICING CUP zauzima jako malo mesta.</p>
                                </div>
                            </div>
        ...
        <section class="section-8">
            <div class="container">
                <div class="guides ">
                    <h2 class="w_main_title"><span class="text">Kako koristiti PORTABLE JUICING CUP</span></h2>
                    <div class="w_outer">
                        <div class="w_inner">
                            <div class="w_item ">
                                ...
                                <div class="w_desc">
                                    ...
                                    <p><img src="{{ asset('/') }}dailysharkFiles/portablejuicingcup/step-1.jpg" alt=""></p>
                                </div>
                            </div>
                            <div class="w_item ">
                                ...
                                <div class="w_desc">
                                    ...
                                    <p><img src="{{ asset('/') }}dailysharkFiles/portablejuicingcup/step-2.png" alt=""></p>
                                </div>
                            </div>
                            <div class="w_item ">
                                ...
                                <div class="w_desc">
                                    ...
                                    <p><img src="{{ asset('/') }}dailysharkFiles/portablejuicingcup/step-3.jpg" alt=""></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="section-9">
            <div class="container">
                <div class="wysiwyg-content best-reviews shop-link ">
                    <h2><span style="color: #74bd1f;">Šta naši kupci kažu o PORTABLE JUICING CUPU</span></h2>
                            ...
                            <div class="w_item ">
                                ...
                                <div class="w_desc">
                                    <p>Moje dete je vrlo izbirljivo u hrani. Ispljune barem polovinu onoga što joj dam da jede.
                                        Od kada sam kupila PORTABLE JUICING CUP, pravim ukusne i zdrave smutije za moju malu devojčicu, koje ona naprosto obožava!
        ...
        <section class="section-11">
            <div class="container">
                <div class="wysiwyg-content special-offer text-large ">
                    ...
                    <p>PORTABLE JUICING CUP olakšava pripremu najboljih i najukusnijih smutija, koktela, poslastica, pa čak i dečje hrane!
                    ...
                    <div class="container">
                        <div class="inner">
                            <div class="floating-desc">
                                <p><img src="{{ asset('/') }}dailysharkFiles/portablejuicingcup/logo.png" alt="logo" class=""></p>
