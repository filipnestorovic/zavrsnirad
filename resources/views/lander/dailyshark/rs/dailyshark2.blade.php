...
<head>
    ...
    <link href="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/2.13-landend-base.css" type="text/css" rel="stylesheet">
...
<div id="imk70DZKGMb399trSeGQ79IWrp7T9Clk" class="widget widget-section " >
    <div class="row">
        <div class="container " >
            <div id="vzzvFGPL869J8G3hq6Vo20TWoMhGQW02" class="widget widget-text">
                <h1>AKTYWNA PIANKA DO SUCHEGO MYCIA TAPICERII DAILYSHARK</h1>
            </div>
            <div id="tRbiRN0T1IIJCbMwpRnCLgaQHcguq4Tp" class="widget widget-text">
                <h2>PIANKA DAILYSHARK TO SPRAY DO SUCHEGO MYCIA I DEZYNFEKCJI RÓŻNYCH POWIERZCHNI O WIELOFUNKCYJNYM ZASTOSOWANIU: - salony samochodowe, sofy, krzesła kuchenne, tapicerki i zużyte buty</h2>
            </div>
            ...
            <img id="KpWQMXSW0EdkmA8PEgN5WaVvuCNBiyx9"
                 width="287" height="73"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/bg5.png"
                 alt=""
            >
            <img id="IsTFrG7GgBUn15WO5HhMJThU0EkOb9wn"
                 width="307" height="74"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/bg6.png"
                 alt=""
            >
...
<div id="aaOnmXnxRAlsiUCnTMUxlVfHzgDeI5FZ" class="widget widget-section " >
    <div class="row">
        <div class="container " >
            <div id="u1nADw3T42RrDm0F4ZENecufS0uzgOw3" class="widget widget-text">
                <p>Gęsta piana rozpuszcza brud i przenosi go na powierzchnię. Ten spray / pianka oferuje innowacyjne rozwiązanie do czyszczenia brudnych powierzchni.</p>
            </div>
            <div id="b5fs5xHszCyy70TLoBqAWhmC52SCvOrR" class="widget widget-text">
                <h2>DAILYSHARK</h2>
            </div>
            <div id="PE2E4yNQatnJ2RanbI9WfPktTE1qenXQ" class="widget widget-text">
                <h3>PIANKA DO TAPICERKI "PRANIE NA SUCHO"</h3>
            </div>
            <a href="#XqJ6sTI6tNbSss1nJLcdTzqTIcUgVGzG" id="a90u0du3m9mTyslbdsvyKObnST5Gi59N" class="widget widget-button"  version="3" subtype="anchor" rel="noopener noreferrer" >
                <div class="widget-overlay"></div>
                <div id="bLHE0DRocUdJdg4Ak0gy4US7TIT8dZSa" class="widget widget-text">DOWIEDŹ SIĘ WIĘCEJ</div>
            </a>
...
<div id="nh3lNaIHoM4Trg8dCMXTMuxLP0kOGfQt" class="widget widget-section " >
    <div class="row">
        <div class="container " >
            <i id="Db8xGWkxiMJKyd4Bd50GMWL3Lafx7E2F" class="fa fa-car widget widget-icon"></i>
            <div id="a81rJX4dhrMZ6O5sLirGJbbzEpZqKf22" class="widget widget-box" ></div>
            <div id="HTZ6tB6vvz1NRBeqvbEKA2xvC0Pby2Zl" class="widget widget-text">
                <p>CZYSTY I ŚWIEŻY SAMOCHÓD</p>
            </div>
            <div id="HqtfCu4yLlPVkVhtEJZGAZM76Fs1y5fV" class="widget widget-text">
                <p>Pianka doskonale nadaje się do czyszczenia brudnych siedzeń, wnętrza lub dachu samochodu!</p>
            </div>
            <div id="E3hnCRQ0Pb3oFJgzfaFXBVLETnwoIaNS" class="widget widget-text">
                <p>-----------------------------------------</p>
            </div>
            <div id="ZwzpAaNbrWgV42lUQrfowzTuMPIJe8cq" class="widget widget-box" ></div>
            <i id="nPHc7HmomUM2nNiJadpz2d67Nilodhs7" class="fa fa-times-circle widget widget-icon"></i>
            <div id="QyIT2yhnpcnt0KPip2piU3GEOTtDVvMX" class="widget widget-text">
                <p>100% biodegradowalny</p>
            </div>
            <div id="ElaoTFo0RrC29oTplU4wmy8giTrF7nKE" class="widget widget-text">
                <p>Produkt jest całkowicie biodegradowalny! Przechowywać w suchym i chłodnym miejscu! Unikać kontaktu ze skórą! Trzymać z dala od dzieci!</p>
            </div>
            <div id="KOxohsMmgThyRVipkMdGx0OTDU39t8tJ" class="widget widget-text">
                <p>-----------------------------------------</p>
            </div>
            <div id="VdbGc9WewRXPFv8coRdtcpipxe8uR9kU" class="widget widget-box" ></div>
            <i id="K0dqA8txpsr6QUSnUphEP2ekUIsAS4dF" class="fa fa-home widget widget-icon"></i>
            <div id="TSiHp4VHuWuFyOiTz9KKqXycHsk9RM0Q" class="widget widget-text">
                <p>CZYSTE MEBLE I TAPICERKA</p>
            </div>
            <div id="fbFFyD1dqdUJDuizJwlSky6iEtgieH16" class="widget widget-text">
                <p>Pianki można używać do czyszczenia sof, krzeseł kuchennych, dywanów, a nawet okien i powierzchni ceramicznych</p>
            </div>
            <div id="Vfhq3qBQUHRws4NQTnwM2HXZTqkTKXhA" class="widget widget-text">
                <p>-----------------------------------------</p>
            </div>
            <div id="JgqcWPA1qTUxrcfegrwOPX77aLX9VurH" class="widget widget-box" ></div>
            <i id="Lhv71zUfQETHxDrkMgwgJgd9yscuH9ve" class="fa fa-magic widget widget-icon"></i>
            <div id="Bf0NlsXC2VzmBSos7SciPfEzUeXeibTF" class="widget widget-text">
                <p>ŁATWE, SZYBKO I PRAKTYCZNE</p>
            </div>
            <div id="cmkOxhwHab1POW26orid31d2ZlNlegFt" class="widget widget-text">
                <p>Pianka nie wymaga dodatkowego prania. Wszystko, co musisz zrobić, to spryskać, poczekać i wytrzeć ręcznikiem</p>
            </div>
            <div id="qogBAl08RyKuDfUKtQcRMy0NUWH0CV9f" class="widget widget-text">
                <p>-----------------------------------------</p>
            </div>
            <div id="OTCrDvTITpNlsIVyC4u1GJxI3Hl1Q2UE" class="widget widget-box" ></div>
            <div id="uzyvdRc2c5RETZlBcHzxXMQgTO8rwsrk" class="widget widget-text">
                <p>NOWE ŻYCIE DLA TWOICH STARYCH BUTÓW</p>
            </div>
            <div id="I3ENd4TWnTSqcUZBz3ApriLe6uODlnB8" class="widget widget-text">
                <p>Pianki można używać na każdej powierzchni tekstylnej - nawet na butach! Twoje ulubione zamszowe buty znów są jak nowe!</p>
            </div>
            <div id="zSQIaoWK1cS25NqctwNSHXTRxUdfo1ns" class="widget widget-text">
                <p>-----------------------------------------</p>
            </div>
            ...
            <div id="TbapAWUTwwomusrCuv5xe5x9wseL6zvy" class="widget widget-text">
                <p>Plamy i brud nie stanowią już problemu. Innowacyjny piankowy spray zajmie się nimi w ciągu kilku minut!</p>
            </div>
            ...
            <img id="Rs76L4gHfPSCa8dwXS8H7fTEaUFhAiwt"
                 ...
                 alt=""
            >
            <img id="kbl9saf8K8yxVgx9orhCnFzvJW11mey8"
                 width="307" height="74"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/bg6.png"
                 alt=""
            >
            <img id="OkpspwvOUqWSTqHi8WDDtBLISROJO3JM"
                 width="307" height="74"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/bg6.png"
                 alt=""
            >
            <img id="RTT7P7TKSLsqaxTyIAaHMJrJg2o5TusV"
                 width="307" height="74"
                 class="widget widget-image"
                 data-original="../images.assets-landingi.com/fpOnYY7a/bg6.png"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/bg6.png"
                 alt=""
            >
            <img id="K0JDRWvxTwsPmwr6Ag8GnT6RCDGXb3sB"
                 width="307" height="74"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/bg6.png"
                 alt=""
            >
            <img id="as1HNyNCFGkpcf9Txk1zLnxIXp5reCZH"
                 width="307" height="74"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/bg6.png"
                 alt=""
            >
            <i id="Jz89mZGtAhldJBaFWxqsyIyyJywCgr1R" class="fa fa-arrow-down widget widget-icon"></i>
            <div id="CJSwGTD2meBu7IlEs8d7Tui3FvnmUsQG" class="widget widget-box" ></div>
            <img id="zCitDE1cMPWBxHc1lDTTLbCy9PL3yvHf"
                 width="307" height="74"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/bg6.png"
                 alt=""
            >
            <img id="wbfex4GQPgXsKv3PasTreNxMdseICXTa"
                 width="307" height="74"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/bg6.png"
                 alt=""
            >
            <img id="T8qgJOmDPTqTrxzLoK0ZOX5LmCoTloRQ"
                 width="307" height="74"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/bg6.png"
                 alt=""
            >
            <img id="aHquEETsDUTBtGoLqsmMOhyT5TOlKOsL"
                 width="307" height="74"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/bg6.png"
                 alt=""
            >
            <div id="ef35Dy87yfciTJIq6a9Zgtq9CRN5A4II" class="widget widget-box" ></div>
        </div>
    </div>
</div>
<div id="uDuTefOJm1ydxTmulwmTa2pixT3nZgpT" class="widget widget-section " >
    <div class="row">
        <div class="container " >
            <div id="pxVtZJq7IMdENGsFBaV3a8y0WOO9xulf" class="widget widget-text">
                <h3>SUPER AKTYWNA PIANKA DO CZYSZCZENIA POWIERZCHNI</h3>
            </div>
            <div id="WiKdTHgng7T6QG5f4vIeaoQhvJpITexc" class="widget widget-text">
                <h2>DAILYSHARK ACTIVE FOAM 400 ML.</h2>
            </div>
            <div id="k1cK1ZIcXoJgvmROAMn2kkz6VVeGWOMA" class="widget widget-text">
                <p>Wiele problemów można rozwiązać za pomocą jednego produktu! Z praktycznym zastosowaniem w domu, biurze, a nawet samochodzie. Produkt wysokiej jakości! Wyprodukowane w Niemczech!</p>
            </div>
            ...
            <a href="#XqJ6sTI6tNbSss1nJLcdTzqTIcUgVGzG" id="QeDOh2oT1p6tbqLvzCMaZlIzAp8d4T6q" class="widget widget-button"  version="3" subtype="anchor" rel="noopener noreferrer" >
                <div class="widget-overlay"></div>
...
<div id="cOkgTEvxeaG7r3256NDh12S58Jxi1Jy7" class="widget widget-section " >
    <div class="row">
        <div class="container " >
            <div id="oTtPMVhODyaResT92qAeqDL2NTTtCErd" class="widget widget-text">
                <h3><font color="#ffe800">PIANKA DAILYSHARK TO SPRAY DO SUCHEGO MYCIA I DEZYNFEKCJI RÓŻNYCH POWIERZCHNI O WIELOFUNKCYJNYM ZASTOSOWANIU:</font></h3>
            </div>
            <div id="PcNTIgWH26kOz5rfxfEMcxB2EUxWTRn2" class="widget widget-text">
                <p>GĘSTA PIANKA rozpuszcza brud i sprawia, że na powierzchni</p>
            </div>
            <div id="n2PKnNnWQymoEPGSLCQaGFc33o7nvdZW" class="widget widget-text">
                <h3><font color="#ffe800">DLACZEGO DAILYSHARK JEST LEPSZY NIŻ INNE PRODUKTY DO CZYSZCZENIA?</font></h3>
            </div>
            <div id="Pm8AR7KmGLir3STB2LBfsZtkcX8DTJpI" class="widget widget-text">
                <ul>
                    <li>salony samochodowe, sufity samochodowe, motocykle, łodzie, rowery</li>
                    <li>sofy, krzesła kuchenne, tapicerki i inne tapicerki tekstylne</li>
                    <li>dywany, chodniki</li>
                    <li>okna, okna, ślady owadów</li>
                    <li>zużyte buty, zamsz, skóra</li>
                    <li>spoiny, powierzchnie ceramiczne, drewno, plastik</li>
                </ul>
            </div>
            <img id="eywooLKul2ZfgNTClsy52Fk58MzPIGu8"
                 width="320" height="212"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/DSCF3073.jpg"
                 alt=""
            >
            <img id="ezOJoZw4PC1Tvfy1qFvrMxxW1As5cqmh"
                 width="307" height="74"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/bg6.png"
                 alt=""
            >
            <div id="CQpsFoa5NBIoNCfatHcnSrzVudB5UNMu" class="widget widget-text">
                <p>Zastosowanie: Piankę rozpylaj na zanieczyszczoną powierzchnię, odczekaj kilka sekund, a następnie wytrzyj wilgotną mikrofibrę lub ręcznikiem. Zalecamy, aby ręcznik był neutralny</p>
            </div>
            ...
            <img id="GSC2y6xT8bMODscfuTrkwgl99KvgO0rQ"
                 width="335" height="219"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/DSCF3111.jpg"
                 alt=""
            >
            <img id="U5iVAwcbfaRyTqsLnoIGtZrcl4vk4USS"
                 width="225" height="324"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/DSCF3124.jpg"
                 alt=""
            >
            <div id="IqUeM54wCqoFVokq9lSPm7pTpLdxUw0t" class="widget widget-text">
                <p>Zawiera: Węglowodory alifatyczne: 5% lub więcej, ale mniej niż 15%</p>
                <p>Perfumy (Citral).</p>
            </div>
            <div id="GHC2poPCLHkgKd8TznTe3kxMhWl94Tq6" class="widget widget-box" ></div>
            <div id="Mhx4akkqm15zh0AdFyLyUJXbl9r4fcOX" class="widget widget-box" ></div>
            <div id="TyKrT50OzT9Z77sh6oSghVLqsg0fkkcJ" class="widget widget-box" ></div>
            <div id="TSROpv5kbQKw0y9x4zGapnxdi7Hgphrz" class="widget widget-box" ></div>
...
<div id="xXu7AbgLAifiUomBTbNfGi7QAxWx05PN" class="widget widget-section " >
    <div class="row">
        <div class="container " >
            <div id="yFwyCyXaFekEpxufW8Br2x0wNS8Va9JI" class="widget widget-text">
                <p>Jestem bardzo zadowolony! Czyści w kilka minut. Jedna paczka wystarczyła na wszystkie foteliki samochodowe!</p>
            </div>
            <div id="KdWgcw8qxg7B9ZuI6lNEctXcg1qAR39o" class="widget widget-text">
                <h2>OPINIE NASZYCH KLIENTÓW</h2>
            </div>
            <div id="GUpcgCoQf1PM6LUo2vV3p2MLTfCCuDNz" class="widget widget-text">
                <h3>"WYSOKIE RECENZJE PRODUKTU"</h3>
            </div>
            <img id="d0iGW9WhMd8Kcsok0Tp2biOLqBrT2JwN"
                 width="60" height="46"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/icon_4.png"
                 alt=""
            >
            <div id="eoly4ckApTCV7bb767fPDoxaqcz17LBm" class="widget widget-text">
                <p>Paweł Kowalski</p>
            </div>
            <img id="yIw7DsWQB8yfun83JmxkSzfHnLizEm75"
                 width="60" height="46"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/icon_4.png"
                 alt=""
            >
            <img id="y3vGI3XwJZZ5qKKx5hglw8Kcc9gCwRxE"
                 width="373" height="248"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/DSCF3065.jpg"
                 alt=""
            >
            <div id="RPGwEVOrvsfpF9oC6F4Twmh7DT9wH0F6" class="widget widget-text">
                <p>Krystyna Moszczyńska</p>
            </div>
            <div id="kT5wZCm87VfZQbKzcCaK4zHCLcz44ig5" class="widget widget-text">
                <p>Nie wierzyłam, że kiedykolwiek będę w stanie usunąć plamy z moich ulubionych butów!</p>
            </div>
            <div id="oGLqOwcxcKAtKDzmDzbTda2AUzbqhy1G" class="widget widget-text">
                <p>Grzegorz Stanowski</p>
            </div>
            <div id="a5e4vAhKoImu1LNbHq6360dAKi1F3ADL" class="widget widget-text">
                <p>Bardzo ekonomiczny produkt. Myślałem, że kupuję coś, co będzie działało tylko dla mojego samochodu, ale okazało się, że może wyczyścić prawie wszystko. Polecam!</p>
            </div>
            <img id="pJphTPSMx85HTtZNPtsX1PGJbUqOoRXF"
                 width="60" height="46"
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/icon_4.png"
                 alt=""
...
<div id="G0uHePzRrKXsuCV4yXTXks1X52db4wOb" class="widget widget-section " >
    <div class="row">
        <div class="container " >
            ...
            <div id="PJ6krHrwGwcmFqMzFCPTp9OQT1w2kicT" class="widget widget-box" ></div>
            ...
            <img id="FoO2mDIDA62GMSzbUT7k5SFOXiChlUED"
                 ...
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/2BR.png"
                 alt=""
            >
            ...
            <img id="lFqCELilWDrL4TFVFspH68XnrIR4ibcm"
                 ...
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/3BR.png"
                 alt=""
            >
...
<div id="XqJ6sTI6tNbSss1nJLcdTzqTIcUgVGzG" class="widget widget-section " >
    <div class="row">
        <div class="container " >
            <div id="zKoPPmrhCeDz1dPBEmGFvtnmrnm77S3b" class="widget widget-text">
                <h1>ZRÓB SZYBKIE ZAMÓWIENIE </h1>
            </div>
            <div id="A6kdJTQqhPFJ8zqrzUEv73GrAcgzbSlJ" class="widget widget-text">
                <ul>
                    <li>DARMOWA DOSTAWA</li>
                    <li>PŁACISZ PRZY ODBIÓRU Z OPCJĄ PRZEGLĄDU</li>
            ...
            <img id="E7KrT1lc3zS5lRv2qHUZ21WPVNb38rPw"
                 ...
                 class="widget widget-image"
                 src="{{ asset('/') }}dailysharkFiles/dailyshark/lander2/DSCF3115.jpg"
                 alt=""
            >
        </div>
    </div>
</div>
<div id="v2tp0eX4ZOULN6225oIrD1htR3HCem1s" class="widget widget-section " >
    <div class="row">
        <div class="container " >
