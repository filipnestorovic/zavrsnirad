...
<div class="main__wrapper s__main">
    <div class="header">
        <div class="header__container">
            <div class="logo font-mons"><b>ΕΠΙΘΕΜΑ ΑΔΥΝΑΤΙΣΜΑΤΟΣ</b></div>
            <div class="h1 font-mons" data-xd="t3"><b>Για επίπεδο και ελκυστικό στομάχι!</b></div>
        </div>
    </div>
    <section class="sec1">
        <div class="sec1__container">
            <div class="sec1__h1 only-web sec1__text__gr font-mons" data-xd="t2">Χάστε βάρος γρήγορα και εύκολα, χωρίς το αποτέλεσμα γιο-γιο!</div>
            <div class="h1 only-mob sec1__text__gr font-mons" data-xd="t2">Χάστε βάρος γρήγορα και εύκολα</div>
            <div class="h2 only-mob font-mons" data-xd="t2">χωρίς το αποτέλεσμα γιο-γιο!</div>
            <img alt class="sec1__prod only-web" src="{{ asset('/') }}naturapharmFiles/slimmingpatch/prod2.png"><img alt class="sec1__prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimmingpatch/prod2.png"><button class="btn for_scroll"> ΠΑΡΑΓΓΕΙΛΤΕ </button>
            <div class="last__block">
                ...
                <ul class="font-PT">
                    ...
                    <li><b>Επιταχύνει</b> τον μεταβολισμό ακόμα και όταν ξεκουράζεστε</li>
                </ul>
        ...
        <div class="sec2__container">
            ...
            <div class="sec2__grid">
                <div class="sec2__part">
                    ...
                    <p class="font-PT">Η εργαστηριακή ανάλυση καθόρισε ότι το προϊόν περιέχει <b class="green"> απολύτως φυσικές ουσίες που έχουν θετικό αποτέλεσμα σε όλο τον οργανισμό.</b></p>
    ...
    <section class="sec3">
        <div class="sec3__container">
            ...
            <div class="h1 blue font-mons" data-xd="t2">ΕΠΙΘΕΜΑΤΑ ΑΔΥΝΑΤΙΣΜΑΤΟΣ</div>
            <div class="h2 pink font-mons" data-xd="t2">Σε λίγες μόλις ημέρες, το σώμα σας θα έχει <b>καθαριστεί, θα είναι γεμάτο ενέργεια</b> και το βάρος θα έχει μειωθεί ορατά.</div>
            <div class="sec3__grid" dir="rtl">
                <div class="sec3__part" dir="ltr">
                    ...
                    <div class="girl"></div>
                    <p class="white_block pink font-mons only-web">ΤΟ ΕΠΙΘΕΜΑ ΑΔΥΝΑΤΙΣΜΑΤΟΣ ΣΑΣ ΔΙΝΕΙ ΕΝΕΡΓΕΙΑ ΚΑΤΑ ΤΗ ΔΙΑΡΚΕΙΑ ΟΛΗΣ ΤΗΣ ΗΜΕΡΑΣ</p>
                    <button class="btn for_scroll only-web"> ΠΑΡΑΓΓΕΙΛΤΕ </button>
                </div>
                <div class="sec3__part" dir="ltr">
                    <p class="font-PT">
                        Ο μοναδικός συνδυασμός συστατικών διεγείρει την υγιή λειτουργία του σώματος. Αυτή η φόρμουλα δεν έχει αρνητικά αποτελέσματα και μειώσεις στην ενέργεια κατά τη διάρκεια της ημέρας.
                        Τα λίπη λιώνουν γρήγορα και πετάγονται στην επιφάνεια και ο μεταβολισμός σε επιτάχυνση διεγείρει την απώλεια των υγρών.
                        <b class="pink">Με αυτόν τον τρόπο, το πρήξιμο μειώνεται, η κινητικότητα είναι πιο εύκολη και το πιο σημαντικό είναι ότι αποκτάτε ένα πιο αδύνατο και γυμνασμένο σώμα.</b></p>
                    <ul class="font-PT">
                    ...
                    <p class="white_block pink font-mons only-mob">ΤΟ ΕΠΙΘΕΜΑ ΑΔΥΝΑΤΙΣΜΑΤΟΣ ΣΑΣ ΔΙΝΕΙ ΕΝΕΡΓΕΙΑ ΚΑΤΑ ΤΗ ΔΙΑΡΚΕΙΑ ΟΛΗΣ ΤΗΣ ΗΜΕΡΑΣ</p>
    ...
    <section class="sec5">
        <div class="sec5__container">
            <div class="h1 blue font-mons" data-xd="t2">ΕΠΙΘΕΜΑ ΑΔΥΝΑΤΙΣΜΑΤΟΣ</div>
            <div class="h2 blue font-mons" data-xd="t2">Τί είναι τόσο μοναδικό σε αυτή τη σύνθεση?</div>
            <p class="font-PT"> Το σώμα σας μετατρέπεται χάρη στον ειδικό συνδυασμό φυσικών συστατικών <b class="blue"> που παρέχουν ενέργεια και επιταχύνουν την καύση λίπους.</b></p>
                    ...
                    <div class="grafic grafic1">
                        ...
                        <div class="variant">
                            ...
                            <ul class="font-PT">
                                ...
                                <li class="gr">Επίθεμα Αδυνατίσματος</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <section class="sec7">
        <div class="sec7__container">
            <div class="h1 blue font-mons" data-xd="t2"> Αποτελέσματα του</div>
            <div class="h2 blue font-mons" data-xd="t2"> χρήστη </div>
            <div class="sec7__grid" dir="rtl">
                ...
                <div class="sec7__part last_block" dir="ltr">
                    ...
                    <div class="after"></div>
                    <div class="girl-name blue font-mons" data-xd="t46"> Ηλιάνα, 28 ετών</div>
                    <p class="last-p font-PT">Πήρα κιλά αφού γέννησα. Πίστευα ότι θα μπορούσα να χάσω το βάρος εύκολα,
                        αλλά μετά από πολλές δίαιτες, συνέχισα να παίρνω βάρος. Πεινούσα συνέχεια και ήμουν σε κακή
                        διάθεση. Αφού χρησιμοποίησα τα επιθέματα Αδυνατίσματος, άρχισα αμέσως να νιώθω καλύτερα. Είχα
                        περισσότερη ενέργεια κατά τη διάρκεια της ημέρας, ήμουν λιγότερο κουρασμένη το απόγευμα, ζούσα
                        με λιγότερο άγχος. Ως αποτέλεσμα, έφτασα στον στόχο μου μέσα σε 2,5 μήνες. Επίσης, με απλή
                        δίαιτα δεν πέτυχα το στόχο μου ούτε σε έναν χρόνο!</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="sec9__container">
            ...
            <div class="dietolog">
                <div class="photo-name_block">
                    <div class="girl"></div>
                    <p class="blue font-mons"> Δήμητρα, <br> διαιτολόγος </p>
                </div>
                <p class="font-PT">Το Επίθεμα Αδυνατίσματος είναι ένα βιολογικά ενεργό προϊόν με ολοκληρωμένο αποτέλεσμα βελτίωσης της υγείας που ακόμα και οι άνθρωποι γύρω σας θα παρατηρήσουν. Τα θετικά αποτελέσματα μπορείτε να τα δείτε ακόμα και σε εξέταση αίματος. Το χαμηλό επίπεδο χοληστερόλης, το σταθερό επίπεδο σακχάρων, η υγιής ποσότητα πρωτεϊνών είναι αυτά που παρατηρούνται χάρη στα επιθέματα Αδυνατίσματος!</p>
        ...
        <div class="sec10__container">
            <div class="sec10__grid">
                ...
                <div class="sec10__part">
                    ...
                    <img alt class="prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimmingpatch/prod.png"><button class="btn for_scroll"> ΚΑΝΤΕ ΠΑΡΑΓΓΕΛΙΑ </button>
                </div>
            </div>
        </div>
    </section>
    <section class="sec11">
        <div class="sec11__container">
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Ναι! Το Επίθεμα Αδυνατίσματος είναι εκπληκτικό! Έχασα 7 κιλά χωρίς καν να προσπαθήσω σε μόλις ένα μήνα. Τώρα δουλεύω στους κοιλιακούς μου.</p>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Χάνω βάρος με τα επιθέματα αδυνατίσματος εδώ και έναν μήνα. Λίγο λίγο, η όερξή μου μειώθηκε. Ξεκίνησα να νιώθω χορτάτη ακόμα και μετά από μικρές ποσότητες φαγητού. Δεν έκανα δίαιτα, απλώς μείωσα την κατανάλωση ζάχαρης και ζυμαρικών. Αυτό είχε ως αποτέλεσμα να χάσω 12 κιλά. Το λίπος από το στήθος και το στομάχι μου έχει φύγει. Δείτε το σώμα μου.</p>
        ...
        <div class="sec12__container">
            <div class="sec12__grid">
                <div class="sec12__part">
                    <div class="h2 blue font-mons" data-xd="t2">ΕΠΙΘΕΜΑ ΑΔΥΝΑΤΙΣΜΑΤΟΣ – Για επίπεδο και ελκυστικό στομάχι!</div>
                    <div class="h1 blue font-mons" data-xd="t2">ΕΠΙΘΕΜΑ ΑΔΥΝΑΤΙΣΜΑΤΟΣ</div>
                ...
                <div class="sec12__part">
                    <div class="order">
                        <form action="{{$orderRoute}}" class="form font-mons main_form" data-xd="t76" id="order_form" method="post">
                            ...
                            <div class="zakaz blue">ΕΙΣΑΓΕΤΕ ΠΛΗΡΟΦΟΡΙΕΣ ΑΠΟΣΤΟΛΗς</div>
                            ...
                            <input class="inp font-mons" name="shipping_zip" placeholder="Ταχυδρομικός κώδικας" type="text" required>
