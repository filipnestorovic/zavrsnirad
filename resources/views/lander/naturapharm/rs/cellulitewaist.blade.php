...
<head>
    ...
    <style>
        ...
        .top-block-v2{
            padding: 432px 0 0;
            background: url('{{ asset('/') }}naturapharmFiles/cellulitewaist/top-block-v2.png') 50% 0 no-repeat;
        }
    </style>
</head>
<body>
...
<!-- -v2 -->
    ...
    <section class="detail-block about_section">
        ...
        <div class="text-cont">
            ...
            <img src="{{ asset('/') }}naturapharmFiles/cellulitewaist/pic-1.png" alt="Burning Belt">
        </div>
    </section>
