    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 text-right header__title">
                <h1>Sprej protiv bolova u mišićima i zglobovima</h1>
                <h2>TIGERS OIL</h2>
...
{{--                <div class="ingredients"><img alt="" src="{{ asset('/') }}naturapharmFiles/kneepatch/ingredients.png"/></div>--}}
            ...
            <div class="col-xs-12 col-md-5 product">
                <div class="product__picture" id="firstProductPic" >
                    <img alt="" class="product__image" src="{{ asset('/') }}naturapharmFiles/tigersoilspray/painpatchimg.png"/>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-2 triggers__item triggers__icon--flower">
                <div class="triggers__desc">Dugotrajno delovanje</div>
            </div>
...
<section class="section section--1">
    <div class="container">
        ...
        <div class="row scope">
            <div class="col-xs-12">
                <h2 class="section__title scope__title">Oblasti primene TIGER OIL SPRAY-a</h2>
            </div>
...
<section class="section section--2">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h2 class="section__title">Sprej protiv bolova u mišićima i zglobovima TIGER OIL SPRAY</h2>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                    <p class="scroll__text">U osnovi lekovitog delovanja spreja leže sledeći efekti:</p>
    ...
    <div class="container">
        <div class="row composition">
            <div class="col-xs-12 composition__caption">
                <h2 class="section__title">SASTAV TIGER OIL SPREJA PROTIV BOLA: </h2>
                <p>Recept za sprej uključuje preko 9 lekovitih biljaka i dobijen je kao rezultat vekovnih istraživanja narodnih iscelitelja.</p>
                <p>Sprej protiv bola se proizvodi po savremenoj tehnologiji i najvišim međunarodnim normama za kvalitet. Sprej <b>TIGER OIL</b> ne sadrže hemijske dodatke, nisu toksični, bezopasni su i nemaju štetne efekte na organizam.</p>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title">"TIGER OIL SPRAY" UKLANJA BOLOVE U TELU <br/> U NAJKRAĆEM MOGUĆEM ROKU!</h2>
            </div>
        </div>
        <div class="row">
...
<section class="section section--5">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title"> ŠTA O TIGER OIL SPRAY-u<br/> GOVORE DOKTORI?</h2>
            </div>
        </div>
            ...
            <div class="col-xs-12 col-lg-4">
                <div class="comment__text">
                    <p>Najvažnije u procesu lečenja bilo kakve bolesti je zaustaviti bol i ukloniti upalni proces. Ranije je jedino rešenje bilo prepisivanje nekoliko preparata. Odvojeno za uklanjanje bola i odvojeno za lečenje bolesti što je nanosilo nepopravljivu štetu probavnom traktu i jetri. Sada tablete nisu neophodne.
                        <br/> <b>TIGER OIL</b> sprej je odličan za otklanjanje bola i problema sa mišićima i zglobovima na sasvim prirodan način. Mogu ga koristiti čak i sportisti kojima je neophodan bezbedan način za rešavanje bola. </p>
                    <p>Od kada sam počeo preporučivati <b>TIGER OIL SPRAY</b> svojim pacijentima, broj pacijenata sa recidivima i pogoršanjima se značajno umanjio. Praktičnost, kvalitet i visoka delotvornost spreja čini ga sredstvom br.1 u lečenju tegoba u mišićima i zglobovima.</p>
                </div>
        ...
        <div class="row comments">
            <div class="col-xs-12 col-md-4 comments__item">
                ...
                <div class="comments__text">
                    <p>Dobar dan. Moja mama ima 79 godina i mučili su je strašni bolovi u mišićima i zglobovima. Od vas sam kupila 3 spreja i bolovi su se umanjili, mama se mnogo bolje oseća. Samo naneseš i čekaš da dođe do okakšanja. Neizmerno vam hvala!</p>
                </div>
            </div>
            <div class="col-xs-12 col-md-4 comments__item">
                <div class="comments__title"> Nikola, 43 godine</div>
                <div class="comments__text">
                    <p>Od svih prednosti želim izdvojiti široki dijapazon delovanja i pristupačnu cenu. Imam problem sa kolenom koji se povremeno pogoršava, posebno u jesen i proleće i ne da mi živeti normalno. Nakon korišćenja raznih masti, našao sam ovaj sprej. Nakon prvog tretmana, osetio sam veliko olakšanje. Bolovi ne samo da su prošli, nego se nisu ni vraćali tokom cele godine! Od tada se TIGER OIL SPRAY nalazi u mojoj privatnoj apoteci.</p>
                </div>
            </div>
            <div class="col-xs-12 col-md-4 comments__item">
                <div class="comments__title"> Lena, 32 godine</div>
                <div class="comments__text">
                    <p>Život bez bola - upravo tako bih nazvala period upotrebe ovog čudotvornog spreja. Povreda na treningu me je terala na stalno korišćenje tableta protiv bolova i zbog toga sam dobila probleme sa želucem. Bol je postao deo mog života, a više nisam mogla piti tablete protiv bolova. Nakon što sam probala mnogo masti, losiona i tableta, shvatila sam da neću naći bolje sredstvo protiv hroničnih bolova od <b>TIGER OIL</b> spreja. Sada znam da je moguće živeti bez bola i uzimanja tableta!</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="section section--4">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title"> "TIGER OIL SPRAY" nije privremeno lečenje, nego TRAJNO REŠENJE ZA POTPUNO UKLANJANJE BOLA!</h2>
            </div>
        </div>
        <div class="row">
