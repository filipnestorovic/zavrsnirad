...
<head>
    ...
    <style>
        ...
        .top-block-v2{
            padding: 432px 0 0;
            background: url({{ asset('/') }}naturapharmFiles/saunapants2/top-block-v2.jpg) 50% 0 no-repeat;
        }
    </style>
</head>
<body>
...
<!-- -v2 -->
    ...
    <section class="detail-block about_section">
        ...
        <div class="text-cont">
            ...
            <p>Ova akcija izaziva povećanje znojenja, i to <b>do 4 puta više</b> nego u
                ...
                i toksina.</p>
            <img src="{{ asset('/') }}naturapharmFiles/saunapants2/pic-1.jpg" alt="Sauna Pants">
        </div>
    </section>
    ...
    <section class="rev-block-v3">
        ...
        <div class="rev-cont clearfix">
            ...
            <div class="rev-item">
                <img src="{{ asset('/') }}naturapharmFiles/saunapants2/rev-block-v3_2.jpg" alt="Sauna Pants">
