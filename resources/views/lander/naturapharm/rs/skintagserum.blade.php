...
<head>
    ...
    <style>@media (min-width: 640px) and (max-width: 659px) {
    ...
    <style>
        ...
        .offer_section {
            height: 630px;
            background: #eee url({{ asset('/') }}naturapharmFiles/skintagserum/desctop__offer_bg.jpg) center top no-repeat;
        }

        .order_section .content_block {
            padding: 25px 0 0;
            height: 700px;
            background: #eee url({{ asset('/') }}naturapharmFiles/skintagserum/desctop__order_bg.jpg) center top no-repeat;
        }
        ...
        @media screen and (max-width: 959px) {
            .offer_section {
                background-image: url({{ asset('/') }}naturapharmFiles/skintagserum/tablet__offer_bg.jpg);
            }

            .order_section .content_block {
                background-image: url({{ asset('/') }}naturapharmFiles/skintagserum/tablet__order_bg.jpg);
            }
        ...
        @media screen and (max-width: 639px) {
            .offer_section {
                padding: 20px 0 25px;
                height: auto;
                background-image: url({{ asset('/') }}naturapharmFiles/skintagserum/mobile__offer_bg.jpg);
            }
