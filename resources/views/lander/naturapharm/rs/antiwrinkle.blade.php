...
<header>
    <div class="header-body">
        <div class="header-pack">
            <div class="header-pack-body"><img src="{{ asset('/') }}naturapharmFiles/antiwrinkle/header-pack.png"
                                               alt=""/></div>
        ...
        <div class="header-info">
            <div class="header-head">
                ...
                <div class="header-text">
                    <p><span>ANTI WRINKLE ZA VEČNU MLADOST </span>
                        <br>
...
<div class="main">
    <div class="strong-block">
        <div class="strong-block-note">
            <div class="sbn-name">
                <h2><span>U ČEMU JE TAJNA</span> ANTI WRINKLE KREME?</h2>
            </div>
            <div class="sbn-img">
        ...
        <div class="strong-block-text">
            <img src="{{ asset('/') }}naturapharmFiles/antiwrinkle/header-pack.png" alt=""/>
            ...
            <p>ANTI WRINKLE ne samo da će momentalno izgladiti mimičke bore, već će i sprečiti pojavu novih zbog kumulativnog
                efekta.
                Nanesite ANTI WRINKLE na problematična područja i ostvarite vidljive rezultate za samo 5 dana!</p>
        </div>
    </div>
    <div class="pay-block">
        <div class="pay-block-name">
            <h2>
                ...
                <p>Instant ANTI WRINKLE brzo i bezbolno uklanja bore sa lica!</p>
            </h2>
        </div>
        <div class="pay-block-info">
            <div class="pay-block-video"><img style="max-width: 100%"
                                              src="{{ asset('/') }}naturapharmFiles/antiwrinkle/header-pack.png" alt=""/>
            </div>
    ...
    <div class="contrast-block">
        <div class="contrast-block-body">
            <div class="contrast-block-name">
                <h2>PO ČEMU SE <span>RAZLIKUJE</span> ANTI WRINKLE KREMA OD DRUGIH PROIZVODA?</h2>
            </div>
            <div class="contrast-block-info">
                ...
                <div class="contrast-block-img"><img src="{{ asset('/') }}naturapharmFiles/antiwrinkle/header-pack.png"
                                                     alt=""/></div>
            </div>
    ...
    <div class="feedback">
        <div class="feedback-name">
            <h2><span>Utisci žena</span> koje su već koristile ANTI WRINKLE</h2>
        </div>
        <div class="owl-carousel owl-theme">
            <div class="item">
                ...
                <div class="feed-text">
                    ...
                    <p>Krema ANTI WRINKLE je fenomenalna, prosto sam zadivljena!
    ...
    <div class="order-block">
        <div class="order-block-name">
            <h2><span>Kako poručiti</span> ANTI WRINKLE?</h2>
        </div>
