...
<head>
    ...
    <style>
        ...
        .sec9__container:before {
            background: url({{ asset('/') }}naturapharmFiles/slimpatch2/prod.png) no-repeat;
            width: 472px;
            height: 584px;
            right: -90px;
            bottom: -100px;
...
<div class="main__wrapper s__main">
    <div class="header">
        <div class="header__container">
            <div class="logo font-mons"><b> SLIM PATCH </b></div>
    ...
    <section class="sec1">
        <div class="sec1__container">
            ...
            <img alt class="sec1__prod only-web" src="{{ asset('/') }}naturapharmFiles/slimpatch2/prod2.png"><img alt class="sec1__prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimpatch2/prod2.png"><button class="btn for_scroll"> Naručite </button>
            <div class="last__block">
                ...
                <img alt class="prod only-web" src="{{ asset('/') }}naturapharmFiles/slimpatch2/prod.png" width="300px">
            </div>
        </div>
    </section>
    <section class="sec2">
        ...
        <div class="sec3__container">
            ...
            <div class="sec3__grid" dir="rtl">
                <div class="sec3__part" dir="ltr">
                    <div class="only-web"><img alt class="prod" src="{{ asset('/') }}naturapharmFiles/slimpatch2/prod.png"></div>
                    <div class="only-mob"><img alt class="prod" src="{{ asset('/') }}naturapharmFiles/slimpatch2/prod.png"></div>
                    <div class="girl"></div>
                    <p class="white_block pink font-mons only-web">SLIM PATCH DAJE ENERGIJU TOKOM CELOG DANA</p>
                ...
                <div class="sec3__part" dir="ltr">
                    ...
                    <p class="white_block pink font-mons only-mob">SLIM PATCH DAJE ENERGIJU TOKOM CELOG DANA</p>
    ...
    <section class="sec5">
        <div class="sec5__container">
            <div class="h1 blue font-mons" data-xd="t2"> SLIM PATCH </div>
    ...
    <section class="sec9">
        <div class="sec9__container">
            ...
            <div class="dietolog">
                ...
                <p class="font-PT">Slim Patch je biološki aktivan proizvod s celovitim efektom poboljšanja zdravlja koje će čak i ljudi oko vas da primete.
    ...
    <section class="sec10">
        <div class="sec10__container">
            <div class="sec10__grid">
                <div class="sec10__part"><img alt class="prod only-web" src="{{ asset('/') }}naturapharmFiles/slimpatch2/prod.png"></div>
                <div class="sec10__part">
                    <div class="h1 blue font-mons" data-xd="t2"> SLIM PATCH </div>
                    <div class="h2 pink font-mons" data-xd="t2"> Oblikujte svoje telo! </div>
                    <img alt class="prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimpatch2/prod.png"><button class="btn for_scroll"> Naručite </button>
                </div>
            </div>
        </div>
    </section>
    <section class="sec11">
        <div class="sec11__container">
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Čula sam za Slim Patch pre 6 meseci. Tada sam imala 90 kg. Za samo dva meseca, smršala sam gotovo 20 kg! Presrećna sam! Nakon toga, počela sam da mršavim sporo. Uprkos tome, sad imam 62,5 kg i osećam se bolje nego ikad.</p>
            ...
            <div class="comment">
                <div class="star4"></div>
                <p class="font-PT">Koristim Slim Patch nedelju dana i već vidim rezultate. Pantalone me više ne stežu.</p>
                <p class="font-PT">
                    <b class="blue">
                        Miroslava
                    </b>
            ...
            <div class="comment">
                <p class="font-PT">Naporno sam trenirao u teretani 2 godine. Osim toga, bio sam stalno na dijeti jer sam hteo da smršam 45 kg. Bilo je baš teško. Odlučio sam da probam Slim Patch jer ne znam više šta da radim s kilogramima.</p>
                <p class="font-PT">
                    <b class="blue">
                        Bojan
                    </b>
            ...
            <div class="comment">
                <div class="star4"></div>
                <p class="font-PT">Moj kolega koristi Slim patch svaki dan. Mnogo je smršao! Sa XL veličine je prešao na S tako da mogu reći da ovaj dodatak stvarno deluje. Bolje deluje od dijete, vi budete pobednici.</p>
                <p class="font-PT">
                    <b class="blue">
                        Ana
                    </b>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Sviđa mi se osećaj lakoće koji daje Slim Patch! Imam mnogo energije tokom dana! Višak kilograma je za mene stvar prošlosti.</p>
                <p class="font-PT">
                    <b class="blue">
                        Kristina
                    </b>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Jeeee! Slim Patch je nešto neverovatno! Smršao sam 7 kg bez imalo napora u samo mesec dana. Sada radim na trbušnim mišićima.</p>
            ...
            <div class="comment">
                <p class="font-PT">Slim Patch je moja zadnja nada! Borim se s viškom kilograma već 10 godina. Probala sam sve. Naručila sam danas ovo sredstvo. Videćemo kad stigne.</p>
                <p class="font-PT">
                    <b class="blue">
                        Jelena
                    </b>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Volim da koristim Slim Patch pre treninga. Daje mi mnogo energije, dovoljno da obavim sve zadatke tokom dana.</p>
                <p class="font-PT">
                    <b class="blue">
                        Aleksandra
                    </b>
            ...
            <div class="comment">
                <p class="font-PT">Bavim se sportom ceo život i uvek sam imala problema sa strukom i bedrima. Želim savršeno telo. Došlo je vreme da probam Slim Patch.</p>
                <p class="font-PT">
                    <b class="blue">
                        Dunja
                    </b>
        ...
        <div class="sec12__container">
            <div class="sec12__grid">
                <div class="sec12__part">
                    <div class="h2 blue font-mons" data-xd="t2"> SLIM PATCH - Za zgodno i privlačno telo! </div>
                    <div class="h1 blue font-mons" data-xd="t2"> SLIM PATCH</div>
                    <div class="h2 pink font-mons" data-xd="t2"> Za savršeno telo bez štete po zdravlje </div>
                    <div class="discount font-PT"> -40% </div>
                    <img alt class="prod only-web" src="{{ asset('/') }}naturapharmFiles/slimpatch2/prod2.png"><img alt class="prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimpatch2/prod2.png">
                </div>
                <div class="sec12__part">
                    <div class="order">
