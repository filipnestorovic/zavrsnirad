                                ...
                                @foreach($prices as $singlePrice)
                                    ...
                                    <label for="productLabel{{$singlePrice['quantity']}}">
                                        @if($singlePrice['quantity'] === 1)
                                            1 komad ({{$singlePrice['amount']}} RSD)
                                        @endif
                                        @if($singlePrice['quantity'] === 3)
                                            2 komada <span style="color: #2b8f26;font-size: 18px;font-weight: 700;">+ 1 GRATIS</span> ({{$singlePrice['amount']}} RSD)
                                        @endif
                                        @if($singlePrice['quantity'] === 4)
                                            4 komada ({{$singlePrice['amount']}} RSD)
                                        @endif
