...
<div class="body-wrap">
    ...
    <header>
        <div class="wrapper">
            ...
            <a href="#form-scroll"><div class="header__call headerCallJs ever-popup-btn">Naručite odmah!</div>            <div class="header__blocks"></a>

                <a class="scrollTo" href="#action1">Kako krema deluje?</a>
    ...
    <div class="section2">
        <div class="wrapper">
            <p class="title"><span class="title2-span1">Ako prepoznajete barem jedan simptom od navedenih, onda treba da počnete da koristite ovaj proizvod!
            </p>
            <div class="symptoms">
    ...
    <div class="section3">
        <div class="wrapper">
            ...
            <p class="stage__main-text">Prema statistikama, svaki peti stanovnik ove zemlje pati od gljivica na noktima.
                <br> Uske zatvorene cipele, sintetičke čarape, saune i bazeni su česti uročnici gljivica i infekcija na noktima i nogama.
                <br> <span class="stage__span1">U letnjim mesecima ova pojava je učestala pa je potrebno lečiti je na vreme.</span> <br>
            </p>
    ...
    <div class="section__wrap-bg">
        ...
        <div class="section4">
            <div class="wrapper">
                <p class="title">Kako deluje <span class="title4-span1">Fungal Nail set?</span></p>
                <p class="work__text-top"><span class="work__span1">Uz redovno korišćenje "Fungal Nail" seta eliminiše se nekoliko problema odjednom. Aktivni sastojci koji efikasno deluju eliminišu:</p>
                ...
                <div class="consist">
                    <p class="consist__text consist__text--1"><span class="consist__text--b">Matični mleč</span> — zaustavlja razvoj gljivica. Ublažava svrat i ima destruktivan efekat na gljivice.</p>
                    ...
                    <p class="consist__text consist__text--4">Za razliku od ostalih proizvoda, Fungal Nail se ravnomerno raspoređuje po celoj površini nokta. Brzo upija i ne ostavlja tragove na posteljini i odeći.</p>
                </div>
            </div>
        </div>
        <!--section5-->
    ...
    <div class="section__wrap-bg-2">
        ...
        <div class="section7">
            <div class="wrapper">
                <p class="title">Kako primeniti  <span class="title7-span1"> "Fungal Nail"?</span></p>
                <p class="how-use">Turpijom iz pakovanja nežno isturpijajte nokat laganim pokretima, a onda prema priloženom uputstvu nanesite sloj aktivne tečne formule preko nokta.
                </p>
            </div>
        </div>
        <!--section8-->
    ...
    <div class="section9">
        <div class="wrapper">
            <div class="better__wrap">
                <p class="title">Zašto je Fungal Nail krema bolja od drugih antifugalnih lekova?</p>
                <div class="better">
                    <p class="better__text better__text--1">Antifugalni agensi su podeljeni u dva tipa: prvi ne pomažu, drugi rade samo tokom primene. Ljudi koji pate od gljivica na noktima</p>
                    <p class="better__text">
                        "Fungal Nail" drastično menja situaciju. Masovne kliničke studije pokazale su da se proizvod efikasno bori protiv gljivica na noktima.
                        Nakon 1 cikljusa tretmana, gljivice nestaju i ne vraćaju se. Ovako moćan efekat postiže se zahvaljujući pažljivo biranim prirodnim sastojcima.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div id="slider">
                    <div class="slide">
                        <div class="text-wrap-slide text-wrap-slide--2">
                            <p class="text-slide">Stalno idem na bazen. Kada sam otkrila da imam gljivicu na noktu uopste se nisam iznenadila pošto koristimo zajedničku svlačionicu i zajedničke tuševe.
Jedna drugarica sa plivanja mi je preporučila Fungal Nails proizvod i rekoh hajde zašto da ne probam. Mogu da vam kažem da sam potpuno oduševljena! Nakon mesec i po gljivica je nestala a nokat je skroz normalan.</p>
                            <p class="name-slide">Aleksandra, 47 godina</p>
                        </div>
                    </div>
                    <div class="slide">
                        <div class="text-wrap-slide text-wrap-slide--1">
                            <p class="text-slide">Pre ovog proizvoda sam mislila da gljivice na noktima nikada ne mogu nestati. Probala sam gomilu drugih lekova. Simptomi su
povremeno nestajali ali su se brzo vraćali. Išla sam kod doktora, propisivao mi je razne masti ali ništa nije pomagalo. Nakon korišćenja Fungal Nail proizvoda već 6 meseci mi se gljivica na noktima ne vraća.
Mislim da sam konačno izlečila.
                    ...
                    <div class="slide">
                        <div class="text-wrap-slide text-wrap-slide--3">
                            <p class="text-slide">
Gljivice su toliko uporne da ih moj suprug godinama nije uspeo da uništi. Videli smo reklamu za Fungal Nail Kit i poručili smo.
