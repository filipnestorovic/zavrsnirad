...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/') }}naturapharmFiles/slimliftfemale2/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('/') }}naturapharmFiles/slimliftfemale2/styles.css">
    <link href="{{ asset('/') }}naturapharmFiles/slimliftfemale2/custom-styless.min.css" type="text/css" rel="stylesheet">
</head>
<body>
...
<div class="info_section">
    <div class="wrapper">
        <div class="info_item">
            <img src="{{ asset('/') }}naturapharmFiles/slimliftfemale2/b2-3.png" alt="Slim'N Lift" title="Slim'N Lift">
        ...
        <div class="info_item">
            <img src="{{ asset('/') }}naturapharmFiles/slimliftfemale2/b2-1.png" alt="Slim'N Lift" title="Slim'N Lift">
            <p>Pomaže u održavanju atraktivnog izgleda tokom procesa mršavljenja.</p>
        </div>
        <div class="info_item">
            <img src="{{ asset('/') }}naturapharmFiles/slimliftfemale2/b2-4.png" alt="Slim'N Lift" title="Slim'N Lift">
            <p>Efikasno zateže stomak i ističe dekolte, zahvaljujući posebnom obliku i strukturi.</p>
        </div>
        <div class="info_item">
            <img src="{{ asset('/') }}naturapharmFiles/slimliftfemale2/b2-2.png" alt="Slim'N Lift" title="Slim'N Lift">
    ...
    <div class="wrapper">
        <div class="product_item male clearfix">
            <div class="gallery_block">
                <img class="image one" src="{{ asset('/') }}naturapharmFiles/slimliftfemale2/b4-1.jpg" alt="Slim'N Lift" title="Slim'N Lift">
            </div>
            <div class="info">
...
<section class="order_steps_section">
    <div class="wrapper">
        ...
        <div class="steps_list">
            <div class="step_item">
                <img src="{{ asset('/') }}naturapharmFiles/slimliftfemale2/order_steps__step1_image.png" alt="Slim'N Lift" title="Slim'N Lift">
                <p>Ostavite podatke za dostavu na sajtu</p>
            </div>
            <div class="step_item">
                <img src="{{ asset('/') }}naturapharmFiles/slimliftfemale2/order_steps__step2_image.jpg" alt="Slim'N Lift" title="Slim'N Lift">
                <p>Kontaktiraćemo Vas da potvrdimo porudžbinu</p>
            </div>
            <div class="step_item">
                <img src="{{ asset('/') }}naturapharmFiles/slimliftfemale2/order_steps__step3_image.jpg" alt="Slim'N Lift" title="Slim'N Lift">
                <p>Poslaćemo pošiljku brzom poštom</p>
            </div>
            <div class="step_item">
                <img src="{{ asset('/') }}naturapharmFiles/slimliftfemale2/order_steps__step4_image.jpg" alt="Slim'N Lift" title="Slim'N Lift">
    ...
    <div class="wrapper">
        ...
        <div class="reviews_list owl-carousel">
            <div class="review_item clearfix">
                <img src="{{ asset('/') }}naturapharmFiles/slimliftfemale2/rew-1.jpg" alt="Slim'N Lift" title="Slim'N Lift">
                <div class="text_block">
            ...
            <div class="review_item clearfix">
                <img src="{{ asset('/') }}naturapharmFiles/slimliftfemale2/rew-2.jpg" alt="Slim'N Lift" title="Slim'N Lift">
                <div class="text_block">
...
<script src="{{ asset('/') }}naturapharmFiles/slimliftfemale2/owl.carousel.min.js"></script>
<script src="{{ asset('/') }}naturapharmFiles/slimliftfemale2/scripts.js"></script>
