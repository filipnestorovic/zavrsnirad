...
<head>
    ...
    <style>
        ...
        .top-block-v2{
            padding: 432px 0 0;
            background: url('{{ asset('/') }}naturapharmFiles/burningbelt/top-block-v2.png') 50% 0 no-repeat;
        }
    </style>
</head>
<body>
    ...
    <section class="detail-block about_section">
        ...
        <div class="text-cont">
            ...
            <p>Ova akcija izaziva povećanje znojenja, i to <b>do 4 puta više</b> nego u
                ...
                i toksina.</p>
            <img src="{{ asset('/') }}naturapharmFiles/burningbelt/pic-1.png" alt="Burning Belt">
        </div>
    </section>
