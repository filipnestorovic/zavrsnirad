...
<head>
    ...
    <style>
        ...
        .top-block-v2{
            padding: 432px 0 0;
            background: url({{ asset('/') }}naturapharmFiles/justoneshaper/top-block-v2.jpg) 50% 0 no-repeat;
        }
    </style>
</head>
<body>
<div class="main-wrap">
    ...
    <section class="title-block">
        <div class="sub-main-title">NOSITE I MRŠAVITE <br>POJAS ZA SAGOREVANJE MASTI</div>
        <h1 class="main-title">Just One Shaper</h1>
    </section>
    ...
    <section class="sup-block-v3 benefits1_section">
        <h2 class="lvl-title">Just One Shaper <br/>SE PREPORUČUJE <br/>UKOLIKO:</h2>
        <ul class="sup-cont clearfix">
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/sup-block-v3_1.jpg" alt="Just One Shaper">
                <p>Želite lepu figuru u najkraćem mogućem roku</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/sup-block-v3_2.jpg" alt="Just One Shaper">
                <p>Odlučili ste da dovedete svoje telo do savršenstva bez izgladnjivanja i dijeta</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/sup-block-v3_3.jpg" alt="Just One Shaper">
                <p>Hoćete da imate idealnu kilažu</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/sup-block-v3_4.jpg" alt="Just One Shaper">
    ...
    <section class="detail-block about_section">
        <h2 class="lvl-title">Just One Shaper ZA SAGOREVANJE MASTI</h2>
        <div class="text-cont">
            <p>Posebno je dizajniran za <b>siguran i brz</b> gubitak težine.</p>
            <p>Just One Shaper za sagorevanje masti dobro pristaje vašem telu,
            ...
            <p>Ova akcija izaziva povećanje znojenja, i to <b>do 4 puta više</b> nego u
                ...
                i toksina.</p>
            <img src="{{ asset('/') }}naturapharmFiles/justoneshaper/pic-1.jpg" alt="Just One Shaper">
        </div>
    </section>

    <!-- -v2 -->
    <section class="sup-block-v2">
        <h2 class="lvl-title">EFIKASNOST <br/> Just One Shapera</h2>
    ...
    <section class="sup-block-v3 use_section">
        <h2 class="lvl-title">KADA I GDE MOŽE DA SE KORISTI Just One Shaper?</h2>
        <ul class="sup-cont clearfix">
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/use1.jpg" alt="Just One Shaper">
                <p>ODMOR</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/use2.jpg" alt="Just One Shaper">
                <p>KUĆNI POSLOVI</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/use3.jpg" alt="Just One Shaper">
                <p>ŠOPING</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/use4.jpg" alt="Just One Shaper">
                <p>TRČANJE</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/use5.jpg" alt="Just One Shaper">
                <p>FITNES</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/use6.jpg" alt="Just One Shaper">
                <p>ČUVANJE DECE</p>
            </li>
        </ul>
    ...
    <section class="delivery-block-v1">
        <h2 class="lvl-title">KAKO PORUČITI <br/> Just One Shaper?</h2>
    ...
    <section class="rev-block-v3">
        ...
        <div class="rev-cont clearfix">
            <div class="rev-item">
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/rev-block-v3_1.jpg" alt="Just One Shaper">
            ...
            <div class="rev-item">
                <img src="{{ asset('/') }}naturapharmFiles/justoneshaper/rev-block-v3_2.jpg" alt="Just One Shaper">
                <h4>Boriša Gavrić , 31 godina</h4>
                <p>Kupio sam pojas za svoju suprugu, jer je dugo pokušavala da izgubi kilograme.
            ...
            <div class="rev-item">
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/rev-block-v3_3.jpg" alt="Just One Shaper">
                <h4>Dragana Marković, 29 godina</h4>
                <p>Pojas je isporučen 2 dana nakon što sam ga poručila. Koristim ga već 9 nedelja. Nosim ga gde god je to moguće – u šetnji sa detetom, kod kuće, na trčanju.
