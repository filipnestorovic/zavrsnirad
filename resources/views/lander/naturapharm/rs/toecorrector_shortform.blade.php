...
<div class="container s__main">
    ...
    <header class="section-1">
        <div class="wrap">
            <div class="head-top right">
                ...
                <h3>PORUČITE TOE CORRECTOR I ZAUVEK ZABORAVITE NA PROBLEME SA STOPALIMA!</h3>
                <img src="{{ asset('/') }}naturapharmFiles/toecorrector/longetaProduct.png"/>
                <br/>
    ...
    <div class="textinfo2">
        <div class="wrap">
            <h2>TOE CORRECTOR POZITIVNO UTIČE NA SLEDEĆE NAČINE</h2>
            <div class="item">
                <img src="{{ asset('/') }}naturapharmFiles/toecorrector/longeta4.png"/>
                <p>Nežno postavlja prste u njihov prirodan položaj i uklanja deformacije</p>
            </div>
            <div class="item">
                <img src="{{ asset('/') }}naturapharmFiles/toecorrector/02.jpg"/>
                <p>Sprečava stvaranje dosadnih žuljeva i bolova u stopalima</p>
            </div>
            <div class="item last">
                <img src="{{ asset('/') }}naturapharmFiles/toecorrector/03.jpg"/>
    ...
    <div class="textinfo3">
        <div class="wrap">
            ...
            <div class="item">
                ...
                <p>TOE CORRECTOR ispravlja koste nožnih prstiju i drži ih u ravni sa stopalom.</p>
            </div>
            <div class="item last">
    ...
    <div class="textinfo4">
        <div class="wrap">
            <h2>KADA JE POTREBNO DA KORISTITE TOE CORRECTOR?</h2>
            <div class="item">
                <h4>Želite da napravite prevenciju od nastanka čukljeva i krivih prstiju</h4>
                <p>Imate ravna stopala, nosite uske cipele, neko u vašoj porodici ima probleme sa prstima. Toe Corrector sprečava nastanak čukljeva, a vaša stopala ostaju zdrava i lepa.</p>
            </div>
            <div class="item">
    ...
    <div class="textinfo5">
        <div class="wrap">
            ...
            <div class="item">
                <img src="{{ asset('/') }}naturapharmFiles/toecorrector/longeta1.png"/>
                <p>Izrađen od čistih, kvalitetnih i veoma sigurnih materijala, koji nemaju štetna dejstva na kožu.</p>
            </div>
            <div class="item">
                <img src="{{ asset('/') }}naturapharmFiles/toecorrector/longeta2.png"/>
                <p>TOE CORRECTOR se prilagođava anatomiji vašeg stopala, i nećete osetiti da ga nosite. Pažljivo i sigurno će držati vaš prst u pravilnom položaju.</p>
            </div>
            <div class="item">
            ...
            <div class="info-block">
                <img src="{{ asset('/') }}naturapharmFiles/toecorrector/longetaProduct.png"/>
                <div class="text-info">
                    <h2>KAKO KORISTITI TOE CORRECTOR?</h2>
            ...
            <h2>RAZLIKA U DELOVANJU TOE CORRECTOR-A
                <br/>
    ...
    <div class="textinfo6">
        ...
        <div class="green">
            <div class="wrap">
                <div class="item">
                    <img src="{{ asset('/') }}naturapharmFiles/toecorrector/longeta5.jpg"/>
                    <div class="r-text">
                        <h5>TOE CORRECTOR</h5>
                        <p>
        ...
        <div class="wrap">
            ...
            <div class="item">
                ...
                <blockquote>
                    ...
                    <p>TOE CORRECTOR me je spasio! Bolovi u nogama bili su užasni, nosila sam veći broj cipela i jedva sam se kretala. Čim sam počeo nositi korektor, osećala sam se puno bolje. Sada opet nosim normalne cipele i čizme.
    ...
    <div class="container">
        <div class="inner">
            <div class="floating-desc">
                ...
                <div class="right-ft">Nabavi <b>Toe Corrector</b> već danas!<a href="#scrollform">KUPI ODMAH</a></div>
            </div>
        </div>
    </div>
</div>
