...
<head>
    ...
    <style>
        ...
        .sec9__container:before {
            background: url({{ asset('/') }}naturapharmFiles/slimmingsticker/prod.png) no-repeat;
            width: 472px;
            height: 584px;
            right: -90px;
            bottom: -100px;
...
<div class="main__wrapper s__main">
    <div class="header">
        <div class="header__container">
            <div class="logo font-mons"><b> SLIMMING STICKER </b></div>
            <div class="h1 font-mons" data-xd="t3"><b>Za zgodno i privlačno telo!</b></div>
        </div>
    </div>
    <section class="sec1">
        <div class="sec1__container">
            <div class="sec1__h1 only-web sec1__text__gr font-mons" data-xd="t2">Smršajte brzo i lako!</div>
            ...
            <img alt class="sec1__prod only-web" src="{{ asset('/') }}naturapharmFiles/slimmingsticker/prod2.png"><img alt class="sec1__prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimmingsticker/prod2.png"><button class="btn for_scroll"> Naručite </button>
            <div class="last__block">
                ...
                <img alt class="prod only-web" src="{{ asset('/') }}naturapharmFiles/slimmingsticker/prod.png" width="300px">
            </div>
        </div>
    </section>
    <section class="sec2">
    ...
    <section class="sec3">
        <div class="sec3__container">
            ...
            <div class="h1 blue font-mons" data-xd="t2"> SLIM FLASTERA</div>
            ...
            <div class="sec3__grid" dir="rtl">
                <div class="sec3__part" dir="ltr">
                    <div class="only-web"><img alt class="prod" src="{{ asset('/') }}naturapharmFiles/slimmingsticker/prod.png"></div>
                    <div class="only-mob"><img alt class="prod" src="{{ asset('/') }}naturapharmFiles/slimmingsticker/prod.png"></div>
                    <div class="girl"></div>
                    <p class="white_block pink font-mons only-web">SLIMMING STICKER DAJE ENERGIJU TOKOM CELOG DANA</p>
                ...
                <div class="sec3__part" dir="ltr">
                    ...
                    <p class="white_block pink font-mons only-mob">SLIMMING STICKER DAJE ENERGIJU TOKOM CELOG DANA</p>
    ...
    <section class="sec5">
        <div class="sec5__container">
            <div class="h1 blue font-mons" data-xd="t2"> SLIMMING STICKER </div>
                    ...
                    <div class="grafic grafic1">
                        ...
                        <div class="variant">
                            ...
                            <ul class="font-PT">
                                ...
                                <li class="gr"> Slimming Sticker </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="sec7__grid" dir="rtl">
                ...
                <div class="sec7__part last_block" dir="ltr">
                    ...
                    <p class="last-p font-PT">Udebljala sam se nakon porođaja. Mislila sam da ću lako da smršam, ali nakon mnogih dijeta, i dalje sam se debljala.
                        Bila sam stalno gladna i lošeg raspoloženja. Nakon korišćenja Slim flastera, odmah sam počela da se osećam bolje.
    ...
    <section class="sec9">
        <div class="sec9__container">
            ...
            <div class="dietolog">
                ...
                <p class="font-PT">Slimming Sticker je biološki aktivan proizvod s celovitim efektom poboljšanja zdravlja koje će čak i ljudi oko vas da primete.
                    Pozitivni rezultati mogu da se vide i u analizi krvi. Nizak nivo holesterola, stabilan nivo šećera, zdrava količina proteina su ono što nalazi mojih pacijenata pokažu zahvaljujući Slim flasterima!</p>
    ...
    <section class="sec10">
        <div class="sec10__container">
            <div class="sec10__grid">
                <div class="sec10__part"><img alt class="prod only-web" src="{{ asset('/') }}naturapharmFiles/slimmingsticker/prod.png"></div>
                <div class="sec10__part">
                    <div class="h1 blue font-mons" data-xd="t2"> SLIMMING STICKER </div>
                    <div class="h2 pink font-mons" data-xd="t2"> Oblikujte svoje telo! </div>
                    <img alt class="prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimmingsticker/prod.png"><button class="btn for_scroll"> Naručite </button>
                </div>
            </div>
        </div>
    </section>
    <section class="sec11">
        <div class="sec11__container">
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Čula sam za Slimming Sticker pre 6 meseci. Tada sam imala 90 kg. Za samo dva meseca, smršala sam gotovo 20 kg! Presrećna sam! Nakon toga, počela sam da mršavim sporo. Uprkos tome, sad imam 62,5 kg i osećam se bolje nego ikad.</p>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Smršala sam sa Slim flasterima pre godinu dana. Najvažnije je što nisu samo pomogli da smršam 20 kg, nego su i pročistili moje telo.
            ...
            <div class="comment">
                <div class="star4"></div>
                <p class="font-PT">Koristim Slimming Sticker nedelju dana i već vidim rezultate. Pantalone me više ne stežu.</p>
                <p class="font-PT">
                    <b class="blue">
                        Miroslava
                    </b>
            ...
            <div class="comment">
                <p class="font-PT">Naporno sam trenirao u teretani 2 godine. Osim toga, bio sam stalno na dijeti jer sam hteo da smršam 45 kg. Bilo je baš teško. Odlučio sam da probam Slimming Sticker jer ne znam više šta da radim s kilogramima.</p>
                <p class="font-PT">
                    <b class="blue">
                        Bojan
                    </b>
            ...
            <div class="comment">
                <div class="star4"></div>
                <p class="font-PT">Moj kolega koristi Slimming Sticker svaki dan. Mnogo je smršao! Sa XL veličine je prešao na S tako da mogu reći da ovaj dodatak stvarno deluje. Bolje deluje od dijete, vi budete pobednici.</p>
                <p class="font-PT">
                    <b class="blue">
                        Ana
                    </b>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Sviđa mi se osećaj lakoće koji daje Slimming Sticker! Imam mnogo energije tokom dana! Višak kilograma je za mene stvar prošlosti.</p>
                <p class="font-PT">
                    <b class="blue">
                        Kristina
                    </b>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Jeeee! Slimming Sticker je nešto neverovatno! Smršao sam 7 kg bez imalo napora u samo mesec dana. Sada radim na trbušnim mišićima.</p>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Više od mesec dana sam gubila težinu sa Slim flasterima. Malo po malo, apetit mi se smanjivao. Počela sam da se osećam sito već nakon malih porcija.
            ...
            <div class="comment">
                <p class="font-PT">Slimming Sticker je moja zadnja nada! Borim se s viškom kilograma već 10 godina. Probala sam sve. Naručila sam danas ovo sredstvo. Videćemo kad stigne.</p>
                <p class="font-PT">
                    <b class="blue">
                        Jelena
                    </b>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Volim da koristim Slimming Sticker pre treninga. Daje mi mnogo energije, dovoljno da obavim sve zadatke tokom dana.</p>
                <p class="font-PT">
                    <b class="blue">
                        Aleksandra
                    </b>
            ...
            <div class="comment">
                <p class="font-PT">Bavim se sportom ceo život i uvek sam imala problema sa strukom i bedrima. Želim savršeno telo. Došlo je vreme da probam Slimming Sticker.</p>
                <p class="font-PT">
                    <b class="blue">
                        Dunja
                    </b>
        ...
        <div class="sec12__container">
            <div class="sec12__grid">
                <div class="sec12__part">
                    <div class="h2 blue font-mons" data-xd="t2"> SLIMMING STICKER - Za zgodno i privlačno telo! </div>
                    <div class="h1 blue font-mons" data-xd="t2"> SLIMMING STICKER</div>
                    <div class="h2 pink font-mons" data-xd="t2"> Za savršeno telo bez štete po zdravlje </div>
                    <div class="discount font-PT"> -40% </div>
                    <img alt class="prod only-web" src="{{ asset('/') }}naturapharmFiles/slimmingsticker/prod2.png"><img alt class="prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimmingsticker/prod2.png">
                </div>
                <div class="sec12__part">
                    <div class="order">
