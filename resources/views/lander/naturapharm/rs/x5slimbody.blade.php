...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/') }}naturapharmFiles/x5slimbody/styles.css">
    <script>
...
<header class="offer_section offer_top">
    <div class="wrapper clearfix">
        <div class="title_block">
            <h1 class="main_title">VIBRACIONI POJAS<br> x5 Slim Body</h1>
            <p class="subtitle">VIBRACIONI MASAŽNI POJAS <br>ZA OBLIKOVANJE TELA</p>
        </div>
        <img class="mobile_product" src="{{ asset('/') }}naturapharmFiles/x5slimbody/mobile__offer_product.png" alt="x5 Slim Body">
...
<section class="about_section">
    <div class="wrapper clearfix">
        <img src="{{ asset('/') }}naturapharmFiles/x5slimbody/about__image.jpg" alt="x5 Slim Body">
        <div class="content_block">
            <h2>JEDINSTVENI VIBRACIONI POJAS <span>x5 Slim Body</span></h2>
            <p><b>x5 Slim Body pojas je neizostavan dodatak koji pomaže u smanjenju struka.</b></p>
...
<section class="benefits_section">
    <div class="wrapper">
        ...
        <div class="benefits_block">
            <img src="{{ asset('/') }}naturapharmFiles/x5slimbody/benefits__image.jpg" alt="x5 Slim Body">
            <ul>
        ...
        <div class="use_list clearfix">
            <div class="use_item">
                <div class="image_block">
                    <img src="{{ asset('/') }}naturapharmFiles/x5slimbody/use__use1_image.jpg" alt="x5 Slim Body">
                    <p>POSLE TRUDNOĆE</p>
                </div>
            ...
            <div class="use_item">
                <div class="image_block">
                    <img src="{{ asset('/') }}naturapharmFiles/x5slimbody/use__use2_image.jpg" alt="x5 Slim Body">
            ...
            <div class="use_item">
                <div class="image_block">
                    <img src="{{ asset('/') }}naturapharmFiles/x5slimbody/use__use3_image.jpg" alt="x5 Slim Body">
    ...
    <div class="wrapper">
        ...
        <div class="steps_list clearfix">
            <div class="step_item">
                ...
                <img src="{{ asset('/') }}naturapharmFiles/x5slimbody/order_steps__step1_image.jpg" alt="x5 Slim Body">
                <h4>PORUČITE</h4>
                <p>Ostavite vaše podatke na našem sajtu i smatrajte da ste poručili proizvod.</p>
            </div>
            <div class="step_item">
                <div class="number">2</div>
                <img src="{{ asset('/') }}naturapharmFiles/x5slimbody/order_steps__step2_image.jpg" alt="x5 Slim Body">
                <h4>KONTATIRAĆEMO VAS</h4>
                <p>Naš tim za komunikaciju sa kupcima će vas kontaktirati da potvri porudžbinu.</p>
            </div>
            <div class="step_item">
                <div class="number">3</div>
                <img src="{{ asset('/') }}naturapharmFiles/x5slimbody/order_steps__step3_image.jpg" alt="x5 Slim Body">
                <h4>ISPORUKA</h4>
    ...
    <div class="wrapper">
        ...
        <div class="reviews_list">
            <div class="review_item clearfix">
                <div class="image_block">
                    <img src="{{ asset('/') }}naturapharmFiles/x5slimbody/reviews__review1_photo.jpg" alt="x5 Slim Body">
                </div>
                <div class="text_block">
            ...
            <div class="review_item clearfix">
                <div class="image_block">
                    <img src="{{ asset('/') }}naturapharmFiles/x5slimbody/reviews__review2_photo.jpg" alt="x5 Slim Body">
                </div>
                <div class="text_block">
            ...
            <div class="review_item clearfix">
                <div class="image_block">
                    <img src="{{ asset('/') }}naturapharmFiles/x5slimbody/reviews__review3_photo.jpg" alt="x5 Slim Body">
                </div>
                <div class="text_block">
