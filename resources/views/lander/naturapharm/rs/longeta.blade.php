...
<div class="container s__main">
    ...
    <header class="section-1">
        <div class="wrap">
            <div class="head-top right">
                ...
                <h3>PORUČITE LONGETU I ZAUVEK ZABORAVITE NA ČUKLJEVE</h3>
                <img src="{{ asset('/') }}naturapharmFiles/longeta/longetaProduct.png"/>
                <br/>
    ...
    <div class="textinfo2">
        <div class="wrap">
            <h2>LONGETA ZA ČUKLJEVE POZITIVNO UTIČE NA SLEDEĆE NAČINE</h2>
            <div class="item">
                <img src="{{ asset('/') }}naturapharmFiles/longeta/longeta4.png"/>
    ...
    <div class="textinfo3">
        <div class="wrap">
            <h2>ŠTA JE LONGETA ZA ČUKLJEVE?</h2>
            <div class="item">
            ...
            <div class="item">
                ...
                <p>Longeta za čukljeve ispravlja kost nožnog palca i drži ga u ravni sa stopalom.</p>
            </div>
            <div class="item last">
    ...
    <div class="textinfo4">
        <div class="wrap">
            <h2>KADA JE POTREBNO DA KORISTITE FLEXOVAL LONGETU ZA ČUKLJEVE?</h2>
            <div class="item">
                <h4>Želite da napravite prevenciju od nastanka čukljeva</h4>
                <p>Imate ravna stopala, nosite uske cipele, neko u vašoj porodici ima čukljeve. Flexoval longeta sprečava nastanak čukljeva, a vaša stopala ostaju zdrava i lepa.</p>
            </div>
            <div class="item">
                <h4>Imate početne simptome</h4>
                <p>Stalno nošenje longete u trajanju od 3 do 6 meseci učiniće da čukljevi nestanu. Rezultat je klinički dokazan, a deformiteti se ne vraćaju.</p>
            </div>
            <div class="item">
                <h4>Imate tešku deformaciju palca</h4>
                <p>Longeta za čukljeve vraća nožni prst u ispravan pložaj, čak i ako su nožni prsti ukršteni i zbijeni. Sprečava razvoj bolesti i komplikacija kao što su upale zglobova i žuljevi. Opterećenje na stopalima tokom hodanja je ravnomerno raspoređeno, tako da bol nestaje ne samo u prstima nego i u stopalima, a noge se mnogo manje umaraju. </p>
            </div>
        </div>
    </div>
    <div class="textinfo5">
        <div class="wrap">
            ...
            <div class="item">
                <img src="{{ asset('/') }}naturapharmFiles/longeta/longeta1.png"/>
                <p>Izrađen od čistih, kvalitetnih i veoma sigurnih materijala, koji nemaju štetna dejstva na kožu.</p>
            </div>
            <div class="item">
                <img src="{{ asset('/') }}naturapharmFiles/longeta/longeta2.png"/>
                <p>Longeta za čukljeve se prilagođava anatomiji vašeg stopala, i nećete osetiti da je nosite. Pažljivo i sigurno će držati vaš prst u pravilnom položaju.</p>
            </div>
            <div class="item">
            ...
            <div class="info-block">
                <img src="{{ asset('/') }}naturapharmFiles/longeta/longetaProduct.png"/>
                <div class="text-info">
                    <h2>KAKO KORISTITI LONGETU ZA ČUKLJEVE?</h2>
                    <p>Jednostavno stavite longetu na prst, a zatim obujte vase cipele. Jedan Nevidljiva je u zatvorenim cipelama i sportskim patikama.</p>
                    <p>
                        <b>
                            <i>Što više vremena nosite longetu, korekcija deformacije će biti brža.</i>
                        </b>
                    </p>
                    <p>
                        <span>Jedna longeta dovoljna je za najmanje godinu dana korišćenja.</span>
                    </p>
                </div>
                <div class="clear">
                </div>
            </div>
            <h2>RAZLIKA U DELOVANJU LONGETE ZA ČUKLJEVE
                <br/>
    ...
    <div class="textinfo6">
        ...
        <div class="green">
            <div class="wrap">
                <div class="item">
                    <img src="{{ asset('/') }}naturapharmFiles/longeta/longeta5.jpg"/>
                    <div class="r-text">
                        <h5>Longeta za čukljeve</h5>
                        <p>
        ...
        <div class="wrap">
            ...
            <div class="item">
                ...
                <blockquote>
                    ...
                    <p>Longeta za čukljeve me je spasila! Bolovi u nogama bili su užasni, nosila sam veći broj cipela i jedva sam se kretala. Čim sam počeo nositi longetu, osjećala sam se puno bolje. Sada opet nosim normalne cipele i čizme.
            ...
            <div class="item">
                ...
                <blockquote>
                    ...
                    <p>U ranom detinjstvu lekar mi je ustanovio da imam ravna stopala. Prošle godine jednostavno nisam mogla nositi normalne cipele i bila sam iskrivljena. Dok sam tražila rešenje, naišla sam na ortopeda koji mi preporučio ove longete. Koristim ih već dva meseca i zaboravila sam na probleme sa čukljevima. Osećam se sjajno! </p>
                </blockquote>
                <div class="clear">
                </div>
            </div>
