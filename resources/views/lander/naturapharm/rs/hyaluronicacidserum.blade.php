...
<header>
    <div class="header-body">
        <div class="header-pack">
            <div class="header-pack-body"><img src="{{ asset('/') }}naturapharmFiles/hyaluronicacidserum/header-pack.png"
                                               alt=""/></div>
        ...
        <div class="header-info">
            <div class="header-head">
                ...
                <div class="header-text">
                    <p><span>HYALURONIC ACID SERUM <br>ZA VEČNU MLADOST </span>
                        <br>
...
<div class="main">
    <div class="strong-block">
        <div class="strong-block-note">
            <div class="sbn-name">
                <h2><span>U ČEMU JE TAJNA</span> HYALURONIC ACID SERUMA?</h2>
            </div>
            <div class="sbn-img">
        ...
        <div class="strong-block-text">
            <img src="{{ asset('/') }}naturapharmFiles/hyaluronicacidserum/header-pack.png" alt=""/>
            ...
            <p>HYALURONIC ACID SERUM ne samo da će momentalno izgladiti mimičke bore, već će i sprečiti pojavu novih zbog kumulativnog
                efekta.
                Nanesite HYALURONIC ACID SERUM na problematična područja i ostvarite vidljive rezultate za samo 5 dana!</p>
        </div>
    </div>
    <div class="pay-block">
        <div class="pay-block-name">
            <h2>
                ...
                <p>Instant HYALURONIC ACID SERUM brzo i bezbolno uklanja bore sa lica!</p>
            </h2>
        </div>
        <div class="pay-block-info">
            <div class="pay-block-video"><img style="max-width: 100%"
                                              src="{{ asset('/') }}naturapharmFiles/hyaluronicacidserum/header-pack.png" alt=""/>
            </div>
    ...
    <div class="contrast-block">
        <div class="contrast-block-body">
            <div class="contrast-block-name">
                <h2>PO ČEMU SE <span>RAZLIKUJE</span> HYALURONIC ACID SERUM OD DRUGIH PROIZVODA?</h2>
            </div>
            <div class="contrast-block-info">
                <div class="contrast-block-text">
                    <p>
                        Formula inovativnog HYALURONIC ACID SERUMA zasnovana je na <span>potpuno prirodnim sastojcima i vitaminima.</span>
                        Zahvaljujući tome HYALURONIC ACID SERUM <span>zaglađuje bore i trajno eliminiše uzrok starenja kože preokretom autoimunih procesa.</span>
                    </p>
                    <p>
                ...
                <div class="contrast-block-img"><img src="{{ asset('/') }}naturapharmFiles/hyaluronicacidserum/header-pack.png"
                                                     alt=""/></div>
            </div>
    ...
    <div class="feedback">
        <div class="feedback-name">
            <h2><span>Utisci žena</span> koje su već koristile HYALURONIC ACID SERUM</h2>
        </div>
        <div class="owl-carousel owl-theme">
            <div class="item">
                ...
                <div class="feed-text">
                    ...
                    <p>HYALURONIC ACID SERUM je fenomenalno, prosto sam zadivljena!
            ...
            <div class="item">
                ...
                <div class="feed-text">
                    ...
                    <p>Volim kada kozmetika ne samo obećava već i radi! HYALURONIC ACID SERUM vidno zaglađuje bore, eliminiše tamne
    ...
    <div class="take-block">
        <div class="take-block-name">
            <h2><span>Kako naneti</span> HYALURONIC ACID SERUM?</h2>
        </div>
        <div class="take-block-list">
            <ul>
                ...
                <li id="t2">
                    ...
                    <div class="tbl-info">
                        <h3>NANETI SERUM</h3>
                        <p>Nanesite HYALURONIC ACID SERUM po celom licu i dekolteu</p>
                    </div>
                </li>
                <li id="t3">
    ...
    <div class="order-block">
        <div class="order-block-name">
            <h2><span>Kako poručiti</span> HYALURONIC ACID SERUM?</h2>
        </div>
    ...
    <div class="header-body">
        ...
        <div class="header-info">
            <div class="header-head">
                ...
                <div class="header-text">
                    <p><span>HYALURONIC ACID SERUM ZA VEČNU MLADOST</span>
                        <br>
