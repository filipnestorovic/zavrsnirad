...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/') }}flexonikFiles/sweatshapermale/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('/') }}flexonikFiles/sweatshapermale/styles.css">
    <link href="{{ asset('/') }}flexonikFiles/sweatshapermale/custom-styless.min.css" type="text/css" rel="stylesheet">
    <style>
    ...
    <div class="content_block wrapper">
        <div class="info">
            <div class="title_block">
                ...
                <h1 class="main_title">SWEAT SHAPER</h1>
            </div>
            <ul>
...
<div class="info_section">
    <div class="wrapper">
        <div class="info_item">
            <img src="{{ asset('/') }}flexonikFiles/sweatshapermale/b2-3.png" alt="Slim'N Lift" title="Slim'N Lift">
            <p>Ova neverovatna majica bez rukava za sagorevanje masnoće je napravljena je od polimera nove generacije.</p>
        </div>
        <div class="info_item">
            <img src="{{ asset('/') }}flexonikFiles/sweatshapermale/b2-1.png" alt="Slim'N Lift" title="Slim'N Lift">
            <p>Pospešuje proces mršavljenja sagorevajući masti i kalorije velikom brzinom.</p>
        </div>
        <div class="info_item">
            <img src="{{ asset('/') }}flexonikFiles/sweatshapermale/b2-4.png" alt="Slim'N Lift" title="Slim'N Lift">
            <p>Za kratak period i kvalitetan trening, trbušnjaci će postati vidljivi.</p>
        </div>
        <div class="info_item">
            <img src="{{ asset('/') }}flexonikFiles/sweatshapermale/b2-2.png" alt="Slim'N Lift" title="Slim'N Lift">
...
<section class="about_section">
    <div class="wrapper clearfix">
        <h2>O SWEAT SHAPER MAJICI</h2>
        <div class="video_block">
        </div>
        <div class="text_block">
            <p>SWEAT SHAPER pomaže da se ima muževna i atraktivna figura. Telo brzo postaje zategnutije i privlačnije - bez dijeta i izgladnjivanja.
                Zahvaljujući jedinstvenom i inovativnom dizajnu, SWEAT SHAPER ravnomerno i brzo topi masne naslage.
                ...
                Takođe, SWEAT SHAPER pomaže u sagorevanju masti na drugim delovima tela, jer pospešuje cirkulaciju i pojačava metabolizam.
    ...
    <div class="wrapper">
        <div class="product_item male clearfix">
            <div class="gallery_block">
                <img class="image one" src="{{ asset('/') }}flexonikFiles/sweatshapermale/b4-1.jpg" alt="Slim'N Lift" title="Slim'N Lift">
            </div>
            <div class="info">
                <h3>KARAKTERISTIKE SWEAT SHAPER MAJICE</h3>
                <ul>
...
<section class="benefits_section">
    <div class="wrapper">
        <h2>PREDNOSTI SWEAT SHAPER <br> MAJICE</h2>
...
<section class="order_steps_section">
    <div class="wrapper">
        <h2>KAKO PORUČITI <span>SWEAT SHAPER</span></h2>
        <div class="steps_list">
            <div class="step_item">
                <img src="{{ asset('/') }}flexonikFiles/sweatshapermale/order_steps__step1_image.png" alt="Slim'N Lift" title="Slim'N Lift">
                <p>Ostavite podatke za dostavu na sajtu</p>
            </div>
            <div class="step_item">
                <img src="{{ asset('/') }}flexonikFiles/sweatshapermale/order_steps__step2_image.jpg" alt="Slim'N Lift" title="Slim'N Lift">
                <p>Kontaktiraćemo Vas da potvrdimo porudžbinu</p>
            </div>
            <div class="step_item">
                <img src="{{ asset('/') }}flexonikFiles/sweatshapermale/order_steps__step3_image.jpg" alt="Slim'N Lift" title="Slim'N Lift">
                <p>Poslaćemo pošiljku brzom poštom</p>
            </div>
            <div class="step_item">
                <img src="{{ asset('/') }}flexonikFiles/sweatshapermale/order_steps__step4_image.jpg" alt="Slim'N Lift" title="Slim'N Lift">
    ...
    <div class="wrapper">
        ...
        <div class="reviews_list owl-carousel">
            <div class="review_item clearfix">
                <img src="{{ asset('/') }}flexonikFiles/sweatshapermale/rew-1.jpg" alt="Slim'N Lift" title="Slim'N Lift">
                <div class="text_block">
            ...
            <div class="review_item clearfix">
                <img src="{{ asset('/') }}flexonikFiles/sweatshapermale/rew-2.jpg" alt="Slim'N Lift" title="Slim'N Lift">
                <div class="text_block">
...
<section class="order_section">
    <div class="wrapper clearfix">
        <div class="info">
            <div class="title_block">
                <p class="subtitle">MAJICA ZA SAGOREVANJE <br>MASTI I SAVRŠEN STRUK I TORZO</p>
                <h1 class="main_title">SWEAT SHAPER</h1>
            </div>
            <ul>
                <li>Visokokvalitetni materijali</li>
...
<script src="{{ asset('/') }}flexonikFiles/sweatshapermale/owl.carousel.min.js"></script>
<script src="{{ asset('/') }}flexonikFiles/sweatshapermale/scripts.js"></script>
