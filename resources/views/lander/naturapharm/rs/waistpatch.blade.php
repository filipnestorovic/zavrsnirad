...
{{--                <div class="ingredients"><img alt="" src="{{ asset('/') }}naturapharmFiles/kneepatch/ingredients.png"/></div>--}}
            ...
            <div class="col-xs-12 col-md-5 product">
                <div class="product__picture" id="firstProductPic" >
                    <img alt="" class="product__image" src="{{ asset('/') }}naturapharmFiles/waistpatch/kneepatchimg.png"/>
                </div>
            </div>
...
<section class="section section--1">
    <div class="container">
        ...
        <div class="row scope">
            <div class="col-xs-12">
                <h2 class="section__title scope__title">Oblasti primene flastera WAIST PATCH</h2>
            </div>
...
<section class="section section--2">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h2 class="section__title">BILJNI FLASTERI PROTIV BOLA "WAIST PATCH"</h2>
            </div>
    ...
    <div class="container">
        <div class="row composition">
            <div class="col-xs-12 composition__caption">
                <h2 class="section__title">SASTAV "WAIST PATCH" FLASTERA PROTIV BOLA: </h2>
                ...
                <p>Flasteri protiv bola se proizvode po savremenoj tehnologiji i najvišim međunarodnim normama za kvalitet. Flasteri <b>WAIST PATCH</b> ne sadrže hemijske dodatke, nisu toksični, bezopasni su i nemaju štetne efekte na organizam.</p>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title">"WAIST PATCH" UKLANJA BOLOVE U TELU <br/> U NAJKRAĆEM MOGUĆEM ROKU!</h2>
            </div>
        </div>
        <div class="row">
...
<section class="section section--5">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title"> ŠTA O "WAIST PATCH" BILJNIM FLASTERIMA <br/> GOVORE DOKTORI?</h2>
            </div>
        </div>
            ...
            <div class="col-xs-12 col-lg-4">
                <div class="comment__text">
                    <p>Najvažnije u procesu lečenja bilo kakve bolesti je zaustaviti bol i ukloniti upalni proces. Ranije je jedino rešenje bilo prepisivanje nekoliko preparata. Odvojeno za uklanjanje bola i odvojeno za lečenje bolesti što je nanosilo nepopravljivu štetu probavnom traktu i jetri. Sada tablete nisu neophodne.
                        <br/> <b>WAIST PATCH</b> flasteri se odlični za otklanjanje bola i problema sa mišićima i zglobovima na sasvim prirodan način. Mogu ih koristiti čak i sportisti kojima je neophodan bezbedan način za rešavanje bola. </p>
                    <p>Od kada sam počeo preporučivati <b>WAIST PATCH</b> flastere svojim pacijentima, broj pacijenata sa recidivima i pogoršanjima se značajno umanjio. Praktičnost, kvalitet i visoka delotvornost flastera čini ih sredstvom br.1 u lečenju tegoba u mišićima i zglobovima.</p>
                </div>
...
<section class="section section--7">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title">KAKO ISPRAVNO KORISTITI FLASTER "WAIST PATCH"</h2>
            </div>
        </div>
...
<section class="section section--4">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title"> "WAIST PATCH" nije privremeno lečenje, nego TRAJNO REŠENJE ZA POTPUNO UKLANJANJE BOLA!</h2>
            </div>
        </div>
        <div class="row">
