...
<div class="main-wrap">
    ...
    <section class="title-block">
        ...
        <h1 class="main-title">Sweat Shaper</h1>
    </section>
    ...
    <section class="sup-block-v3 benefits1_section">
        <h2 class="lvl-title">SWEAT SHAPER <br/>SE PREPORUČUJE <br/>UKOLIKO:</h2>
        <ul class="sup-cont clearfix">
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/sup-block-v3_1.jpg" alt="Sweat Shaper">
                <p>Želite lepu figuru u najkraćem mogućem roku</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/sup-block-v3_2.jpg" alt="Sweat Shaper">
                <p>Odlučili ste da dovedete svoje telo do savršenstva bez izgladnjivanja i dijeta</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/sup-block-v3_3.jpg" alt="Sweat Shaper">
                <p>Hoćete da imate idealnu kilažu</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/sup-block-v3_4.jpg" alt="Sweat Shaper">
    ...
    <section class="detail-block about_section">
        <h2 class="lvl-title">SWEAT SHAPER KORSET ZA SAGOREVANJE MASTI</h2>
        <div class="text-cont">
            <p>Posebno je dizajniran za <b>siguran i brz</b> gubitak težine.</p>
            <p>Sweat Shaper korset za sagorevanje masti dobro pristaje vašem telu,
            ...
            <p>Ova akcija izaziva povećanje znojenja, i to <b>do 4 puta više</b> nego u
                ...
                i toksina.</p>
            <img src="{{ asset('/') }}flexonikFiles/sweatshaper/pic-1.jpg" alt="Sweat Shaper">
        </div>
    </section>

    <!-- -v2 -->
    <section class="sup-block-v2">
        <h2 class="lvl-title">EFIKASNOST KORSETA <br/> SWEAT SHAPER</h2>
    ...
    <section class="sup-block-v3 use_section">
        <h2 class="lvl-title">KADA I GDE MOŽE DA SE KORISTI SWEAT SHAPER KORSET?</h2>
        <ul class="sup-cont clearfix">
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/use1.jpg" alt="Sweat Shaper">
                <p>ODMOR</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/use2.jpg" alt="Sweat Shaper">
                <p>KUĆNI POSLOVI</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/use3.jpg" alt="Sweat Shaper">
                <p>ŠOPING</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/use4.jpg" alt="Sweat Shaper">
                <p>TRČANJE</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/use5.jpg" alt="Sweat Shaper">
                <p>FITNES</p>
            </li>
            <li>
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/use6.jpg" alt="Sweat Shaper">
                <p>ČUVANJE DECE</p>
            </li>
        </ul>
    ...
    <section class="delivery-block-v1">
        <h2 class="lvl-title">KAKO PORUČITI <br/> SWEAT SHAPER KORSET?</h2>
    ...
    <section class="rev-block-v3">
        ...
        <div class="rev-cont clearfix">
            <div class="rev-item">
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/rev-block-v3_1.jpg" alt="Sweat Shaper">
            ...
            <div class="rev-item">
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/rev-block-v3_2.jpg" alt="Sweat Shaper">
            ...
            <div class="rev-item">
                <img src="{{ asset('/') }}flexonikFiles/sweatshaper/rev-block-v3_3.jpg" alt="Sweat Shaper">
