        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-5 product">
                <div class="product__picture">
                    <img alt="" class="product__image" src="{{ asset('/') }}naturapharmFiles/wormwoodfootpad/kinoki1.png"/>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row pair">
            <div class="col-md-12 col-lg-7 text-center">
                <img alt="" src="{{ asset('/') }}naturapharmFiles/wormwoodfootpad/kinoki2.png"/>
            </div>
            <div class="col-md-12 col-lg-5 section__content section__content--pair">
                <p>Danas svi živimo delimično nezdravim načinom života i vrlo je važno redovno raditi <span>detoksikaciju organizma</span>.
                    Wormwood foot pad su napravljeni od biljnih ekstrakata prema <span>tradicionalnom kineskom receptu</span> i namenjeni su izbacivanju viška tečnosti i toksina iz tela kroz <span>akupunkturne tačke.</span></p>
                <p> Wormwood foot pad <span>ublažavaju napetost i umor, poboljšavaju san, čiste kožu i poboljšavaju opšte zdravstveno stanje</span>. Koristeći ove flastere, toksini koji se skupljaju u telu i krvotoku bivaju brzo eliminisani iz organizma.</p>
                <p></p>
                <p></p>
            </div>
        </div>
        <div class="row scope">
            <div class="col-xs-12">
                <h2 class="section__title scope__title">OBLASTI PRIMENE WORMWOOD FOOT PADS</h2>
            </div>
...
<section class="section section--2">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h2 class="section__title">OČISTITE SVOJ ORGANIZAM OD TOKSINA ZA SAMO 5 DANA UZ POMOĆ WORMWOOD FOOT PADS</h2>
            </div>
    ...
    <div class="container">
        <div class="row composition">
            <div class="col-xs-12 composition__caption">
                <h2 class="section__title">SASTAV WORMWOOD FOOT PADS</h2>
                ...
                <p>Ovi flasteri se proizvode prema savremenoj tehnologiji i najvišim međunarodnim normama za kvalitet.  Flasteri ne sadrži hemijske dodatke, bezopasni su I ne štete organizmu.</p>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title">WORMWOOD FOOT PAD ĆE OČISTITI VAŠ ORGANIZAM OD TOKSINA <br/> U NAJKRAĆEM MOGUĆEM ROKU!</h2>
            </div>
        </div>
        <div class="row">
...
<section class="section section--5">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title">ŠTA O WORMWOOD FOOT PADS <br/> GOVORE DOKTORI?</h2>
            </div>
        </div>
        <div class="row comment doctorSection">
            ...
            <div class="col-xs-12 col-lg-4">
                <div class="comment__text">
                    ...
                    <p>Kada sam svojim pacijentima počeo da preporučujem WORMWOOD FOOT PADS, nakon određenog vremena dobar deo njih je imao znatno manje problema, a većini su problemi skroz nestali.
                        WORMWOOD FOOT PADS su odlični za priorodno izbacivanje toksina iz organizma i svakome prepoučujem detoksikaciju bar jednom mesečno.</p>
                </div>
        ...
        <div class="row comments">
            <div class="col-xs-12 col-md-4 comments__item">
                ...
                <div class="comments__text">
                    <p>Dobar dan. Radim mnogo u kancelariji, i imala sam problem sa bolom u mišićima, udovi su mi bili teški, nisam imala dovoljno energije i bila sam jako mrzovoljna. Na internetu sam pronašla WORMWOOD FOOT PADS i pokušala sam da detoksikujem svoj organizam. Nakon dve kutije, simptomi koji su me mučili su skroz nestali, a ja se evo već 3 meseca osećam odlično. Sada preventivno svaki mesec potrošim jednu kutiju jer ne želim ni da mi se ponovi onaj teški period.</p>
                </div>
            </div>
            <div class="col-xs-12 col-md-4 comments__item">
                <div class="comments__title"> Ljubica, 65 godina</div>
                <div class="comments__text">
                    <p>Godinama sam imala problem sa viškom tečnosti u organizmu i otokom na nogama. Pokušavala sam sve i svašta, ali su mi lekovi često pravili druge probleme. Kćerka mi je kupila WORMWOOD FOOT PADS, i to je jedini proizvod koji mi je pomogao. Imam ga u svojoj apoteci u većim zalihama. Hvala vam!</p>
                </div>
            </div>
            <div class="col-xs-12 col-md-4 comments__item">
                <div class="comments__title"> Dragan, 32 godine</div>
                <div class="comments__text">
                    <p>Često jedem brzu hranu i slatkiše, pijem dosta gaziranih sokova i pušač sam. Vremenom sam počeo da osećam poteškoće poput iscrpljenosti i glavobolje. Majka mi je koristila WORMWOOD FOOT PADS i preporučila ga i meni. U početku nisam verovao da pomaže ali na nagovor majke nisam odustajao, i već u drugoj nedelji korišćenja dosta sam se lepše osećao. Budio sam se odmorniji, imao sam više energije i glavobolja je nestala. Slobodno mogu da kažem da ovaj proizvod preporučujem svima, jer je zaista dobar!</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="section section--7">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title">KAKO ISPRAVNO KORISTITI WORMWOOD FOOT PADS</h2>
            </div>
        </div>
...
<section class="section section--4">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title"> WORMWOOD FOOT PAD nije privremeno, već trajno oslobađanje od ŠTETNIH TOKSINA U ORGANIZMU!</h2>
            </div>
        </div>
        <div class="row">
