...
<div class="container s__main">
    ...
    <header class="section-1">
        <div class="wrap">
            <div class="head-top right">
                <h1>KONAČNO SE POJAVILO PRAVO REŠENJE ZA ČUKLJEVE I PROBLEME SA NOŽNIM PRSTIMA!</h1>
                <h3>PORUČITE MAGNETNI KOREKTOR ZA ČUKALJ I ZAUVEK ZABORAVITE NA PROBLEME SA STOPALIMA!</h3>
                <img src="{{ asset('/') }}naturapharmFiles/magnetnikorektorcukalj/longetaProduct.png"/>
                <br/>
    ...
    <div class="textinfo">
        <div class="wrap">
            ...
            <p>
                <br/>
                To su problemi koji nastaju deformitetom kostiju stopala – nepravilnim oblikom nožnih prstiju
                <span></span>
            </p>
        </div>
    </div>
    <div class="textinfo2">
        <div class="wrap">
            <h2>MAGNETNI KOREKTOR ZA ČUKALJ POZITIVNO UTIČE NA SLEDEĆE NAČINE</h2>
            <div class="item">
                <img src="{{ asset('/') }}naturapharmFiles/magnetnikorektorcukalj/longeta4.png"/>
                <p>Nežno postavlja prste u njihov prirodan položaj i uklanja deformacije</p>
            </div>
            <div class="item">
                <img src="{{ asset('/') }}naturapharmFiles/magnetnikorektorcukalj/02.jpg"/>
                <p>Sprečava stvaranje dosadnih žuljeva i bolova u stopalima</p>
            </div>
            <div class="item last">
                <img src="{{ asset('/') }}naturapharmFiles/magnetnikorektorcukalj/03.jpg"/>
                <p>Ukljava čukljeve i pozitivno utiče na lečenje artritisa</p>
            </div>
        </div>
    </div>
    <div class="order">
        <div class="wrap">
            <div class="form-wrp-sec ">
                <h3> MAGNETNI KOREKTOR ZA ČUKALJ
                    <br/>
    ...
    <div class="textinfo3">
        <div class="wrap">
            <h2>ŠTA JE MAGNETNI KOREKTOR ZA ČUKALJ?</h2>
            <div class="item">
                <img src="{{ asset('/') }}naturapharmFiles/longeta/img-1.jpg"/>
                <p>Na zdravom stopalu palac ima normalan položaj i prsti su ravnomerno raspoređeni. Stopalo ima normalnu funkciju i daje potpotu celom telu.</p>
            </div>
            <div class="item">
                <img src="{{ asset('/') }}naturapharmFiles/longeta/img-2.jpg"/>
                <p>MAGNETNI KOREKTOR ZA ČUKALJ ispravlja koste nožnih prstiju i drži ih u ravni sa stopalom.</p>
            </div>
            <div class="item last">
                <img src="{{ asset('/') }}naturapharmFiles/longeta/img-3.jpg"/>
                <p>Na slici iznad je prikazan deformitet palca trećeg stepena. Palac je jako savijen u odnosu na ostale prste, a funkcija stopala je značajno oslabljena. </p>
            </div>
        </div>
    </div>
    <div class="textinfo4">
        <div class="wrap">
            <h2>KADA JE POTREBNO DA KORISTITE MAGNETNI KOREKTOR ZA ČUKALJ?</h2>
            <div class="item">
                <h4>Želite da napravite prevenciju od nastanka čukljeva i krivih prstiju</h4>
                <p>Imate ravna stopala, nosite uske cipele, neko u vašoj porodici ima probleme sa prstima. Magnetni korektor za čukalj sprečava nastanak čukljeva, a vaša stopala ostaju zdrava i lepa.</p>
            </div>
            <div class="item">
                <h4>Imate početne simptome</h4>
                <p>Stalno nošenje u trajanju od 3 do 6 meseci učiniće da čukljevi nestanu. Rezultat je klinički dokazan, a deformiteti se ne vraćaju.</p>
            </div>
            <div class="item">
                <h4>Imate tešku deformaciju palca</h4>
                <p>MAGNETNI KOREKTOR ZA ČUKALJ vraća nožni prst u ispravan pložaj, čak i ako su nožni prsti ukršteni i zbijeni. Sprečava razvoj bolesti i komplikacija kao što su upale zglobova i žuljevi. Opterećenje na stopalima tokom hodanja je ravnomerno raspoređeno, tako da bol nestaje ne samo u prstima nego i u stopalima, a noge se mnogo manje umaraju. </p>
            </div>
        </div>
    </div>
    <div class="textinfo5">
        <div class="wrap">
            ...
            <div class="item">
                <img src="{{ asset('/') }}naturapharmFiles/magnetnikorektorcukalj/longeta1.png"/>
                <p>Izrađen od čistih, kvalitetnih i veoma sigurnih materijala, koji nemaju štetna dejstva na kožu.</p>
            </div>
            <div class="item">
                <img src="{{ asset('/') }}naturapharmFiles/magnetnikorektorcukalj/longeta2.png"/>
                <p>MAGNETNI KOREKTOR ZA ČUKALJ se prilagođava anatomiji vašeg stopala, i nećete osetiti da ga nosite. Pažljivo i sigurno će držati vaš prst u pravilnom položaju.</p>
            </div>
            <div class="item">
                <img src="{{ asset('/') }}naturapharmFiles/longeta/longeta3.png"/>
                <p>Pod pritiskom, kost se vraća u normalan položaj, a palac ostaje paralelan s ostalim prstima. Bol u hodu nestaje, a vase omiljene cipele ćete moći da nosite ponovo.</p>
            </div>
            <div class="clear">
            </div>
            <div class="info-block">
                <img src="{{ asset('/') }}naturapharmFiles/magnetnikorektorcukalj/longetaProduct.png"/>
                <div class="text-info">
                    <h2>KAKO KORISTITI MAGNETNI KOREKTOR ZA ČUKALJ?</h2>
                    <p>Jednostavno ga stavite na prste, a zatim obujte vaše cipele. Nevidljiv je u zatvorenim cipelama i sportskim patikama.</p>
                    <p>
                        <b>
                            <i>Što ga više vremena nosite, korekcija deformiteta će biti brža.</i>
                        </b>
                    </p>
                    <p>
                        <span>Jedan korektor dovoljna je za najmanje godinu dana korišćenja.</span>
                    </p>
                </div>
                <div class="clear">
                </div>
            </div>
            <h2>RAZLIKA U DELOVANJU MAGNETNI KOREKTORA ZA ČUKALJ
                <br/>
    ...
    <div class="textinfo6">
        <div class="wrap">
            <div class="item">
                ...
                <div class="r-text">
                    ...
                    <p>Glomazna konstrukcija uloška ne dozvoljava korišćenje čarapa i obuće, pa se ti ulošci nose uglavnom noću, što nije dovoljno jer deformisani nožni prst i dalje većinu vremena ostaje u nepravilnom položaju.</p>
                </div>
                <div class="clear">
                </div>
            </div>
            ...
            <div class="item">
                ...
                <div class="r-text">
                    ...
                    <p>Oni nemaju nikakav uticaj i dejstvo u lečenju čukljeva. Primenjuju se isključivo za ublažavanje bolova i upale zglobova.</p>
                </div>
                <div class="clear">
                </div>
            </div>
        ...
        <div class="green">
            <div class="wrap">
                <div class="item">
                    <img src="{{ asset('/') }}naturapharmFiles/magnetnikorektorcukalj/longeta5.jpg"/>
                    <div class="r-text">
                        <h5>MAGNETNI KOREKTOR ZA ČUKALJ</h5>
                        <p>
                            Postavlja prste u ispravan položaj i drži ih 24 sata dnevno, pružajući značajan terapeutski učinak.
                            <br/>
        ...
        <div class="wrap">
            ...
            <div class="item">
                ...
                <blockquote>
                    ...
                    <p>MAGNETNI KOREKTOR ZA ČUKALJ me je spasio! Bolovi u nogama bili su užasni, nosila sam veći broj cipela i jedva sam se kretala. Čim sam počeo nositi korektor, osećala sam se puno bolje. Sada opet nosim normalne cipele i čizme.
                        <br/>Vratila sam se u život i jako sam zahvalna onima koji su smislili ovakvu stvar.
                    </p>
                </blockquote>
                <div class="clear">
                </div>
            ...
            <div class="item">
                ...
                <blockquote>
                    ...
                    <p>U ranom detinjstvu lekar je ustanovio da imam ravna stopala. Prošle godine jednostavno nisam mogla da nosim normalne cipele i bila sam iskrivljena. Dok sam tražila rešenje, naišla sam na ortopeda koji mi je preporučio ove korektore. Koristim ih već dva meseca i zaboravila sam na probleme sa čukljevima. Osećam se sjajno! </p>
                </blockquote>
                <div class="clear">
                </div>
            </div>
    ...
    <footer>
        <div class="wrap">
            ...
            <div class="form-wrp">
                ...
                <div class="scrollform" id="scrollform">
                    <form action="{{$orderRoute}}" method="POST">
                        {{ csrf_field() }}
                        @include('lander.naturapharm.components.form_hidden_fields')
                        <input type="text" name="name" placeholder="Ime i prezime" required/>
                        <input type="text" name="phone" placeholder="Telefon" required/>
                        <button class="submit js_pre_toform" type="submit">ZAVRŠI KUPOVINU</button>
                    </form>
                </div>
                <style>
                    html {
    ...
    <div class="container">
        <div class="inner">
            <div class="floating-desc">
                ...
                <div class="right-ft">Nabavi <b>Magnetni korektor za čukalj</b> već danas!<a href="#scrollform">KUPI ODMAH</a></div>
            </div>
        </div>
    </div>
</div>
