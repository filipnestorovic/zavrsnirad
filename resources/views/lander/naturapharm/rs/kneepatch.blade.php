    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 text-right header__title">
                <h1>Biljni flasteri protiv bola u kolenima</h1>
                <h2>KNEE PATCH</h2>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-5 product">
                <div class="product__picture">
                    <img alt="" class="product__image" src="{{ asset('/') }}naturapharmFiles/kneepatch/kneepatchimg.png"/>
                </div>
            </div>
...
<section class="section section--1">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h2 class="section__title">SIGURNO JE DA BOL U KOLENU OSEĆA 80% LJUDI U NEKOM RAZDOBLJU ŽIVOTA!</h2>
            </div>
        </div>
        <div class="row pair">
            ...
            <div class="col-md-12 col-lg-5 section__content section__content--pair">
                <p><span>Bolovi</span>  u  <span>kolenu</span>  predstavljaju  <span>problem prvog stepena</span> jer zaista utiču na <span>kvalitet života.</span></p>
        ...
        <div class="row scope">
            <div class="col-xs-12">
                <h2 class="section__title scope__title">Oblasti primene flastera KNEE PATCH</h2>
            </div>
...
<section class="section section--2">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h2 class="section__title">BILJNI FLASTERI PROTIV BOLA U KOLENU "KNEE PATCH"</h2>
            </div>
    ...
    <div class="container">
        <div class="row composition">
            <div class="col-xs-12 composition__caption">
                <h2 class="section__title">SASTAV "KNEE PATCH" FLASTERA PROTIV BOLA U KOLENIMA: </h2>
                ...
                <p>Flasteri protiv bola se proizvode po savremenoj tehnologiji i najvišim međunarodnim normama za kvalitet. Flasteri <span>KNEE PATCH</span> ne sadrže hemijske dodatke, nisu toksični, bezopasni su i nemaju štetne efekte na organizam.</p>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title">"KNEE PATCH" UKLANJA BOLOVE U KOLENIMA <br/> U NAJKRAĆEM MOGUĆEM ROKU!</h2>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xs-12 col-md-8 productSection">
                <div class="product">
                    ...
                    <div class="product__desc product__desc--bold">
                        <div>Lekovito sredstvo protiv bolova u kolenima.</div>
...
<section class="section section--5">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title"> ŠTA O "KNEE PATCH" BILJNIM FLASTERIMA ZA KOLENO  <br/>  GOVORE DOKTORI?</h2>
            </div>
        </div>
        <div class="row comment doctorSection">
            ...
            <div class="col-xs-12 col-lg-4">
                <div class="comment__text">
                    ...
                    <br/> KNEE PATCH flasteri se odlični za otklanjanje bola i problema sa kolenima na sasvim prirodan način. Mogu ih koristiti čak i sportisti kojima je neophodan bezbedan način za rešavanje bola. </p>
                    <p>Od kada sam počeo preporučivati KNEE PATCH flastere svojim pacijentima, broj pacijenata sa recidivima i pogoršanjima se značajno umanjio. Praktičnost, kvalitet i visoka delotvornost flastera čini ih sredstvom br.1 u lečenju tegoba u kolenima.</p>
                </div>
        ...
        <div class="row comments">
            <div class="col-xs-12 col-md-4 comments__item">
                ...
                <div class="comments__text">
                    <p>Dobar dan. Moja mama ima 79 godina i mučili su je strašni bolovi u kolenina. Od vas sam kupila 3 kutije flastera i bolovi su se umanjili, mama se mnogo bolje oseća. Samo zalepiš i čekaš da dođe do okakšanja. Mogu li da poručim još 6 kutija? Neizmerno vam hvala!</p>
                </div>
            </div>
            <div class="col-xs-12 col-md-4 comments__item">
                <div class="comments__title"> Nikola, 43 godine</div>
                <div class="comments__text">
                    <p>Od svih prednosti želim izdvojiti široki dijapazon delovanja i pristupačnu cenu. Imam problem sa kolenom koji se povremeno pogoršava, posebno u jesen i proleće i ne da mi živeti normalno. Nakon korišćenja raznih masti, našao sam flastere KNEE PATCH.. Nakon prvog tretmana, osetio sam veliko olakšanje. Bolovi ne samo da su prošli, nego se nisu ni vraćali tokom cele godine! Od tada se ovi flasteri nalaze u mojo privatnoj apoteci.</p>
                </div>
            </div>
            <div class="col-xs-12 col-md-4 comments__item">
                <div class="comments__title"> Lena, 32 godine</div>
                <div class="comments__text">
                    <p>Život bez bola - upravo tako bih nazvala period upotrebe ovih čudotvornih flastera. Povreda kolena na treningu me je terala na stalno korišćenje tableta protiv bolova i zbog toga sam dobila probleme sa želucem. Bol je postao deo mog života, a više nisam mogla piti tablete protiv bolova. Nakon što sam probala mnogo masti, losiona i tableta, shvatila sam da neću naći bolje sredstvo protiv hroničnih bolova u kolenu od KNEE PATCH flastera. Sada znam da je moguće živeti bez bola i uzimanja tableta!</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="section section--7">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title">KAKO ISPRAVNO KORISTITI FLASTER "KNEE PATCH"</h2>
            </div>
        </div>
...
<section class="section section--4">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 section__caption">
                <h2 class="section__title"> "KNEE PATCH" nije privremeno lečenje, nego TRAJNO REŠENJE ZA POTPUNO UKLANJANJE BOLA!</h2>
            </div>
        </div>
        <div class="row">
