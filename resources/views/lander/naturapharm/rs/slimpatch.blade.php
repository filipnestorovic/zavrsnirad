...
<head>
    ...
    <style>
        ...
        .sec9__container:before {
            background: url({{ asset('/') }}naturapharmFiles/slimpatch/prod.png) no-repeat;
            width: 472px;
            height: 584px;
            right: -90px;
            bottom: -100px;
...
<div class="main__wrapper s__main">
    ...
    <section class="sec1">
        <div class="sec1__container">
            ...
            <img alt class="sec1__prod only-web" src="{{ asset('/') }}naturapharmFiles/slimpatch/prod2.png"><img alt class="sec1__prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimpatch/prod2.png"><button class="btn for_scroll"> Naručite </button>
            <div class="last__block">
                ...
                <img alt class="prod only-web" src="{{ asset('/') }}naturapharmFiles/slimpatch/prod.png" width="300px">
            </div>
        </div>
    </section>
    <section class="sec2">
        ...
        <div class="sec3__container">
            ...
            <div class="sec3__grid" dir="rtl">
                <div class="sec3__part" dir="ltr">
                    <div class="only-web"><img alt class="prod" src="{{ asset('/') }}naturapharmFiles/slimpatch/prod.png"></div>
                    <div class="only-mob"><img alt class="prod" src="{{ asset('/') }}naturapharmFiles/slimpatch/prod.png"></div>
                    <div class="girl"></div>
    ...
    <section class="sec10">
        <div class="sec10__container">
            <div class="sec10__grid">
                <div class="sec10__part"><img alt class="prod only-web" src="{{ asset('/') }}naturapharmFiles/slimpatch/prod.png"></div>
                <div class="sec10__part">
                    <div class="h1 blue font-mons" data-xd="t2"> SLIM PATCH </div>
                    <div class="h2 pink font-mons" data-xd="t2"> Oblikujte svoje telo! </div>
                    <img alt class="prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimpatch/prod.png"><button class="btn for_scroll"> Naručite </button>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="sec12__container">
            <div class="sec12__grid">
                <div class="sec12__part">
                    ...
                    <img alt class="prod only-web" src="{{ asset('/') }}naturapharmFiles/slimpatch/prod2.png"><img alt class="prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimpatch/prod2.png">
                </div>
                <div class="sec12__part">
                    <div class="order">
