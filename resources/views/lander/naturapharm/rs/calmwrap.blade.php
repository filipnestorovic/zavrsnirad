...
<div class="fixedtop">
    <div class="fixedtop__wrap clearfix">
        <picture>
            <img src="{{ asset('/') }}naturapharmFiles/calmwrap/logo.png" class="fixedtop__img" alt="img">
        </picture>
...
<main>
    ...
    <section class="s1">
        <div class="container">
            <div class="logo">
                <img src="{{ asset('/') }}naturapharmFiles/calmwrap/logo.png" alt="img">
            </div>
            ...
            <div class="list-wrap">
                <ul class="list">
                    ...
                    <li><span>Pojas</span> vibrira i daje efekat masaže, a takođe i ima 3 nivoa zagrevanja</li>
                    <li><span>Eliminiše i sprečava</span> uklještenje nerava</li>
                    <li><span>Pomaže</span> u normalizaciji sluha i vida</li>
                </ul>
                <div class="form-wrap">
                    <div class="prod-wrap">
                        <img src="{{ asset('/') }}naturapharmFiles/calmwrap/prod.png" alt="img" class="prod">
                    </div>
                    <div class="form">
    ...
    <section class="s2">
        <div class="container clearfix">
            <div class="col-2 col-2-offset">
                <h2>PROTIV <span>KAKVIH TEGOBA</span> SE BORI CALM WRAP?</h2>
                <blockquote>
                    <p><b><span>CALM WRAP</span> - jedinstveni proizvod za bol u vratu i zglobovima, </b> koji nema alternativu na srpskom tržištu.</p>
                </blockquote>
                <p>Trajna efikasnost CALM WRAPA - <b>ciljano delovanje na kritični područje vrata, ramena i leđa</b>
    ...
    <section class="s3">
        <div class="container">
            <h3>EVO <span>KOD KOJIH TEGOBA</span> MOŽE DA POMOGNE <br> CALM WRAP:</h3>
    ...
    <section class="s10">
        <div class="container">
            <h2><span>DELOVANJE</span> CALM WRAPA:</h2>
            <div class="s10__list-wrap">
                ...
                <div class="s10_prod-wrap">
                    <img src="{{ asset('/') }}naturapharmFiles/calmwrap/s10_prod.png" alt="img" class="prod" loading="lazy">
                </div>
            </div>
        ...
        <div class="container">
            <div class="wrap">
                ...
                <p>Za oporavak od bolesti zglobova potrebno je izabrati kvalitetno rešenje.
                    <b>Najefikasniju u toj borbi je CALM WRAP.</b> Iz iskustva, reći ću da se gotovo <b>90% pacijenata potpuno oporavi.</b>
                    Za mene kao lekara ovo je visoka stopa, tako da svojim pacijentima preporučujem samo CALM WRAP.</p>
            </div>
        </div>
    </section>
    <section class="s16">
            ...
            <div class="items">
                <div class="item">
                    ...
                    <div class="item_wrap">
                        ...
                        <p>Dve godine me je užasno boleo vrat, nisam imao vremena da odem kod doktora.
                            Sa pilulama sam nekako uspevao da smanjim bol, ali nisam uspeo da rešim problem do kraja.
                            Počeo je vrat da mi se koči i bio sam jako uplašen. Moja supruga je videla ovaj proizvod na internetu i poručila mi. Nakon nekoliko nedelja, bol je potpuno nestao.
                            Konačno živim bez muke i bola.</p>
                    </div>
                </div>
                <div class="item">
                    ...
                    <div class="item_wrap">
                        ...
                        <p>Strašno me boleo vrat, a doktor je rekao da ne može ništa da se uradi bez operacije. Otišla sam kod drugog doktora i on mi je prepisao da nosim Calm Wrap.
                            Postalo mi je mnogo lakše, a nakon 4 nedelje bol je nestao.</p>
                    </div>
                </div>
                <div class="item">
                    ...
                    <div class="item_wrap">
                        ...
                        <p>Povredila sam vrat i provela dosta vremena u bolnici. Doktor mi je rekao da ću morati da se naviknem na povremene bolove. Bol je često bio nepodnošljiv i na kraju sam se navikla na njega. Suprug mi je kupio CALM WRAP koji mi zaista puno pomaže u smanjenju bola.</p>
                    </div>
                </div>
                <div class="item">
                    ...
                    <div class="item_wrap">
                        ...
                        <p>Boleo me je vrat ali nisam mnogo obraćao pažnju na to sve dok nisam došao u fazu da ne mogu da okrenem glavu. Počeo sam da koristim CALM WRAP i za nedelju dana sam se skroz vratio u normalu.
    ...
    <section class="s1 s17">
        <div class="container">
            ...
            <div class="list-wrap">
                ...
                <div class="form-wrap">
                    <div class="prod-wrap">
                        <img src="{{ asset('/') }}naturapharmFiles/calmwrap/prod.png" alt="img" class="prod prodd" loading="lazy">
                    </div>
