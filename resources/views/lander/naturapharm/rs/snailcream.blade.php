...
<header>
    <div class="header-body">
        <div class="header-pack">
            <div class="header-pack-body"><img src="{{ asset('/') }}naturapharmFiles/snailcream/header-pack.png"
                                               alt=""/></div>
        ...
        <div class="header-info">
            <div class="header-head">
                ...
                <div class="header-text">
                    <p><span>KREMA "SNAIL" <br>ZA VEČNU MLADOST </span>
                        <br>
...
<div class="main">
    <div class="strong-block">
        <div class="strong-block-note">
            <div class="sbn-name">
                <h2><span>U ČEMU JE TAJNA</span> SNAIL KREME?</h2>
            </div>
            <div class="sbn-img">
        ...
        <div class="strong-block-text">
            <img src="{{ asset('/') }}naturapharmFiles/snailcream/header-pack.png" alt=""/>
            <p>Peptidi puža i meduze ispravljaju bore iznutra, opuštajući mišićna vlakna bez promene izraza lica.
            ...
            <p>SNAIL ne samo da će momentalno izgladiti mimičke bore, već će i sprečiti pojavu novih zbog kumulativnog
                efekta.
                Nanesite SNAIL na problematična područja i ostvarite vidljive rezultate za samo 5 dana!</p>
        </div>
    </div>
    <div class="pay-block">
        <div class="pay-block-name">
            <h2>
                ...
                <p>Instant SNAIL krema brzo i bezbolno uklanja bore sa lica!</p>
            </h2>
        </div>
        <div class="pay-block-info">
            <div class="pay-block-video"><img style="max-width: 100%"
                                              src="{{ asset('/') }}naturapharmFiles/snailcream/header-pack.png" alt=""/>
            </div>
    ...
    <div class="contrast-block">
        <div class="contrast-block-body">
            <div class="contrast-block-name">
                <h2>PO ČEMU SE <span>RAZLIKUJE</span> SNAIL KREMA OD DRUGIH PROIZVODA?</h2>
            </div>
            <div class="contrast-block-info">
                <div class="contrast-block-text">
                    <p>
                        Formula inovativne kreme SNAIL rezultat je dugogodišnjeg istraživanja. Zasnovana je na <span>peptidima puža i besmrtne meduze (Turritopsis nutricula)</span>,
                        sposobne da
                        se <span>podmlađuje beskonačan broj puta.</span> Zahvaljujući tome SNAIL <span>zaglađuje bore i trajno eliminiše uzrok starenja kože preokretom autoimunih procesa.</span>
                    </p>
                    <p>
                ...
                <div class="contrast-block-img"><img src="{{ asset('/') }}naturapharmFiles/snailcream/header-pack.png"
                                                     alt=""/></div>
            </div>
    ...
    <div class="feedback">
        <div class="feedback-name">
            <h2><span>Utisci žena</span> koje su već koristile SNAIL kremu</h2>
        </div>
        <div class="owl-carousel owl-theme">
            <div class="item">
                <div class="feed-img"><img src="{{ asset('/') }}naturapharmFiles/snailcream/slide-1.jpg" alt=""></div>
                <div class="feed-text">
                    <p><span>Prosto sam zadivljena!</span></p>
                    <p>Krema SNAIL je fenomenalna, prosto sam zadivljena!
            ...
            <div class="item">
                <div class="feed-img"><img src="{{ asset('/') }}naturapharmFiles/snailcream/slide-2.jpg" alt=""></div>
                <div class="feed-text">
                    <p><span>Nema više injekcija!</span></p>
                    <p>Volim kada kozmetika ne samo obećava već i radi! SNAIL vidno zaglađuje bore, eliminiše tamne
            ...
            <div class="item">
                <div class="feed-img"><img src="{{ asset('/') }}naturapharmFiles/snailcream/slide-3.jpg" alt=""></div>
                <div class="feed-text">
    ...
    <div class="take-block">
        <div class="take-block-name">
            <h2><span>Kako naneti</span> SNAIL kremu?</h2>
        </div>
        <div class="take-block-list">
            <ul>
                ...
                <li id="t2">
                    ...
                    <div class="tbl-info">
                        <h3>NANETI KREMU</h3>
                        <p>Nanesite SNAIL kremu po celom licu i dekolteu</p>
                    </div>
                </li>
                <li id="t3">
    ...
    <div class="order-block">
        <div class="order-block-name">
            <h2><span>Kako poručiti</span> SNAIL kremu?</h2>
        </div>
    ...
    <div class="header-body">
        ...
        <div class="header-info">
            <div class="header-head">
                ...
                <div class="header-text">
                    <p><span>KREMA "SNAIL" ZA VEČNU MLADOST</span>
                        <br>
