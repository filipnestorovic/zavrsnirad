    ...
    <div class="container">
        <div class="banner_row">
            ...
            <div class="text invisible-xs visible-sm">
                ...
                <strong>Heel Protective Sleeve je jako udoban na nogama i preporučen je od 97% ljudi koji su ga
                    kupili.</strong>
            </div>
            <div class="banner__wrapper">
                <div class="left_block">
                    <img src="{{ asset('/') }}naturapharmFiles/heelsleeve/product1.png"
        ...
        <div class="steps row">
            ...
            <div class="col-xs-100 col-sm-32">
                <div class="step">
                    ...
                    <div class="text">
                        Heel Protective Sleeve pruža petama izuzetnu amortizaciju i podršku, smanjuje trenje i apsorbuje
            ...
            <div class="col-xs-100 col-sm-34">
                <div class="step">
                    ...
                    <div class="text">
                        Heel Protective Sleeve pruža ogromnu pomoć kada je u pitanju eliminisanje bolova u petama, a ima i
    ...
    <div class="container">
        <div class="row">
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="4000">
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="{{ asset('/') }}naturapharmFiles/heelsleeve/about1.jpg" alt="">
                            </div>
                            <div class="item ">
                                <img src="{{ asset('/') }}naturapharmFiles/heelsleeve/about2.jpg" alt="">
                            </div>
                            <div class="item ">
                                <img src="{{ asset('/') }}naturapharmFiles/heelsleeve/about3.jpg" alt="">
                            </div>
                        </div>
            ...
            <div class="col-sm-50">
                <div class="right_block">
                    <h2 class="title_2">
                        O HEEL PROTECTIVE SLEEVE
                    </h2>
                    <div class="text">
                        <strong>Bol u petama često može da sprečava obavljanje svakodnevnih aktivnosti.</strong>
                        Heel Protective Sleeve savršeno pristaje na stopalo i petu, i konačno ćete osetitit veliko olakšanje.
                    ...
                    <ul class="orange_list">
                        ...
                        <li><strong>Bol u stopalu može dovesti do drugih komplikacija i dovesti do sedećeg načina
                                života.</strong> Zato ne čekajte i poručite Heel Protective Sleeve.
...
<section id="green_line">
    <div class="container">
        <div class="message">
            HEEL PROTECTIVE SLEEVE JE NA AKCIJI SAMO DANAS!
        </div>
    </div>
</section>
<section id="benefits">
        ...
        <div class="benefits_list">
            ...
            <div class="benefit_item">
                ...
                <div class="right_block">
                    ...
                    <div class="text">
                        Heel Protective Sleeve pruža izuzetnu amortizaciju i podršku i smanjuje trenje. Dizajniran je za
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-50">
                <div class="img_block">
                    <img src="{{ asset('/') }}naturapharmFiles/heelsleeve/img3.png" alt="">
                </div>
            </div>
            <div class="col-12 col-md-50">
                <div class="right_block">
                    ...
                    <div class="faq_fist">
                        ...
                        <div class="faq_item">
                            <div class="faq_title">
                                <strong>DA LI SE HEEL PROTECTIVE SLEEVE MOŽE NOSITI SVAKI DAN?</strong>
                            </div>
                            <div class="faq_answer">
...
<section id="bottom_block">
    <div class="container">
        <div class="row">
            <div class="col-xs-100 col-md-50">
                <div class="img_block">
                    <img src="{{ asset('/') }}naturapharmFiles/heelsleeve/img4.png" alt="">
                </div>
            </div>
            <div class="col-xs-100 col-md-50">
                <div class="right_block">
