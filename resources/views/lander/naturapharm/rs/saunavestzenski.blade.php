...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/') }}naturapharmFiles/saunavestzenski/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('/') }}naturapharmFiles/saunavestzenski/styles.css">
    <link href="{{ asset('/') }}naturapharmFiles/saunavestzenski/custom-styless.min.css" type="text/css" rel="stylesheet">
    <style>
    ...
    <div class="content_block wrapper">
        <div class="info">
            <div class="title_block">
                <p class="subtitle">MAJICA ZA SAGOREVANJE MASTI I SAVRŠEN STRUK</p>
...
<div class="info_section">
    <div class="wrapper">
        <div class="info_item">
            <img src="{{ asset('/') }}naturapharmFiles/saunavestzenski/b2-3.png" alt="Slim'N Lift" title="Slim'N Lift">
            <p>Ova neverovatna majica bez rukava za sagorevanje masnoće je napravljena je od polimera nove generacije.</p>
        </div>
        <div class="info_item">
            <img src="{{ asset('/') }}naturapharmFiles/saunavestzenski/b2-1.png" alt="Slim'N Lift" title="Slim'N Lift">
            <p>Pospešuje proces mršavljenja sagorevajući masti i kalorije velikom brzinom.</p>
        </div>
        <div class="info_item">
            <img src="{{ asset('/') }}naturapharmFiles/saunavestzenski/b2-4.png" alt="Slim'N Lift" title="Slim'N Lift">
            <p>Za kratak period i kvalitetan trening, trbušnjaci će postati vidljivi.</p>
        </div>
        <div class="info_item">
            <img src="{{ asset('/') }}naturapharmFiles/saunavestzenski/b2-2.png" alt="Slim'N Lift" title="Slim'N Lift">
...
<section class="about_section">
    <div class="wrapper clearfix">
        ...
        <div class="text_block">
            <p>2u1 SAUNA VEST pomaže da se ima ženstvena i atraktivna figura. Telo brzo postaje zategnutije i privlačnije - bez dijeta i izgladnjivanja.
    ...
    <div class="wrapper">
        <div class="product_item male clearfix">
            <div class="gallery_block">
                <img class="image one" src="{{ asset('/') }}naturapharmFiles/saunavestzenski/b4-1.jpg" alt="Slim'N Lift" title="Slim'N Lift">
            </div>
            <div class="info">
...
<section class="order_steps_section">
    <div class="wrapper">
        ...
        <div class="steps_list">
            <div class="step_item">
                <img src="{{ asset('/') }}naturapharmFiles/saunavestzenski/order_steps__step1_image.png" alt="Slim'N Lift" title="Slim'N Lift">
                <p>Ostavite podatke za dostavu na sajtu</p>
            </div>
            <div class="step_item">
                <img src="{{ asset('/') }}naturapharmFiles/saunavestzenski/order_steps__step2_image.jpg" alt="Slim'N Lift" title="Slim'N Lift">
                <p>Kontaktiraćemo Vas da potvrdimo porudžbinu</p>
            </div>
            <div class="step_item">
                <img src="{{ asset('/') }}naturapharmFiles/saunavestzenski/order_steps__step3_image.jpg" alt="Slim'N Lift" title="Slim'N Lift">
                <p>Poslaćemo pošiljku brzom poštom</p>
            </div>
            <div class="step_item">
                <img src="{{ asset('/') }}naturapharmFiles/saunavestzenski/order_steps__step4_image.jpg" alt="Slim'N Lift" title="Slim'N Lift">
    ...
    <div class="wrapper">
        ...
        <div class="reviews_list owl-carousel">
            <div class="review_item clearfix">
                <img src="{{ asset('/') }}naturapharmFiles/saunavestzenski/rew-1.jpg" alt="Slim'N Lift" title="Slim'N Lift">
                <div class="text_block">
                    <div class="author_info">Jasna 29 godina</div>
                    <p>Imam višak kilograma. Slim And Lift zaista skida stomak, masne naslage sa leđa i ističe zadnjicu i grudi. Dobijam komplimente za izgled, a i lepše mi je gledati sebe u ogledalu.</p>
                </div>
            </div>
            <div class="review_item clearfix">
                <img src="{{ asset('/') }}naturapharmFiles/saunavestzenski/rew-2.jpg" alt="Slim'N Lift" title="Slim'N Lift">
                <div class="text_block">
                    <div class="author_info">Bojana, 32 godine</div>
                    <p>Da budem iskrena, nisam mogla da verujem da je moguće nositi odeću 2-3 veličine manju za kratak period. Kada sam ga isprobala i videla koliko se znojim, shvatio sam da je to to. Muškarci me više primete, a moje koleginice s posla traže da im otrkijem recept za dijetu. :)</p>
                </div>
            </div>
        </div>
    </div>
...
<script src="{{ asset('/') }}naturapharmFiles/saunavestzenski/owl.carousel.min.js"></script>
<script src="{{ asset('/') }}naturapharmFiles/saunavestzenski/scripts.js"></script>
