...
<div class="main__wrapper s__main">
    ...
    <section class="sec1">
        <div class="sec1__container">
            <div class="sec1__h1 only-web sec1__text__gr font-mons" data-xd="t2">Отслабнете бързо и лесно, по напълно
                естествен начин!
            </div>
            <div class="h1 only-mob sec1__text__gr font-mons" data-xd="t2">Отслабнете бързо и лесно</div>
            <div class="h2 only-mob font-mons" data-xd="t2">по напълно естествен начин!</div>
            ...
            <button class="btn for_scroll"> ПОРЪЧАЙ</button>
            <div class="last__block">
                ...
                <div class="h2 green font-mons" data-xd="t2"><b>Отървете се от мастните натрупвания</b> и изхвърлете
                    токсините, без да губите мускулна маса
                </div>
                <ul class="font-PT">
                ...
                <div class="kletki font-mons"><span>мастни клетки (преди)</span><span>мастни клетки (след)</span><img
                        alt src="{{ asset('/') }}natureteaFiles/slimonex1/photo3.png"></div>
        ...
        <div class="sec2__container">
            ...
            <div class="sec2__grid">
                <div class="sec2__part">
                    ...
                    <p class="font-PT">Лабораторен анализ потвърди, че продуктът съдържа <b class="green">напълно
                            естествени вещества, които
                            имат положителен ефект върху целия организъм.</b></p>
                    <p class="font-PT"><b class="green">Те ускоряват кръвообращението, засилват метаболизма и изхвърлят
                            токсините и течностите от тялото. </b>
                        Бързо топи натрупаните мазнини и прави корема стегнат и плосък.</p>
                </div>
    ...
    <section class="sec3">
        <div class="sec3__container">
            ...
            <div class="h1 blue font-mons" data-xd="t2"> KIYESKI</div>
            <span class="h2 blue font-mons" data-xd="t2">натуралните лепенки за отслабване</span>
            <div class="h2 pink font-mons" data-xd="t2">Само за няколко дни тялото ви ще бъде <b>пречистено, пълно с
                    енергия, а килограмите ще ca видно намалени.</b></div>
            <div class="sec3__grid" dir="rtl">
                <div class="sec3__part" dir="ltr">
                    ...
                    <div class="only-mob"><img alt class="prod"
                                               src="{{ asset('/') }}naturapharmFiles/kiyeskibodyshaping/prod.png"></div>
                    <div class="girl"></div>
                    <p class="white_block pink font-mons only-web">KIYESKI BODY SHAPING ДАВА ЕНЕРГИЯ ПРЕЗ ЦЕЛИЯ ДЕН</p>
                    <button class="btn for_scroll only-web"> Поръчай сега</button>
                </div>
                <div class="sec3__part" dir="ltr">
                    <p class="font-PT">
                        Уникална комбинация от съставки, които подпомагат здравословното функциониране на организма. Не
                        съществува отрицателни ефекти и енергийни спадове през деня. Мазнините се бързо топят и
                        изхвърлят на повърхността, ускорява се метаболизмът и стимулира изхвърлянето на течности.
                        <b class="pink">Те намаляват апетита и засилват метаболизма в умерени граници. Резултатът е
                            безболезнено и за сравнително кратко време ефективно отслабване.</b></p>
                    <ul class="font-PT">
                    ...
                    <p class="white_block pink font-mons only-mob">KIYESKI BODY SHAPING DAJE ENERGIJU TOKOM CELOG
                        DANA</p>
            ...
            <div class="sec5__grid">
                ...
                <div class="sec5__part">
                    <div class="grafic grafic2">
                        <div class="vertical">
                            <p class="font-mons">поддържане на тегло в кг</p>
                            <ul class="font-PT">
                                <li> 80</li>
                                <li> 70</li>
                                <li> 60</li>
                        ...
                        <div class="variant">
                            <div class="h1 font-mons">Поддържане на теглото</div>
                            <ul class="font-PT">
                                <li class="red">Обикновени диети</li>
                                <li class="gr"> Kiyeski Body Shaping</li>
                            </ul>
        ...
        <div class="sec7__container">
            ...
            <div class="sec7__grid" dir="rtl">
                ...
                <div class="sec7__part last_block" dir="ltr">
                    ...
                    <div class="after"></div>
                    <div class="girl-name blue font-mons" data-xd="t46">Дияна, 28 години</div>
                    <p class="last-p font-PT">Напълнях повече след раждането. Мислех, че ще отслабна лесно, но след
                        много диети още се напълнях. Постоянно бях гладна и в лошо настроение. След като използвах
                        пластира Kiyeski, аз веднага започнах да се чувствам по-добре. Имах повече енергия през деня,
                        бях по-малко уморна през вечерта, живем с по-малко стрес. Като резултат на това достигнах
                        идеалното си тегло за 2,5 месеца. Между другото, с диети аз не дойдох до идеалното си тегло дори
                        и след една година!</p>
                </div>
            </div>
        </div>
    </section>
    <section class="sec8">
        <div class="sec8__container">
            <div class="up_block">
                ...
                <p class="font-PT up_p"> Такива резултати се постигат благодарение на комбинацията от два фактора - <b
                        class="blue"> разграждане на мазнини + изхвърляне на токсините. </b></p>
                <div class="only-web"><img alt class="prod"
                                           src="{{ asset('/') }}naturapharmFiles/kiyeskibodyshaping/prod.png"></div>
                <div class="only-mob"><img alt class="prod"
                                           src="{{ asset('/') }}naturapharmFiles/kiyeskibodyshaping/prod.png"></div>
            ...
            <p class="font-PT margin-left"><b class="pink">Токсините напускат тялото още през първите седмици на
                    използването</b><br> Ето защо резултатите са видими веднага. </p>
            <p class="font-PT"> В продължение на 2 седмици <b class="pink">дълбоките мастни натрупвания започват да се
                    разграждат, нивото на алкалност се възстановява и съставът на кръвта се подобрява. </b> Загубата на
                тегло може да бъде бавна поради процеса на възстановяване на цялостното здраве. </p>
        </div>
    </section>
    <section class="sec9">
        <div class="sec9__container">
            ...
            <div class="dietolog">
                ...
                <p class="font-PT">Kiyeski Body Shaping е биологично активен продукт с цялостен ефект за подобряване на
                    здравето, който хората около вас ще забележат промените. Положителни резултати могат да се видят и
                    при кръвен тест. Нисък холестерол, стабилни нива на крвна захар, здравословно количество на протеин,
                    които показват резултатите от моите пациенти, благодарение на Kiyeski Body Shaping.</p>
    ...
    <section class="sec11">
        <div class="sec11__container">
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Ура! Kiyeski Body Shaping е нещо невероятно! Свалих 7 кг без никакви усилия само за
                    един месец. Сега работя върху корема си.</p>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Повече от месец отслабвам с лепенки Kiyeski. Малко по малко апетитът ми
                    намаля.Започнах да се чувствам сит дори след малки порции. Не бях на диета, просто ограничих приема
                    на захарни и тестени изделия. Като резултат на това отслабнах с 12 кг. Мазнините от гърдите и
                    стомаха са изчезнали. Виж как изглеждам.</p>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Не знам какво мислят другите, но аз съм много доволна от този продукт. Той наистина
                    ми помогна! Отслабнах с 23,5 кг. Сега искам да спортувам! В момента имам фигура, която дори не можех
                    да си представя преди.</p>
                <p class="font-PT">
                    <b class="blue">
                        Йована
                    </b>
        ...
        <div class="sec12__container">
            <div class="sec12__grid">
                <div class="sec12__part">
                    <div class="h2 blue font-mons" data-xd="t2">KIYESKI BODY SHAPING - За плосък и привлекателен
                        корем!
                    </div>
                    <div class="h1 blue font-mons" data-xd="t2"> KIYESKI BODY SHAPING</div>
                ...
                <div class="sec12__part">
                    <div class="order">
                        <form action="{{$orderRoute}}" class="form font-mons main_form" data-xd="t76" id="order_form"
                            ...
                            <input class="inp only_number phone-js font-mons" name="phone" placeholder="Телефонен номер"
                                   type="tel" required>
                            <input class="inp font-mons" name="shipping_address" placeholder="Адрес" type="text"
                                   required>
