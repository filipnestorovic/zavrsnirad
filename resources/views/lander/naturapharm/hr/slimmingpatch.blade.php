...
<div class="main__wrapper s__main">
    ...
    <section class="sec1">
        <div class="sec1__container">
            <div class="sec1__h1 only-web sec1__text__gr font-mons" data-xd="t2">Smršavite brzo i jednostavno, bez jo-jo efekta!</div>
            <div class="h1 only-mob sec1__text__gr font-mons" data-xd="t2">Smršavite brzo i jednostavno</div>
            <div class="h2 only-mob font-mons" data-xd="t2"> bez jo-jo efekta! </div>
            <img alt class="sec1__prod only-web" src="{{ asset('/') }}naturapharmFiles/slimmingpatch/prod2.png"><img alt class="sec1__prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimmingpatch/prod2.png"><button class="btn for_scroll"> NAPRAVITE NARUDŽBU </button>
        ...
        <div class="sec2__container">
            ...
            <div class="sec2__grid">
                <div class="sec2__part">
                    ...
                    <p class="font-PT">Laboratorijska analiza utvrdila je da proizvod sadrži
                        <b class="green">potpuno prirodne tvari koje pozitivno djeluju na cijeli organizam.</b></p>
                    <p class="font-PT">
                        <b class="green">Ubrzavaju cirkulaciju i metabolizam i izbacuju toksine i tekućinu iz tijela.</b>
                        Brzo tope masne naslage i čine trbuh zategnutim i ravnim.</p>
                </div>
    ...
    <section class="sec3">
        <div class="sec3__container">
            <span class="h2 blue font-mons" data-xd="t2">Započnite svoj dan s energijom od</span>
            ...
            <div class="sec3__grid" dir="rtl">
                <div class="sec3__part" dir="ltr">
                    ...
                    <div class="girl"></div>
                    <p class="white_block pink font-mons only-web">SLIMMING PATCH DAJE ENERGIJU TIJEKOM CIJELOG DANA</p>
                ...
                <div class="sec3__part" dir="ltr">
                    <p class="font-PT">
                        ...
                        <b class="pink">Na taj način se smanjuje nadutost, olakšava pokretljivost, a najvažniji faktor je mršavljenje i zategnuto tijelo.</b></p>
                    <ul class="font-PT">
                        <li>Poboljšava stanje tijela</li>
                        <li>Ubrzava sagorijevanje masti</li>
                        <li>Smanjuje razinu kolesterola u krvi</li>
                        <li>Smanjuje apetit</li>
                    </ul>
                    <p class="white_block pink font-mons only-mob">SLIMMING PATCH DAJE ENERGIJU TIJEKOM CIJELOG DANA</p>
    ...
    <section class="sec5">
        <div class="sec5__container">
            ...
            <p class="font-PT"> Vaše tijelo je transformirano zahvaljujući posebnoj kombinaciji prirodnih sastojaka
        ...
        <div class="sec7__container">
            ...
            <div class="sec7__grid" dir="rtl">
                ...
                <div class="sec7__part last_block" dir="ltr">
                    ...
                    <p class="last-p font-PT">Udebljala sam se nakon poroda. Mislila sam da ću lako smršaviti, ali nakon brojnih dijeta i dalje sam se debljala. Stalno sam bila gladna i loše volje. Nakon korištenja Slimming patch flastera, odmah sam se počela osjećati bolje. Imala sam više energije tijekom dana, a navečer sam bila manje umorna, živjela sam s manje stresa. Kao rezultat toga, dosegla sam svoju idealnu težinu u roku od 2,5 mjeseca. Inače, ni nakon godinu dana dijete nisam dosegla idealnu težinu!</p>
                </div>
            </div>
        </div>
    </section>
    <section class="sec8">
        <div class="sec8__container">
            ...
            <p class="font-PT"><b class="pink">Tijekom 2 tjedna, duboke masne naslage počinju se razgrađivati, razina lužnatosti se vraća, a sastav krvi se poboljšava.</b>
                Gubitak težine može biti spor zbog procesa obnove cjelokupnog zdravlja. </p>
        </div>
    </section>
    <section class="sec9">
        ...
        <div class="sec10__container">
            <div class="sec10__grid">
                ...
                <div class="sec10__part">
                    ...
                    <img alt class="prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimmingpatch/prod.png"><button class="btn for_scroll"> NAPRAVITE NARUDŽBU </button>
                </div>
            </div>
        </div>
    </section>
    <section class="sec11">
        <div class="sec11__container">
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Čula sam za Slimming Patch prije 6 mjeseci. Tada sam imala 90 kg. U samo dva mjeseca izgubila sam gotovo 20 kg! Tako sam sretna! Nakon toga sam počela polako gubiti kilograme. Unatoč tome, sada imam 62,5 kg i osjećam se bolje nego ikad.</p>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Smršavila sam uz Slimming Patch prije godinu dana. Najvažnije je da su mi ne samo pomogli izgubiti 20 kg, već su mi i očistili tijelo. Trbuh me više ne boli, nemam alergije i osjećam se punom energije.</p>
            ...
            <div class="comment">
                <div class="star4"></div>
                <p class="font-PT">Koristim Slimming Patch tjedan dana i već vidim rezultate. Hlače mi više nisu tijesne.</p>
                <p class="font-PT">
                    <b class="blue">
                        Miroslava
                    </b>
            ...
            <div class="comment">
                <p class="font-PT">Naporno sam trenirao u teretani 2 godine. Uz to sam stalno bio na dijeti jer sam htio smršaviti 45 kg. Bilo je jako teško. Odlučio sam isprobati Slimming Patch jer više ne znam što ću s kilogramima.</p>
                <p class="font-PT">
                    <b class="blue">
                        Bojan
                    </b>
            ...
            <div class="comment">
                <div class="star4"></div>
                <p class="font-PT">Moj kolega koristi Slimming svaki dan. Puno je smršavio! Prešao je s XL veličine na S, tako da mogu reći da ovaj dodatak stvarno djeluje. Djeluje bolje od dijete, rezultati su stvarno vidljivi.</p>
                <p class="font-PT">
                    <b class="blue">
                        Ana
                    </b>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Sviđa mi se osjećaj lakoće koji daje Slimming patch! Imam puno energije tijekom dana! Višak kilograma za mene je prošlost.</p>
                <p class="font-PT">
                    <b class="blue">
                        Kristina
                    </b>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Jej! Slimming patch je nešto nevjerojatno! Smršavio sam 7 kg bez imalo truda u samo mjesec dana. Sada radim na trbušnjacima.</p>
            ...
            <div class="comment">
                <p class="font-PT">Slimming Patch je moja posljednja nada! Već 10 godina se borim s viškom kilograma. Sve sam isprobala. Danas sam naručila ovaj proizvod. Vidjet ćemo kad stigne.</p>
                <p class="font-PT">
                    <b class="blue">
                        Anita
                    </b>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Volim koristiti Slimming Patch prije treninga. Daju mi puno energije, dovoljno da obavim sve zadatke tijekom dana.</p>
                <p class="font-PT">
                    <b class="blue">
                        Slavica
                    </b>
            ...
            <div class="comment">
                <p class="font-PT">Cijeli život se bavim sportom i uvijek sam imala problema sa strukom i bedrima. Želim imati savršeno tijelo. Došlo je vrijeme da isprobam Slimming Patch.</p>
                <p class="font-PT">
                    <b class="blue">
                        Antonela
                    </b>
        ...
        <div class="sec12__container">
            <div class="sec12__grid">
                <div class="sec12__part">
                    <div class="h2 blue font-mons" data-xd="t2">SLIMMING PATCH – Za ravan i privlačan trbuh!</div>
                    <div class="h1 blue font-mons" data-xd="t2"> SLIMMING PATCH</div>
