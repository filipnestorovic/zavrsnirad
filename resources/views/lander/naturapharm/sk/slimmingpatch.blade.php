...
<div class="main__wrapper s__main">
    <div class="header">
        <div class="header__container">
            <div class="logo font-mons"><b>NÁPLASTI NA CHUDNUTIE</b></div>
            <div class="h1 font-mons" data-xd="t3"><b>Pre ploché a atraktívne brucho!</b></div>
        </div>
    </div>
    <section class="sec1">
        <div class="sec1__container">
            <div class="sec1__h1 only-web sec1__text__gr font-mons" data-xd="t2">Schudnite rýchlo a ľahko, bez jojo efektu!</div>
            <div class="h1 only-mob sec1__text__gr font-mons" data-xd="t2">Schudnite rýchlo a ľahko</div>
            <div class="h2 only-mob font-mons" data-xd="t2">bez jojo efektu!</div>
            <img alt class="sec1__prod only-web" src="{{ asset('/') }}naturapharmFiles/slimmingpatch/prod2.png"><img alt class="sec1__prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimmingpatch/prod2.png"><button class="btn for_scroll"> OBJEDNAJTE </button>
        ...
        <div class="sec2__container">
            ...
            <div class="sec2__grid">
                <div class="sec2__part">
                    ...
                    <p class="font-PT">
                        Laboratórnou analýzou bolo zistené, že výrobok obsahuje úplne prírodné látky,
                        <b class="green">ktoré majú pozitívny vplyv na celý organizmus.</b></p>
                    <p class="font-PT">
                        <b class="green">Zrýchľujú krvný obeh, zvyšujú metabolizmus a vylučujú z tela toxíny a tekutiny.</b>
                        Rýchlo rozpúšťa tukové zásoby a robí žalúdok pevným a plochým.</p>
                </div>
    ...
    <section class="sec3">
        <div class="sec3__container">
            ...
            <div class="h1 blue font-mons" data-xd="t2">NÁPLASTI NA CHUDNUTIE</div>
            <div class="h2 pink font-mons" data-xd="t2">Už za niekoľko dní bude vaše telo prečistené, <b>plné energie a hmotnosť bude viditeľne znížená.</b></div>
            <div class="sec3__grid" dir="rtl">
                <div class="sec3__part" dir="ltr">
                    ...
                    <div class="girl"></div>
                    <p class="white_block pink font-mons only-web">NÁPLASTI NA CHUDNUTIE VÁM DODAJÚ ENERGIU POČAS CELÉHO DŇA</p>
                    <button class="btn for_scroll only-web"> OBJEDNAJTE </button>
                </div>
                <div class="sec3__part" dir="ltr">
                    <p class="font-PT">Jedinečná kombinácia zložiek podporuje zdravé fungovanie organizmu. Tento prípravok nespôsobuje negatívne účinky a pokles energie počas dňa. Tuky sa rýchlo rozpúšťajú a vyhadzujú na povrch a zrýchlený metabolizmus vyvoláva vylučovanie tekutín.
                    ...
                    <ul class="font-PT">
                        <li>Zlepšuje telesnú kondíciu</li>
                        <li>Urýchľuje spaľovanie tukov</li>
                        <li>Znižuje hladinu cholesterolu v krvi </li>
                        <li>Znižuje chuť do jedla</li>
                    </ul>
                    <p class="white_block pink font-mons only-mob">OBLIŽ ZA HUJŠANJE DAJE ENERGIJO ZA CEL DAN</p>
                    ...
                    <div class="grafic grafic1">
                        ...
                        <div class="variant">
                            ...
                            <ul class="font-PT">
                                ...
                                <li class="gr">Náplasť na chudnutie</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <section class="sec7">
        <div class="sec7__container">
            <div class="h1 blue font-mons" data-xd="t2"> Výsledky </div>
            <div class="h2 blue font-mons" data-xd="t2"> používateľa </div>
    ...
    <section class="sec8">
        <div class="sec8__container">
            <div class="up_block">
                ...
                <div class="h2 pink font-mons" data-xd="t2">do 2 mesiacov</div>
            ...
            <p class="font-PT margin-left">
                <b class="pink">Toxíny opúšťajú telo už počas prvých týždňov liečby.</b><br> Preto sú výsledky viditeľné okamžite. </p>
            <p class="font-PT"> <b class="pink">V priebehu 2 týždňov sa začnú rozkladať hlboké tukové zásoby, vráti sa hladina zásaditosti a zlepší sa zloženie krvi.</b>
                Úbytok hmotnosti môže byť pomalý vzhľadom na proces obnovy celkového zdravia. </p>
        </div>
    </section>
    <section class="sec9">
        <div class="sec9__container">
            ...
            <div class="dietolog">
                ...
                <p class="font-PT">Náplasť na chudnutie je biologicky aktívny výrobok s komplexným účinkom na zlepšenie zdravia, ktorý si všimne aj vaše okolie. Pozitívne výsledky možno pozorovať aj pri krvnom teste. Nízka hladina cholesterolu, stabilná hladina cukru, zdravé množstvo bielkovín, to sú nálezy mojich pacientov, ktoré sa ukázali vďaka náplastiam na chudnutie!</p>
        ...
        <div class="sec10__container">
            <div class="sec10__grid">
                ...
                <div class="sec10__part">
                    ...
                    <img alt class="prod only-mob" src="{{ asset('/') }}naturapharmFiles/slimmingpatch/prod.png"><button class="btn for_scroll"> OBJEDNAJTE </button>
                </div>
            </div>
        </div>
    </section>
    <section class="sec11">
        <div class="sec11__container">
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">O náplasti na chudnutie som počul pred 6 mesiacmi. Vtedy som vážila 90 kg. Za dva mesiace som schudla takmer 20 kg! Som taká šťastná! Potom som začala pomaly chudnúť. Napriek tomu mám teraz 62,5 kg a cítim sa lepšie ako kedykoľvek predtým.</p>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">S náplasťami na chudnutie som schudla pred rokom. Najdôležitejšie je, že mi pomohli nielen schudnúť 20 kg, ale aj prečistiť telo. Už ma nebolí brucho, nemám alergie a cítim sa plná energie.</p>
            ...
            <div class="comment">
                <div class="star4"></div>
                <p class="font-PT">Sú skvelé! Používam ich už nejaký čas. Práve teraz môžem povedať, že som sa úplne zmenila a že moje telo vyzerá inak.</p>
                <p class="font-PT">
                    <b class="blue">
                        Anastázia
                    </b>
            ...
            <div class="comment">
                <div class="star4"></div>
                <p class="font-PT">Zoštíhľujúce náplasti používam týždeň a už vidím výsledky. Moje nohavice už nie sú tesné.</p>
                <p class="font-PT">
                    <b class="blue">
                        Miroslava
                    </b>
            ...
            <div class="comment">
                <p class="font-PT">V posilňovni som tvrdo trénovala 2 roky. Okrem toho som neustále držala diétu, pretože som chcela schudnúť 45 kg. Bolo to naozaj ťažké. Rozhodla som sa vyskúšať náplasti na chudnutie, pretože už neviem, čo s kilogramami.</p>
                <p class="font-PT">
                    <b class="blue">
                        Branislav
                    </b>
            ...
            <div class="comment">
                <div class="star4"></div>
                <p class="font-PT">Môj kolega používa náplasti na chudnutie každý deň. Schudol veľa kíl! Z veľkosti XL sa dostal na veľkosť S, takže môžem povedať, že tento doplnok naozaj funguje. Funguje lepšie ako diéta, budete víťazom.</p>
                <p class="font-PT">
                    <b class="blue">
                        Anna
                    </b>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Milujem ten pocit ľahkosti, ktorý náplasti na chudnutie poskytujú! Počas dňa mám veľa energie! Nadváha je pre mňa minulosťou.</p>
                <p class="font-PT">
                    <b class="blue">
                        Kristína
                    </b>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Hurá! Náplasti na chudnutie sú niečo úžasné! Za jeden mesiac som schudla 7 kg bez akejkoľvek námahy. Teraz pracujem na brušných svaloch.</p>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Už viac ako mesiac chudnem s náplasťami na chudnutie. Postupne sa mi znížila chuť do jedla. Začal som sa cítiť sýty aj po malých porciách. Nedržal som diétu, len som obmedzil príjem cukru a cestovín. Výsledkom bolo, že som schudla 12 kg. Tuk z hrudníka a žalúdka zmizol. Pozrite sa na moju postavu.</p>
            ...
            <div class="comment">
                <p class="font-PT">Ak chcete len schudnúť, potom vám tento výrobok pomôže, ale nie príliš. Ak chcete atletické telo, budete musieť cvičiť.</p>
                <p class="font-PT">
                    <b class="blue">
                        Adela
                    </b>
            ...
            <div class="comment">
                <p class="font-PT">Náplasť na chudnutie je moja posledná nádej! Už 10 rokov bojujem s nadváhou. Vyskúšala som všetko. Dnes som si tento výrobok objednala. Uvidíme, kedy príde</p>
                <p class="font-PT">
                    <b class="blue">
                        Eva
                    </b>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Neviem, čo si myslia ostatní, ale ja som s týmto výrobkom veľmi spokojná. Skutočne mi pomohol! Schudla som 23,5 kg. Teraz chcem športovať! Momentálne mám postavu, ktorú som si predtým nevedela ani predstaviť.</p>
            ...
            <div class="comment">
                <div class="star5"></div>
                <p class="font-PT">Rád používam náplasť na chudnutie pred tréningom. Dodáva mi veľa energie, dosť na to, aby som zvládla všetky úlohy počas dňa.</p>
                <p class="font-PT">
                    <b class="blue">
                        Alexandra
                    </b>
            ...
            <div class="comment">
                <p class="font-PT">Celý život športujem a vždy som mala problémy s pásom a stehnami. Chcem mať dokonalé telo. Nastal čas, aby som vyskúšala zoštíhľujúce náplasti.</p>
                <p class="font-PT">
                    <b class="blue">
                        Petra
                    </b>
        ...
        <div class="sec12__container">
            <div class="sec12__grid">
                <div class="sec12__part">
                    <div class="h2 blue font-mons" data-xd="t2">NÁPLASTI NA CHUDNUTIE - Pre ploché a príťažlivé brucho!</div>
                    <div class="h1 blue font-mons" data-xd="t2">NÁPLASTI NA CHUDNUTIE</div>
                ...
                <div class="sec12__part">
                    <div class="order">
                        <form action="{{$orderRoute}}" class="form font-mons main_form" data-xd="t76" id="order_form" method="post">
                            ...
                            <div class="zakaz blue">ZADAJTE ÚDAJE O DORUČENÍ</div>
