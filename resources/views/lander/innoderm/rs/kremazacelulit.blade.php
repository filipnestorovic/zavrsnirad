...
<div class="wrapper">
        ...
        <div class="container">
            <div class="row align-items-center vertical-align-center">
                <div class="col-md-3 col-sm-7 col-6">
                    <a href="#">
                        <img src="{{ asset('/') }}innodermFiles/kremazacelulit/logo.png" class="cellulite-logo" />
                    </a>
                </div>
    ...
    <section class="top">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col mobile-bg">
                        <picture>
                            <source srcset="{{ asset('/') }}innodermFiles/kremazacelulit/product-01.png" type="image/png" class="">
                            <img src="{{ asset('/') }}innodermFiles/kremazacelulit/product-01.png" alt="" class="packshot">
                        </picture>
                    </div>
                </div>
                <picture>
            ...
            <div class="container">
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-4 text-center text-md-left pt-4 pt-md-0">
                        <picture>
                            <source srcset="{{ asset('/') }}innodermFiles/kremazacelulit/cellulite-01.png" type="image/png" class="">
                            <img src="{{ asset('/') }}innodermFiles/kremazacelulit/cellulite-01.png" alt="" class="">
                        </picture>
                    </div>
                </div>
            </div>
        ...
        <picture>
            <source srcset="{{ asset('/') }}innodermFiles/kremazacelulit/product-02.png" type="image/png" class="">
            <img src="{{ asset('/') }}innodermFiles/kremazacelulit/product-02.png" alt="" class="packshot-cellulite">
        </picture>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 pt-4 pt-md-0">
                    <picture>
                        <source srcset="{{ asset('/') }}innodermFiles/kremazacelulit/cellulie-4.png" type="image/png" class="">
                        <img src="{{ asset('/') }}innodermFiles/kremazacelulit/cellulie-4.png" alt="" class="mobile-img">
                    </picture>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col mobile-bg">
                    <picture>
                        <source srcset="{{ asset('/') }}innodermFiles/kremazacelulit/product-01.png" type="image/png" class="">
                        <img src="{{ asset('/') }}innodermFiles/kremazacelulit/product-01.png" alt="" class="packshot d-block mx-auto mx-md-0">
                    </picture>
                </div>
            </div>
        </div>
    ...
    <section class="end">
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-6">
                    <picture>
                        <source srcset="{{ asset('/') }}innodermFiles/kremazacelulit/footer-logo.png" type="image/png" class="">
                        <img src="{{ asset('/') }}innodermFiles/kremazacelulit/footer-logo.png" alt="" class="cellulite-end-logo d-block ml-auto mr-auto d-md-inline ml-md-0 mr-md-0 mb-3">
                    </picture>
            ...
            <div class="row d-block d-md-none">
                <div class="col mobile-bg">
                    <picture>
                        <source srcset="{{ asset('/') }}innodermFiles/kremazacelulit/product-02.png" type="image/png" class="">
                        <img src="{{ asset('/') }}innodermFiles/kremazacelulit/product-02.png" alt="" class="packshot">
                    </picture>
                    <picture>
