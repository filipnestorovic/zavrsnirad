...
<head>
    ...
    <link href="{{ asset('/') }}natureteaFiles/slimonex_adv/index.css" rel="stylesheet">
    <link href="{{ asset('/') }}natureteaFiles/slimonex_adv/rwd.css" rel="stylesheet">
</head>
<body>
    ...
    <div class="container" id="main_div">
        ...
        <div class="wrapper">
            <section class="content">
                ...
                <p>Nutricionisti se plaše da bi mogli ostati bez posla. Da li je moguće da ih ova nova metoda za mršavljenje čini potpuno nebitnim? Nakon što je u Srbiji kreirana prirodna formula <a href="#product-box">Slimonex</a> stigla je očekivana revolucija u borbi protiv prekomerne težine!</p>
                <p>Već više hiljada korisnika ovog proizvoda izgubilo je 10+ kilograma u mesec dana: bez napora, bezbedno, bez jojo efekta. Zbog toga su rizici od srčanog i moždanog udara smanjeni. Uz to je nivo lošeg holesterola smanjen, a takođe uspeli su i da se zaštite od arteroskleroze. Vratili su atraktivan izgled, samopouzdanje i izvrsnu fizičku kondiciju. Kako je to moguće?</p>
                <p>Vaso Bicović odlučio je pomoći supruzi sa viškom kilograma i kompleksima. Bio je to početak revolucije u borbi protiv prekomerne težine. Nakon godinu dana istraživanja, razvijen je 100% prirodni, bezbedni i jednostavni za upotrebu čaj za mršavljenje <a href="#product-box">Slimonex</a>. Zahvaljujući čaju <a href="#product-box">Slimonex</a>, supruga je smršala 30+ kilograma za dva meseca i, kako ponosno priznaje, "dobila izgled modela!"</p>
                <p>Popularni časopisi već su nazvali ovaj tretman "pionirskim dostignućem u ishrani" , a Bicović je već dobio nekoliko prestižnih nagrada. Zahvaljujući uspehu njegove formule, čak i ljudi koji imaju prekomernu težinu ili već dugi niz godina pate od prekomerne težine (bez obzira na njihove uzroke) mogu da izgube približno dosta kilograma u kratkom periodu: vrlo efikasno i bez gladovanja ili vežbanja.</p>
                ...
                <p>Ove reči potvrđuje više hiljada zadovoljnih korisnika ove prirodne formule za smanjenje težine, koji su već bili podvrgnuti tretmanu i sada uživaju u vitkom telu. Zato smo odlučili detaljnije analizirati poznate dijete. I, tačnije, proveriti zašto ne daju željene rezultate. Evo zaključaka:</p>
                <div style="clear:both;"></div>
                <ul class="list">
                    <li>
                        <h4>Većinu dijeta ne pripremaju stručnjaci</h4>
                        <p>Da biste trajno izgubili kilograme, morate da gladujete oko 2 i po meseca. Da bi se postigla željena težina, to znači da vam treba čak nekoliko godina odricanja . Prestanite da se mučite i borite protiv vas i vaših omiljenih pica, deserta ili kolača. I sve to zato što 98% dijetalnih programa kreiraju nestručne osobe i totalni amateri. Ljudi koji nemaju pojma o funkcionisanju tela, probavnog sistema i odgovorne ishrane. Ovakve dijete štetne su za telo, opasne po zdravlje i potpuno neefikasne. I na kraju – ne deluje svaki organizam na svaku dijetu isto.</p>
                    </li>
                    <li>
                        <h4>Dijete oslabljuju telo i smanjuju njegovu otpornost</h4>
                        <p>Dijeta može rezultira nedostatkom vitamina i mikroelemenata. Telo gubi energiju, zato se osećamo umorno, razdražljivo i pospano . Otpornost tela na viruse i bakterije drastično opada pa se vrlo lako razboljevamo.</p>
                    </li>
                    <li>
                        <h4>Dijetalni proizvodi mogu biti opasni po zdravlje</h4>
                        <p>Proizvođači nas pokušavaju privući tipičnim proizvodima. Nažalost, iako sadrže puno vlakana, imaju i puno šećera koji vas, kao što je poznato, goji više od hamburgera. Proizvodi koji ne sadrže šećer sadrže aspartame, veštački zaslađivač koji je kancerogen!</p>
                    </li>
                    <li>
                        <h4>Dijeta znači izgladnjivanje, žrtvovanje, osećaj krivice</h4>
                        <p>Stalna borba protiv apetita i odbijanje uživanja u hrani je nešto što je nemoguće prevladati. Sa druge strane, situacije u kojim nas nezaustavljivi apetit slomi tokom porodične večere ili večere sa prijateljima uzrok su mnogih kajanja.</p>
                    </li>
                    <li>
                        <h4>Trošimo mnogo novca na dijete</h4>
                        <p>Angažovanje iskusnog nutricioniste košta najmanje 150 evra mesečno. Svi dijetalni, niskokalorični i fit proizvodi jednostavno su skupi. Shodno tome, trošimo 4 puta više novca na "dijetalne" proizvode nego na obične. Da bismo održali težinu, morali bismo jesti na ovaj način cao život. Nijedan novčanik ne može to da izdrži, pogotovo u našoj zemlji.</p>
                    </li>
                    <li>
                        <h4>Nakon završavanja dijete, pojavljuje se jojo efekat</h4>
                ...
                {{--<div class="chart">--}}
                    {{--<article style="background-color: #f8fff7;">--}}
                        {{--<p> Eliminisanje naslaga u crevima, pročišćavanje toksina iz tela, gubljenje preteranog apetita, otprilike 5 kilograma manje </p>--}}
                        {{--<div style="height: 150px;"></div>--}}
                    {{--</article>--}}
                    {{--<article style="background-color: #e7ffe7;">--}}
                        {{--<p> Smanjen osećaj gladi, poboljšani metabolizam, ubrzano sagorevanje kalorija, dodatnih 4 kilograma manje </p>--}}
                        {{--<div style="height: 175px;"></div>--}}
                    {{--</article>--}}
                    {{--<article style="background-color: #d8ffd3;">--}}
                        {{--<p> Automatsko sagorevanje masnog tkiva, niži nivo holesterola i šećera, dodatnih 3 kilograma manje </p>--}}
                        {{--<div style="height: 200px;"></div>--}}
                    {{--</article>--}}
                    {{--<article style="background-color: #ccffc6;">--}}
                        {{--<p> 3 puta više energije, konfigurisanje metabolizma, blokiranje jojo efekta, približno 2 kilograma manje (ukupno 14 kilograma za 1 mesec) </p>--}}
                ...
                {{--<div class="chart_text">--}}
                    ...
                    {{--<p> 4. nedelja </p>--}}
                {{--</div>--}}
                {{--<p style="margin: auto;"><strong> 1. nedelja </strong> Eliminisanje naslaga u crevima, pročišćavanje toksina iz tela, gubljenje preteranog apetita, otprilike 5 kilograma manje </p>--}}
                {{--<p style="margin: auto;"><strong> 2. nedelja </strong> Smanjen osećaj gladi, poboljšani metabolizam, ubrzano sagorevanje kalorija, dodatnih 4 kilograma manje </p>--}}
                {{--<p style="margin: auto;"><strong> 3. nedelja </strong> Automatsko sagorevanje masnog tkiva, niži nivo holesterola i šećera, dodatnih 3 kilograma manje </p>--}}
                {{--<p style="margin: auto;"><strong> 4. nedelja </strong> 3 puta više energije, konfigurisanje metabolizma, blokiranje jojo efekta, približno 2 kilograma manje (ukupno 14 kilograma za 1 mesec) </p>--}}
        ...
        <section class="comments">
            <h2> Komentari </h2>
            <p> Pročitajte komentare na članak "Vreme prekomerne težine je prošlo! Revolucionarno otkriće srpskog stručnjaka... </p>
            <article>
                ...
                <div>
                    ...
                    <p> A neki ljudi misle da se mi, Srbi, ne ističemo širom sveta. Čestitam našem zemljaku </p>
                </div>
            </article>
            <article>
                <img alt src="{{ asset('/') }}natureteaFiles/slimonex_adv/avatar.png" style="width: 41px; height: 41px;">
            ...
            <article>
                ...
                <div>
                    ...
                    <p> Danas svi imamo telo puno toksina. Nije ni čudo što je svaka druga osoba gojazna. Dobro je što postoji metoda koja čisti telo i sagoreva masti </p>
                </div>
            </article>
            <article>
                <img alt src="{{ asset('/') }}natureteaFiles/slimonex_adv/avatar.png" style="width: 41px; height: 41px;">
                <div>
                    ...
                    <p> Imam pitanje: šta ste koristili? Da li ovde postoji neko ko pati od prekomerne težine od detinjstva (ne iz drugih razloga, poput trudnoće, lekova, već od detinjstva) i smršao je ovom metodom? </p>
                </div>
            </article>
            <article>
                <img alt src="{{ asset('/') }}natureteaFiles/slimonex_adv/avatar.png" style="width: 41px; height: 41px;">
            ...
            <article>
                ...
                <div>
                    ...
                    <p> Koristila bih ga sada, ali sumnjam, ne znam da li radi. I već sam puno potrošila na metode koje ne vrede ništa </p>
                </div>
            </article>
            <article>
                <img alt src="{{ asset('/') }}natureteaFiles/slimonex_adv/avatar.png" style="width: 41px; height: 41px;">
                <div>
                    ...
                    <p> AAA!!! Upravo sam pročitala da se ovaj tretman može postići trostrukom garancijom zadovoljstva, tako da nema razloga za brigu. Isprobaću i sama, nadam se da će mi pomoći :) </p>
                </div>
            </article>
            <article>
                <img alt src="{{ asset('/') }}natureteaFiles/slimonex_adv/avatar.png" style="width: 41px; height: 41px;">
            ...
            <article>
                ...
                <div>
                    ...
                    <p> Čekam moju pošiljku! Uskoro ću pisati o efektima </p>
                </div>
            </article>
        </section>
    </div>
