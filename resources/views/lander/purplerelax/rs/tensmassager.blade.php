...
<head>
    ...
    <style>
        .b1 {
            padding: 0 0 10px;
            background: #f8faf5 url({{ asset('/') }}purplerelaxFiles/tensmassager/offer.jpg) no-repeat center 139px;
            position: relative;
        }
        .use li:nth-child(1) {
            background: #fff url({{ asset('/') }}purplerelaxFiles/tensmassager/use1.jpg) no-repeat 0 -5px;
            padding: 30px 0px 30px 240px;
        }

        .use li:nth-child(2) {
            background: #fff url({{ asset('/') }}purplerelaxFiles/tensmassager/use2.jpg) no-repeat right -10px;
            padding: 15px 240px 13px 0;
        }

        .use li:nth-child(3) {
            background: #fff url({{ asset('/') }}purplerelaxFiles/tensmassager/use3.jpg) no-repeat 0 0;
            padding: 30px 0px 21px 240px;
        }

        .use li:nth-child(4) {
            background: #fff url({{ asset('/') }}purplerelaxFiles/tensmassager/use4.jpg) no-repeat right -10px;
...
<div class="wrap">
    ...
    <section class="b1">
        <h1> TENS <span>MASSAGER</span></h1>
        <h2 class="gradient">IMPULSNI ELEKTRO MASAŽER <br> ZA CELO TELO</h2>
    ...
    <section class="b2">
        ...
        <img src="{{ asset('/') }}purplerelaxFiles/tensmassager/b2.jpg" alt>
        <p>Tens Massager je inteligentni vibracioni masažer koji deluje električnim impulsima poboljšavajući mikrocirkulaciju krvi.
        ...
        <p>Tens Massager <b>brzo ublažava napetost, bol i umor, kod kuće, u kancelariji ili na putovanju.</b> Istovremeno, dobićete prijatnu, duboku i opuštajuću masažu,
    ...
    <section class="b3 gradient">
        ...
        <div class="best__item">
            <img src="{{ asset('/') }}purplerelaxFiles/tensmassager/best1.jpg" alt>
            <p><b>8 REŽIMA MASAŽE RAZLIČITOG INTENZITETA</b>
                Omogućavaju vam da prilagodite udoban režim masaže, pogodan za svaku priliku
            </p>
        </div>
        <div class="best__item">
            <img src="{{ asset('/') }}purplerelaxFiles/tensmassager/best2.jpg" alt>
            <p><b>DUBINSKO PRODIRANJE U MIŠIĆE</b>
                Električni impulsi duboko prodiru u mišiće i u potpunosti ih pokreću
            </p>
        </div>
        <div class="best__item">
            <img src="{{ asset('/') }}purplerelaxFiles/tensmassager/best3.jpg" alt>
            <p><b>UNIVERZALNI NASTAVCI</b>
                Za masažu bilo kog dela tela: ramena, leđa, noge, ruke
            </p>
        </div>
        <div class="best__item">
            <img src="{{ asset('/') }}purplerelaxFiles/tensmassager/best4.jpg" alt>
    ...
    <section class="b4">
        <h2 class="title"><span>Kome treba</span><br> Tens Massager?</h2>
        <p>Zahvaljujući svojoj svestranosti, Tens Massager preporučuje se svima ali je posebno koristan za sledeće kategorije ljudi:</p>
        <div class="body">
    ...
    <section class="b5 gradient">
        ...
        <img src="{{ asset('/') }}purplerelaxFiles/tensmassager/body_grad.jpg" alt>
    ...
    <section class="b6">
        ...
        <ul class="use">
            ...
            <li><span>3</span> Povežite elektrode <br> na neki deo tela i <br> uživajte u masaži</li>
            <li><span>4</span> Možete da odaberete režim rada <br> koji vam odgovara</li>
        </ul>
        <a href="#order_form" class="btn">PORUČITE MASAŽER</a>
    </section>
    <section class="b7">
        <h2 class="title"><span>SPECIFIKACIJA</span> PROIZVODA</h2>
        <img src="{{ asset('/') }}purplerelaxFiles/tensmassager/char.jpg" alt>
        <ul class="char">
            <li><b> Tens Massager </b> <span> 1 komad</span></li>
            <li><b> Elektrode </b> <span> 2 komada</span></li>
            <li><b> Uputstvo </b> <span> 1 komad</span></li>
            <li><b> Način masaže </b> <span> 8 režima</span></li>
            <li><b> Automatsko isključivanje </b> <span> DA</span></li>
        </ul>
        <a href="#order_form" class="btn">PORUČITE ODMAH</a>
    </section>
    <section class="b8 gradient">
        ...
        <div class="reviews__item">
            <img src="{{ asset('/') }}purplerelaxFiles/tensmassager/rev1.jpg" alt>
            <p><b>Vrat me je dugo boleo, ponekad bolovi nisu ni prestajali.</b>
                ...
                Prijatelji su mi preporučili kupovinu Tens Massagera. Koristim ga više od mesec dana,
        ...
        <div class="reviews__item">
            <img src="{{ asset('/') }}purplerelaxFiles/tensmassager/rev2.jpg" alt>
            <p>Pulsni masažer je jeftin, a donosi mnogo zadovoljstva i koristi! Patio sam od bolova u leđima,
