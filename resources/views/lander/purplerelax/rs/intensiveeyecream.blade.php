...
<head>
    ...
    <style>
        ...
        .home {
            background: url("{{ asset('/') }}purplerelaxFiles/intensiveeyecream/home__bg.jpg") center top no-repeat;
        }
        .info-1 {
            background: url("{{ asset('/') }}purplerelaxFiles/intensiveeyecream/info__1--bg.jpg") center top no-repeat;
        }
        .recall {
            background: url("{{ asset('/') }}purplerelaxFiles/intensiveeyecream/recall__bg.jpg") center top no-repeat;
        }
...
<div class="wrapper">
    ...
    <section class="home">
        <div class="container">
            <h1 class="home__title">INTENSIVE EYE CREAM</h1>
            ...
            <div class="home__images">
                <img src="{{ asset('/') }}purplerelaxFiles/intensiveeyecream/product.png" alt="" />
    ...
    <section class="section info-2">
        <div class="container">
            <div class="info-2__description">
                <h3 class="title"><span class="title__theme-primary">Krema premijum klase </span> INTENSIVE EYE CREAM</h3>
                <div class="row column--tb">
                    <div class="info-2__text">
                        <p>
                            Otkrijte blistavu tajnu besprekornog tena - naša inovativna krema za regiju ispod očiju!
                            Ova luksuzna krema obogaćena prirodnim sastojcima i moćnim antioksidantima, ciljano se bori protiv tamnih krugova, oteklina i sitnih bora,
                        ...
                        <p>
                            ...
                            naša inovativna krema je pravi izbor za vas. Pomladite i revitalizujte područje ispod očiju sa zlatnim dodirima luksuza.
                            Počnite da vidite rezultate već nakon prvog tretmana!
                        </p>
                    </div>
                    <div class="video_block">
                        <img src="{{ asset('/') }}purplerelaxFiles/intensiveeyecream/tovar.jpg" />
                    </div>
                </div>
            </div>
    ...
    <section class="section info-3">
        <div class="container">
            <h2 class="title-to">
                INTENSIVE EYE CREAM je koncentrovani kremasti serum intenzivne formule i niske molekularne težine, što znači da deluje brzo i svrsishodno.
            ...
            <div class="info-3__product">
                ...
                <img src="{{ asset('/') }}purplerelaxFiles/intensiveeyecream/info-3__product.png" alt="" />
    ...
    <section class="section info-4">
        <div class="container">
            <h2 class="title"><span class="title__theme-primary">Prednosti </span> INTENSIVE EYE CREAM proizvoda</h2>
            <ul class="column__x3 info-4__list text-center">
                <li>
                    <img src="{{ asset('/') }}purplegraceFiles/goldeneyemask/info-4__icon_1.png" alt="" />
                    <p>Naša inovativna krema za regiju ispod očiju pruža luksuzno spa iskustvo u udobnosti vašeg doma.
                ...
                <li>
                    <img src="{{ asset('/') }}purplegraceFiles/goldeneyemask/info-4__icon_1.png" alt="" />
                    <p>INTENSIVE EYE CREAM je dizajnirana da pruži vidljive rezultate već nakon prvog tretmana.
                        Redovnom upotrebom, možete postići dugotrajne rezultate i stalno održavati svjež i mladalački izgled.</p>
                </li>
                <li>
                    <img src="{{ asset('/') }}purplegraceFiles/goldeneyemask/info-4__icon_1.png" alt="" />

                    <p>Bez obzira na tip vaše kože, naša inovativna krema je pogodna za sve.
    ...
    <section class="section expert">
        <div class="container">
            ...
            <h2 class="title title__theme-white">Sastav INTENSIVE EYE CREAM proizvoda</h2>
            <div class="row column--mb">
                <div class="expert__text">
                    <p>
                        Osnova kreme je hijaluronska kiselina, koja prodire duboko u kožu.
        ...
        <div class="container">
            ...
            <div class="recall__card">
                ...
                <div class="recall__card-item">
                    ...
                    <p>
                        Krema se lako nanosi, ima nežan miris i daje osećaj luksuza koji se retko nalazi kod proizvoda za kućnu upotrebu.
                        Posle uklanjanja kreme, moja koža bude nevjerovatno sveža i hidrirana.
                        ...
                        Izgledam odmornije, svježije i mlađe. Ova inovativna krema je postala nezaobilazan deo moje rutine za njegu kože.
