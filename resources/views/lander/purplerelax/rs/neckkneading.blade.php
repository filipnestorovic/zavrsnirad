...
<style>
    @media (min-width: 768px) {
        .section-1 {
            background: url({{ asset('/') }}purplerelaxFiles/neckkneading/leptirBaner_dt.png) bottom right 47%/cover no-repeat
        }
    }
    ...
    @media (max-width: 767px) {
        .common-block .item-1 {
            ...
            text-align: center;
            background: url({{ asset('/') }}purplerelaxFiles/neckkneading/leptir4_mb.png) bottom center/cover no-repeat
        }
        ...
        .block-1 .item-1 {
            ...
            padding: 30px 15px 80%;
            text-align: center;
            background: url({{ asset('/') }}purplerelaxFiles/neckkneading/leptirBaner_mb.png) bottom center/100% no-repeat
        }
    }

    @media (min-width: 768px) {
        .section-9 {
            background: url({{ asset('/') }}purplerelaxFiles/neckkneading/leptir4_dt.png) center right 47%/cover no-repeat
        }
    }
                            ...
                            <div class="w_content_wrap">
                                <div class="w_desc">
                                    <ul>
                                        ...
                                        <li>Dubinski pokreće mišiće, pospešuje cirkulaciju i čini celo telo opuštenijim
                                            i fleksibilnijim.
                                        </li>
                                        <li>Samo nekoliko minuta korišćenja dnevno pokrenuće vaše mišiće i razbiti
                                            naslage toksina
                                            koji uzrokuju bol u glavi, gubitak energije, pritisak u vratnom delu i
                                            potiljku.
                                        </li>
                                        <li>Podesiva jačina masaže, različite masažne tehnike i smerovi masiranja čine
                                            ovaj masažer preporučljivim svim uzrastima.
                                        </li>
                                    </ul>
            ...
            <div class="block-2 ">
                <div class="w_outer">
                    <div class="w_inner">
                        <div class="w_item ">
                            <div class="w_thumb">
                                <img src="{{ asset('/') }}purplerelaxFiles/neckkneading/leptir1.png" alt="product1"
                                     class="img-view">
                            </div>
                            <div class="w_content_wrap">
                                <div class="w_desc">
                                    ...
                                    <p>Veoma je praktičan i možete ga koristiti u kući, kancelariji ili u automobilu.
                                        Neck Kneading Massager je izrađen od najkvalitetnijih materijala što mu garantuje
                                        dug vek korišćenja.</p>
                                    <ul>
                                        <li>
                                            <strong>
                                                <img style="display: block;"
                                                     src="{{ asset('/') }}purplerelaxFiles/shared_files/icon18.png"
                                                     alt="icon1">
                                                PRIJATNO ZAGREVANJE MIŠIĆA
                                            </strong>
                                            Poseduje grejače koji prijatno zagrevaju regiju koja se masira, i na taj
                                            način dolazi do potpune relaksacije i opuštanja.
                                        </li>
                                        <li>
                                            <strong>
                                                <img style="display: block;"
                                                     src="{{ asset('/') }}purplerelaxFiles/shared_files/icon15.png"
                                                     alt="icon2">
                                                MODERAN DIZAJN
                                            </strong>
                                            Zahvaljujući ergonomskom dizajnu ovaj masažer će savršeno prionuti uz vaša
                                            leđa, vrat i ostale delove tela.
                                        </li>
                                        <li>
                                            <strong>
                                                <img style="display: block;"
                                                     src="{{ asset('/') }}purplerelaxFiles/shared_files/icon16.png"
                                                     alt="icon4">
                                                LAK ZA KORIŠĆENJE
                                            </strong>
                                            Bez komplikovanih tehnologija i kablova, jednostavno ga postavite,
                                            pritisnite dugme i uživanje počinje.
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="ct_image_wrap ">
                <picture>
                    <source media="(max-width: 767px)"
                            srcset="{{ asset('/') }}purplerelaxFiles/neckkneading/leptir2_mb.png" class="no-lazy">
                    <img src="{{ asset('/') }}purplerelaxFiles/neckkneading/leptir2_dt.png" alt="product2"
                         class="no-lazy">
                </picture>
            </div>
        </div> <!--/container-->
            ...
            <div class="block-3 ">
                <div class="w_outer">
                    <div class="w_inner">
                        <div class="w_item ">
                            <div class="w_thumb">
                                <img src="{{ asset('/') }}purplerelaxFiles/neckkneading/leptir3.png" alt="product3"
                                     class="img-view">
                            </div>
                            <div class="w_content_wrap">
                                <div class="w_desc">
                                    <h2 style="text-transform: uppercase;">NE DOZVOLITE DA VAS BOL U VRATU OMETA!</h2>
                                    <p>Zahvaljujući savremenoj tehnologiji masiranja deluje na mišiće vrata, gornjeg i
                                        donjeg dela leđa i dovodi do veoma brzog opuštanja i ubrzane cirkulacije.
                                        Može da se koristi i za ostale delove tela.
                                        Ne postoje starosne granice i ovaj masažer mogu koristiti i deca, kao i bake i
                                        deke.
                                    </p>
                                </div>
                            </div>
    ...
    <section class="section-6">
        <div class="container">
            <div class="wysiwyg-content block-4 ">
                ...
                <p style="text-align: center;">"Zaboravio sam na na osećaj ukočenosti u leđima i pritiska u vratu od
                    kako koristim Neck Kneading masažer.
                    Sve preporuke!"</p>
                            ...
                            <div class="w_content_wrap">
                                ...
                                <div class="w_desc">
                                    <p><span class="star" style="color: #993300;">Star</span><i class="icon-star"></i><i
                                            class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i
                                            class="icon-star"></i></p>
                                    <p>"Od kako sam kupio ovaj masažer, nemam više neprijatan bol u glavi koji mi je bio
                                        noćna mora.
                                        Nakon 5-6 dana korišćenja potpuno je iščezao. Neizmerno sam zahvalan
                                        prodavcima."</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="w_content_wrap">
                                ...
                                <div class="w_desc">
                                    <p><span class="star" style="color: #993300;">Star</span><i class="icon-star"></i><i
                                            class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i
                                            class="icon-star"></i></p>
                                    <p>"Nakon napornog dana na poslu, sedenja i vožnje automobilom, Neck Kneading Massager
                                        mi dođe kao nešto najlepše pred spavanje.
