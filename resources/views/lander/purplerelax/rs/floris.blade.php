...
<head>
    ...
    <style>
        ...
        .no-webp .description {
            min-height: 700px;
            padding: 80px 0;
            background-image: url('{{ asset('/') }}purplerelaxFiles/floris/bg-descr.jpg');
        ...
        .no-webp .header .wrapper {
            color: #333;
            background-image: url('{{ asset('/') }}purplerelaxFiles/floris/bg-header-girl.png');
...
<header class="header block first-header">
    <div class="wrapper">
        ...
        <div class="row">
            ...
            <div class="prod">
                <img src="{{ asset('/') }}purplerelaxFiles/floris/products-top.png" alt="img">
            </div>
            <!-- <div id="cloneThis"> -->
...
<section class="gif block">
    <div class="wrapper">
        <img src="{{ asset('/') }}purplerelaxFiles/floris/1.jpg">
        <img src="{{ asset('/') }}purplerelaxFiles/floris/2.jpg">
        <img src="{{ asset('/') }}purplerelaxFiles/floris/3.jpg">
    </div>
</section>
<section class="description block">
    <div class="wrapper">
        <h2>ZA KOŽU KOJA ZRAČI <span>MLADOŠĆU I SVEŽINOM</span></h2>
        <p class="descr-p center">FLORIS - nije obična četka za čišćenje kože lica, to je nešto više. Rezultat njene upotrebe ne samo da ćete primetiti vi, nego i ljudi oko vas.
        ...
        <div class="row">
            <div class="descr-left">
                ...
                <p>FLORIS nežno odstranjuje mrtve ćelije, čisti začepljene pore i uklanja do</p>
...
<section class="block5 block">
    <div class="wrapper">
        <img src="{{ asset('/') }}purplerelaxFiles/floris/product.jpg" alt="img" class="block5__img" loading="lazy">
        <div class="block5-left">
            ...
            <p>Zahaljujući intenzivnoj T-Sonic™ tehnologiji, nove FLORIS četke za čišćenje kože uklanjaju mrtve ćelije i ostatke šminke dvostruko efikasnije
...
<section class="block7 block">
    <div class="block7__wrapper">
        ...
        <img class="img-bg" src="{{ asset('/') }}purplerelaxFiles/floris/bg-feature.png" alt="img" loading="lazy">
    </div>
</section>
<section class="block8 block">
    <div class="wrapper">
        ...
        <ul>
            <li>
                <img src="{{ asset('/') }}purplerelaxFiles/floris/w1.jpg" alt="img" loading="lazy">
                <h4><span>01.</span> Primena prizvoda za čišćenje kože</h4>
                <p>Nanesite proizvod za čišćenje kože koji vam odgovara. Navlažite FLORIS četku i aktivirajte režim čišćenja.</p>
            </li>
            <li>
                <img src="{{ asset('/') }}purplerelaxFiles/floris/w2.jpg" alt="img" loading="lazy">
                <h4><span>02.</span> Čišćenje</h4>
                <p>Jedan minut pomerajte četkicu FLORIS po površini kože nežno i kružno.</p>
            </li>
            <li>
                <img src="{{ asset('/') }}purplerelaxFiles/floris/w3.jpg" alt="img" loading="lazy">
            ...
            <li>
                <img src="{{ asset('/') }}purplerelaxFiles/floris/w4.jpg" alt="img" loading="lazy">
...
<section class="block9 block">
    <div class="wrapper">
        <h3 class="descr-h3 center">BEAUTY BLOGERKE KOJE VOLE FLORIS?</h3>
        <div class="bloger">
            <div class="bloger-left">
                <img src="{{ asset('/') }}purplerelaxFiles/floris/bloger.jpg" alt="img" loading="lazy">
            </div>
...
<section class="block10 block">
    <div class="wrapper">
        ...
        <ul>
            <li><
                <img src="{{ asset('/') }}purplerelaxFiles/floris/r1.jpg" alt="img" loading="lazy">
            </li>
            <!--
               -->
            <li>
                <img src="{{ asset('/') }}purplerelaxFiles/floris/r2.jpg" alt="img" loading="lazy">
            </li>
            <!--
               -->
            <li>
                <img src="{{ asset('/') }}purplerelaxFiles/floris/r3.jpg" alt="img" loading="lazy">
            </li>
            <!--
               -->
            <li>
                <img src="{{ asset('/') }}purplerelaxFiles/floris/r4.jpg" alt="img" loading="lazy">
            </li>
        </ul>
    </div>
</section>
<section class="block11 block">
    <div class="wrapper">
        <h3 class="descr-h3 center">FLORIS OCENE I UTISCI</h3>
        ...
        <div class="row">
            ...
            <div class="right">
                ...
                <p>Konačno sam se rešila mitesera na nosu.
                    Hvala FLORIS. Tako mi je drago što sam kupila ovaj proizvod i nisam bacila novac. Svi moji prijatelji su već primetili poboljšanje i veoma sam
        ...
        <div class="row">
            ...
            <div class="right">
                ...
                <p>Imala sam toliko problema sa kožom, često su mi se pojavljivali ekcemi. Mesecima sam čitala recenzije na internetu, proučavala razne proizvode i na kraju sam se
                    odlučila za FLORIS četkicu. Kreirana je posebno za osetljivu kožu i izuzetno je mekana, što je izdvaja od ostalih četkica koje mi za razliku od nje nisu odgovarale.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="header block">
    <div class="wrapper">
        ...
        <div class="row">
            ...
            <div class="prod">
                <img src="{{ asset('/') }}purplerelaxFiles/floris/products-top.png" alt="img" loading="lazy">
            </div>
            <div class="sale-form">
                <div class="sale-position">
                    <span class="sale-descr">SPECIJALNA<br>PONUDA</span>
