...
<head>
    ...
    <style>@font-face{font-family:'Montserrat';src:url('{{ asset('/') }}fonts/Montserrat-Light.woff2') format('woff2'),url('{{ asset('/') }}fonts/Montserrat-Light.woff') format('woff'),url('{{ asset('/') }}fonts/Montserrat-Light.ttf') format('truetype');font-weight:300;font-style:normal}@font-face{font-family:'Montserrat';src:url('{{ asset('/') }}fonts/Montserrat-Regular.woff2') format('woff2'),url('{{ asset('/') }}fonts/Montserrat-Regular.woff') format('woff'),url('{{ asset('/') }}fonts/Montserrat-Regular.ttf') format('truetype');font-weight:400;font-style:normal}@font-face{font-family:'Montserrat';src:url('{{ asset('/') }}fonts/Montserrat-Italic.woff2') format('woff2'),url('{{ asset('/') }}fonts/Montserrat-Italic.woff') format('woff'),url('{{ asset('/') }}fonts/Montserrat-Italic.ttf') format('truetype');font-weight:400;font-style:italic}@font-face{font-family:'Montserrat';src:url('{{ asset('/') }}fonts/Montserrat-Medium.woff2') format('woff2'),url('{{ asset('/') }}fonts/Montserrat-Medium.woff') format('woff'),url('{{ asset('/') }}fonts/Montserrat-Medium.ttf') format('truetype');font-weight:500;font-style:normal}@font-face{font-family:'Montserrat';src:url('{{ asset('/') }}fonts/Montserrat-Bold.woff2') format('woff2'),url('{{ asset('/') }}fonts/Montserrat-Bold.woff') format('woff'),url('{{ asset('/') }}fonts/Montserrat-Bold.ttf') format('truetype');font-weight:700;font-style:normal}@font-face{font-family:'Montserrat';src:url('{{ asset('/') }}fonts/Montserrat-Black.woff2') format('woff2'),url('{{ asset('/') }}fonts/Montserrat-Black.woff') format('woff'),url('{{ asset('/') }}fonts/Montserrat-Black.ttf') format('truetype');font-weight:900;font-style:normal}@font-face{font-family:'Museo Sans';src:url('{{ asset('/') }}fonts/subset-MuseoSansCyrl-300.woff2') format('woff2'),url('{{ asset('/') }}fonts/subset-MuseoSansCyrl-300.woff') format('woff'),url('{{ asset('/') }}fonts/subset-MuseoSansCyrl-300.ttf') format('truetype');font-weight:400;font-style:normal}@font-face{font-family:'Museo Sans';src:url('{{ asset('/') }}fonts/subset-MuseoSansCyrl-500.woff2') format('woff2'),url('{{ asset('/') }}fonts/subset-MuseoSansCyrl-500.woff') format('woff'),url('{{ asset('/') }}fonts/subset-MuseoSansCyrl-500.ttf') format('truetype');font-weight:500;font-style:normal}@font-face{font-family:'Museo Sans';src:url('{{ asset('/') }}fonts/subset-MuseoSansCyrl-700.woff2') format('woff2'),url('{{ asset('/') }}fonts/subset-MuseoSansCyrl-700.woff') format('woff'),url('{{ asset('/') }}fonts/subset-MuseoSansCyrl-700.ttf') format('truetype');font-weight:700;font-style:normal}@font-face{font-family:'Museo Sans';src:url('{{ asset('/') }}fonts/subset-MuseoSansCyrl-900.woff2') format('woff2'),url('{{ asset('/') }}fonts/subset-MuseoSansCyrl-900.woff') format('woff'),url('{{ asset('/') }}fonts/subset-MuseoSansCyrl-900.ttf') format('truetype');font-weight:900;font-style:normal}</style>
</head>
<body>
<div class="main_wrapper">
    ...
    <section class="offer_section">
        <div class="box">
            <h1 class="main_title">24K <span>GOLD SKIN</span></h1>
            <h2 class="main_subtitle">ZA MLADOLIKU I SJAJNU KOŽU</h2>
            <div class="sale">popust <span>-40%</span></div>
            <div class="offer_content">
                <p class="desc">
                    DUBOKO PRODIRE, ZATEŽE I HIDRIRA
                </p>
                <ul class="list1">
                    <li>Hrani kožu vitaminima</li>
                    <li>Povećava elastičnost kože i daje joj energiju</li>
                    <li>Daje koži mladalački sjaj</li>
                </ul>
                <div class="bef_aftr">
    ...
    <section class="sect2 dark_bg">
        <h2 class="title">24K GOLD SKIN <span>će pomoći u nezi kože koja stari</span></h2>
        <ul class="benef1 check">
            ...
            <li>
                ...
                <p>Štiti od spoljašnih faktora</p>
            </li>
        </ul>
        <a href="#order_form" class="button-m">Poručite sada</a>
        <!-- <img src="{{ asset('/') }}purplerelaxFiles/24kgoldskin/s2_img.jpg" class="p_ignore" alt=""> -->
    </section>
    <section class="sect3">
        <h2 class="title"><span>Zašto hiljade žena bira 24K GOLDSKIN?</span></h2>
        <p><b>Da imate negovanu i hidriranu kožu!</b></p>
        <p>24K Goldskin je serum koji je zasićen 24 karatnim zlatom, mnogim esencijalnim vitaminima i korisnim elementima.</p>

        <img src="{{ asset('/') }}purplerelaxFiles/24kgoldskin/3.gif" alt=""/>

        <p>24k Goldskin ima kompleksan efekat na zrelu kožu. <b>U najkraćem roku je podmlađuje, čini elastičnom i nežnom.</b></p>
    ...
    <section class="sect5 rev_sect color_bg">
        <div class="rev_block">
            <h2 class="title">
                Utisci kupaca <span>koji su već koristili <br/> 24k Goldskin</span>
            </h2>
            <div class="reviews owl-carousel">
                <div class="rev_item">
                    <img src="{{ asset('/') }}purplerelaxFiles/24kgoldskin/rev1.jpg" alt=""/>
                    <span>Zamenila sam sve proizvoda za negu lica sa ovim proizvodom!</span>
                    <p>
                        Koristim ovo ulje više od mesec dana i mažem lice njime svako veče. Efekat je odličan.
                        Nakon 10 dana upotrebe videli su se prvi rezultati. Bore oko očiju su počele da mi nestaju, a bore oko usta su bile manje izražene.
                        Brdo novca sam bacila na kojekakve proizvode, ali mi je jedino ovaj pomogao. Sve preporuke!
                    </p>
                    <div class="info">
                ...
                <div class="rev_item">
                    ...
                    <p>
                        ...
                        ali je rezultat korišćenja 24K Goldskin proizvoda nadmašio sva moja očekivanja. Posne 2 nedelje korišćenja, mogu samo da kažem - WOW!!!
                    </p>
                    <div class="info">
                ...
                <div class="rev_item">
                    ...
                    <p>
                        Po savetu kozmetičarke, kupila sam ovo ulje i moram da vam priznam da sam prezadovoljna. Suvu i "mlohavu" kožu zamenila je sveža i zategnuta.
                        Iznenadila sam se koliko brzo i efikasno ovo ulje deluje. Čudo je napravilo. Definitivno ne žalim ni jedan dinar koji sam dala na ovo, a uopšte nije bilo skupo.
                    </p>
                    <div class="info">
