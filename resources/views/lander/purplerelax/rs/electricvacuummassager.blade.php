...
<head>
    ...
    <style>
        .b1 {
            padding: 0 0 10px;
            background: #f8faf5 url({{ asset('/') }}purplerelaxFiles/electricvacuummassager/offer.jpg) no-repeat center 139px;
            position: relative;
        }
        .use li:nth-child(1) {
            background: #fff url({{ asset('/') }}purplerelaxFiles/electricvacuummassager/use1.jpg) no-repeat 0 -5px;
            padding: 30px 0px 30px 240px;
        }

        .use li:nth-child(2) {
            background: #fff url({{ asset('/') }}purplerelaxFiles/electricvacuummassager/use2.jpg) no-repeat right -10px;
...
<div class="wrap">
    ...
    <section class="b1">
        ...
        <h2 class="gradient">ELECTRIC VACUUM MASSAGER</h2>
    ...
    <section class="b2">
        ...
        <img src="{{ asset('/') }}purplerelaxFiles/electricvacuummassager/b2.jpg" alt>
        <p>Electric Vacuum Massager služi za masažu, hidžamu i razbijanje i izvlačenje celulita.
    ...
    <section class="b3 gradient">
        ...
        <div class="best__item">
            ...
            <p><b>Electric Vacuum Massager zagreva kožu i vakumski izvlači toksine. Toksini koji se talože ispod kože i stvaraju pritisak i bolove u leđima.</b>
            </p>
        </div>
        <div class="best__item">
    ...
    <section class="b4">
        <h2 class="title"><span>Kome treba</span><br> Electric Vacuum Massager?</h2>
        <p>Zahvaljujući svojoj svestranosti, Electric Vacuum Massager preporučuje se svima ali je posebno koristan za sledeće kategorije ljudi:</p>
        <div class="body">
    ...
    <section class="b5 gradient">
        <h2 class="title">Uživajte u detoksikaciji bilo kog dela tela na veoma jednostavan način</h2>
        <img src="{{ asset('/') }}purplerelaxFiles/electricvacuummassager/body_grad.jpg" alt>
        <p>Electric Vacuum Massager ima <b>6 vakumskih nastavaka</b> na kojima se mogu podešavati različiti nivoi usisnog pritiska.</p>
    </section>
    <section class="b6">
    ...
    <section class="b7">
        ...
        <img src="{{ asset('/') }}purplerelaxFiles/electricvacuummassager/char.jpg" alt>

        <a href="#order_form" class="btn">PORUČITE ODMAH</a>
    </section>
    <section class="b8 gradient">
        <h2 class="title">Utisci kupaca <br> kojima je <br> Electric Vacuum Massager pomogao</h2>
        <div class="reviews__item">
            <img src="{{ asset('/') }}purplerelaxFiles/electricvacuummassager/rev1.jpg" alt>
