...
<style>
    @media (min-width:768px) {
        .section-1 {
            background: url({{ asset('/') }}purplerelaxFiles/2u1cetka/cetkaBaner_dt.png) bottom right 47%/cover no-repeat
        }
    }
    @media (max-width:767px) {
        .common-block .item-1 {
            ...
            text-align: center;
            background: url({{ asset('/') }}purplerelaxFiles/2u1cetka/cetka4_mb.png) bottom center/cover no-repeat
        }
        .block-1 .item-1 {
            margin: 0 -15px 20px;
            padding: 30px 15px 80%;
            text-align: center;
            background: url({{ asset('/') }}purplerelaxFiles/2u1cetka/cetkaBaner_mb.png) bottom center/100% no-repeat
        }
    }
    @media (min-width:768px) {
        .section-9 {
            background: url({{ asset('/') }}purplerelaxFiles/2u1cetka/cetka4_dt.png) center right 47%/cover no-repeat
        }
    }
    @media (max-width:767px) {
        .foot-block .item-1 {
            ...
            <div class="block-2 ">
                <div class="w_outer">
                    <div class="w_inner">
                        <div class="w_item ">
                            <div class="w_thumb">
                                <img src="{{ asset('/') }}purplerelaxFiles/2u1cetka/cetka1.png" alt="product1" class="img-view">
                            </div>
                            <div class="w_content_wrap">
                                <div class="w_desc">
                                    <h2>HIT NA SVETSKOM TRŽIŠTU</h2>
                                    <p>Ništa lepše od svežeg, vitalnog i zategnutog lica! 2 u 1 vibrirajuća četka za čišćenje lica je najnoviji hit na tržištu i jedan od najprodavanijih proizvoda.
    ...
    <section class="section-4">
        <div class="container">
            <div class="ct_image_wrap ">
                <picture>
                    <source media="(max-width: 767px)" srcset="{{ asset('/') }}purplerelaxFiles/2u1cetka/cetka2_mb.png" class="no-lazy">
                    <img src="{{ asset('/') }}purplerelaxFiles/2u1cetka/cetka2_dt.png" alt="product2" class="no-lazy">
                </picture>
            </div>
        </div> <!--/container-->
    </section> <!-- /row-wrapper-->
            ...
            <div class="block-3 ">
                <div class="w_outer">
                    <div class="w_inner">
                        <div class="w_item ">
                            <div class="w_thumb">
                                <img src="{{ asset('/') }}purplerelaxFiles/2u1cetka/cetka3.png" alt="product3" class="img-view">
                            </div>
                            <div class="w_content_wrap">
                                <div class="w_desc">
                                    <h2 style="text-transform: uppercase;">DO ZATEGNUTE KOŽE NA PRIRODAN NAČIN!</h2>
                                    <p>Za razliku od većine kozmetike, 2 u 1 vibrirajuća četka je 100% prirodan način za podmlađivanje i regeneraciju vaše kože.
                    ...
                    <div class="w_inner">
                        ...
                        <div class="w_item ">
                            <div class="w_content_wrap">
                                ...
                                <div class="w_desc">
                                    <p><span class="star" style="color: #993300;">Star</span><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i></p>
                                    <p>"Nakon napornog dana na poslu, totalno se opustim pod tušem masirajući lice 2 u 1 četkom. Relaksacija kao na skupom tretmanu."</p>
                                </div>
                            </div>
                        </div>
                    </div>
