...
<head>
    ...
    <style>
        ...
        .home {
            background: url("{{ asset('/') }}purplerelaxFiles/vitaleye/home__bg.jpg") center top no-repeat;
        }

        .info-1 {
            background: url("{{ asset('/') }}purplerelaxFiles/vitaleye/info__1--bg.jpg") center top no-repeat;
        }

        .recall {
            background: url("{{ asset('/') }}purplerelaxFiles/vitaleye/recall__bg.jpg") center top no-repeat;
        }

        @media (max-width: 639px) {
            .home {
                background: url("{{ asset('/') }}purplegraceFiles/goldeneyemask/home__bg-mobile.jpg") center top no-repeat;
...
<div class="wrapper">
    ...
    <section class="home">
        <div class="container">
            <h1 class="home__title">VITAL EYE</h1>
            ...
            <div class="home__images">
                <img src="{{ asset('/') }}purplerelaxFiles/vitaleye/product.png" alt=""/>
            ...
            <div class="order">
                ...
                <div class="prod-count">
                    <img class="prod-count__item"
                         src="{{ asset('/') }}purplegraceFiles/goldeneyemask/prod-count__icon.png" alt=""/>
    ...
    <section class="section info-1">
        <div class="container">
            ...
            <ul class="column__x3 text-center">
                <li>
                    <div class="info-1__list-images"><img class="circle"
                                                          src="{{ asset('/') }}purplegraceFiles/goldeneyemask/info__1--list_1.jpg"
                                                          alt=""/></div>
                    Zateže kožu i usporava starenje
                </li>
                <li>
                    <div class="info-1__list-images"><img class="circle"
                                                          src="{{ asset('/') }}purplegraceFiles/goldeneyemask/info__1--list_2.jpg"
                                                          alt=""/></div>
                    Uklanja bore i zaglađuje kožu
                </li>
                <li>
                    <div class="info-1__list-images"><img class="circle"
                                                          src="{{ asset('/') }}purplegraceFiles/goldeneyemask/info__1--list_3.jpg"
                                                          alt=""/></div>
                    Peptidna maska obnavlja i eksfolira kožu
                </li>
            </ul>
        </div>
    </section>
    ...
    <section class="section info-2">
        <div class="container">
            <div class="info-2__description">
                <h3 class="title"><span class="title__theme-primary">Maska premium klase </span> VITAL EYE</h3>
                <div class="row column--tb">
                    <div class="info-2__text">
                        <p>
                            Otkrijte blistavu tajnu besprekornog tena - naša inovativna formula za regiju ispod očiju!
                            Ova luksuzna maska obogaćena prirodnim sastojcima i moćnim antioksidantima, ciljano se bori
                            protiv tamnih krugova, oteklina i sitnih bora, ostavljajući vašu kožu osveženom i podmlađenom.
                        </p>
                        <p>
                            Ukoliko sanjate o svežem i blistavom pogledu bez obzira na vremenske uslove i napore
                            svakodnevice,
                            naša inovativna maska je pravi izbor za vas. Pomladite i revitalizujte područje ispod očiju
                            sa zlatnim dodirima luksuza. Počnite da vidite rezultate već nakon prvog tretmana!
                        </p>
                    </div>
                    <div class="video_block">
                        <img src="{{ asset('/') }}purplerelaxFiles/vitaleye/tovar.png"/>
                    </div>
                </div>
            </div>
            <div class="info-2__images row column--tb">
                <div class="info-2__images-item"><img
                        src="{{ asset('/') }}purplegraceFiles/goldeneyemask/info__2--images_1.jpg" alt=""/></div>
                <div class="info-2__images-item"><img
                        src="{{ asset('/') }}purplegraceFiles/goldeneyemask/info__2--images_2.jpg" alt=""/></div>
                <div class="info-2__images-item"><img
                        src="{{ asset('/') }}purplegraceFiles/goldeneyemask/info__2--images_3.jpg" alt=""/></div>
            </div>
            <a href="#order_form" class="btn">Poručite sada</a>
        </div>
    </section>
    ...
    <section class="section info-3">
        <div class="container">
            <h2 class="title-to">
                VITAL EYE je koncentrovani kremasta maska intenzivne formule i niske molekularne težine, što znači da
                deluje brzo i svrsishodno. Maska sprečava pojavu novih bora i bori se protiv postojećih.
            </h2>
            <div class="info-3__product">
                <img class="circle info-3__product-instruction"
                     src="{{ asset('/') }}purplegraceFiles/goldeneyemask/info-3__instruction.jpg" alt=""/>
                <img src="{{ asset('/') }}purplerelaxFiles/vitaleye/info-3__product.png" alt=""/>
                <ul class="info-3__list">
                    <li class="info-3__list-item--left"><img class="circle"
                                                             src="{{ asset('/') }}purplegraceFiles/goldeneyemask/1.jpg"
                                                             alt=""/></li>
                    <li class="info-3__list-item--right"><img class="circle"
                                                              src="{{ asset('/') }}purplegraceFiles/goldeneyemask/2.jpg"
                                                              alt=""/></li>
                    <li class="info-3__list-item--left"><img class="circle"
                                                             src="{{ asset('/') }}purplegraceFiles/goldeneyemask/3.jpg"
                                                             alt=""/></li>
                    <li class="info-3__list-item--right"><img class="circle"
                                                              src="{{ asset('/') }}purplegraceFiles/goldeneyemask/4.jpg"
                                                              alt=""/></li>
                </ul>
            </div>
            <a href="#order_form" class="btn">Poručite sada</a>
    ...
    <section class="section info-4">
        <div class="container">
            <h2 class="title"><span class="title__theme-primary">Prednosti </span> VITAL EYE proizvoda</h2>
            <ul class="column__x3 info-4__list text-center">
                <li>
                    <img src="{{ asset('/') }}purplegraceFiles/goldeneyemask/info-4__icon_1.png" alt=""/>
                    <p>Naša inovativna formula za regiju ispod očiju pruža luksuzno spa iskustvo u udobnosti vašeg doma.
                        Ne morate trošiti vreme i novac na skupe tretmane u salonima - sada možete imati luksuzni
                        tretman kad god vam to odgovara.</p>
                </li>
                <li>
                    <img src="{{ asset('/') }}purplegraceFiles/goldeneyemask/info-4__icon_1.png" alt=""/>
                    <p>VITAL EYE je dizajnirana da pruži vidljive rezultate već nakon prvog tretmana.
                        Redovnom upotrebom, možete postići dugotrajne rezultate i stalno održavati svež i mladalački
                        izgled.</p>
                </li>
                <li>
                    <img src="{{ asset('/') }}purplegraceFiles/goldeneyemask/info-4__icon_1.png" alt=""/>
                    <p>Bez obzira na tip vaše kože, naša inovativna maska je pogodna za sve.
        ...
        <div class="container">
            ...
            <div class="row column--mb">
                <div class="expert__text">
                    <p>
                        Lagana maska sa vitaminima i hijaluronskom kiselinom prodire u duboke slojeve kože i pomaže
                        da se zasiti vlagom,
                        čime se izglađuju fine bore i eliminišu nevidljivi nedostaci koje stvaraju godine.
                    </p>
                </div>
            </div>
            <h2 class="title title__theme-white">Sastav VITAL EYE proizvoda</h2>
            <div class="row column--mb">
                <div class="expert__text">
                    <p>
                        Osnova maske je hijaluronska kiselina, koja prodire duboko u kožu.
                        Sastav takođe uključuje vitamin E - snažan prirodni antioksidans koji vezuje polinezasićene
                        masne kiseline u biološkim membranama
        ...
        <div class="container">
            ...
            <div class="recall__card">
                <div class="recall__card-item">
                    ...
                    <p>
                        Ovo je mnogo bolje od bilo koje maske za lice koju sam koristila.
                        Efekat je fenomenalan, ljudi ja ne mogu da verujem da se ovo desilo.
                        Imala sam bore, sada ih nema. Bez ijednog odlaska u kozmetički salon.
                        Lako se koristi, kutija je zgodna i može da se nosi svuda.
                ...
                <div class="recall__card-item">
                    ...
                    <p>
                        ...
                        Radila sam kao konobarica na moru dugo godina i bila sam izložena suncu, što je proizvelo mnogo
                        bora na mom licu.
                        Pokušala sam sa nekim kozmetičkim tretmanima, ali mi je bilo skupo pa sam odustala.
                        Onda sam naletela na ovo čudo na internetu, uzela sam ga i gle čuda počelo je posle nedelju dana
                        da daje rezultate.
                ...
                <div class="recall__card-item">
                    ...
                    <p>
                        Maska se lako nanosi, ima nežan miris i daje osećaj luksuza koji se retko nalazi kod proizvoda
                        za kućnu upotrebu.
                        Posle uklanjanja maske, moja koža bude neverovatno sveža i hidrirana.
                        Tamni krugovi su znatno smanjeni, a podočnjaci se skoro u potpunosti povukli.
                        Ali ono što me je najviše impresioniralo su dugotrajni rezultati. Redovnom upotrebom, moja koža
                        ispod očiju se drastično popravila.
                        Izgledam odmornije, svežije i mlađe. Ova inovativna formula je postala nezaobilazan deo moje
                        rutine za negu kože.
    ...
    <!-- home-footer -->
    <div class="home__discount">Ne propustite priliku da iskoristite <span
            class="home__discount-item">40% popusta</span></div>
    <section class="home">
        <div class="container">
            <h1 class="home__title">VITAL EYE</h1>
            <div class="home__subtitle">Specijalna formula za podmlađivanje lica</div>
