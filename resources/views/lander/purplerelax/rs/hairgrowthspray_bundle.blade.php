...
<head>
    ...
    <style>
        .form-pack {
            background: url({{ asset('/') }}purplerelaxFiles/hairgrowthspray/pack.png) no-repeat center;
            width: 168px;
            height: 278px;
            position: absolute;
            left: -10px;
        ...
        .block11 .form-pack {
            ...
            height: 341px;
            left: 30px;
            background: url({{ asset('/') }}purplerelaxFiles/hairgrowthspray/pack_solo.png) no-repeat center
        }
...
<div class="overflow">
        ...
        <div class="container">
            <form class="orderForm form desktop" action="{{$orderRoute}}" method="POST">
                ...
                <div class="form__wrapper">
                    ...
                    <div class="form__header">Izaberite količinu i poručite odmah!</div>
                    <div class="form__main">
                        ...
                        <div class="form__element">
                            <div class="input-group tooltip-hide">
                                <select name="quantity" id="quantity1" class="form-input order_data quantity" required>
                        ...
                        <div class="timer">
                            <div class="timer__container">
                                <div class="timer__item">
                                    ...
                                    <div class="form-price price_holder" data-quantity="{{$q}}">
                                    ...
                                    @endforeach
                                    <div class="form-price__new freeShippingHolder" style='font-size: 1.2em; white-space: nowrap; font-weight: bold;'>
                                        + BESPLATNA DOSTAVA
                                    </div>
                                </div>
                            </div>
    ...
    <div class="block3">
        <div class="container">
            <h3 class="block3__heading">KAKO HAIR GROWTH SPRAY FUNKCIONIŠE I ZAŠTO JE <span class="blue">BOLJI OD OSTALIH?</span>
            </h3>
            <ul class="block3-list">
                <li class="block3-list__item">
                    <div class="block3-list__wrap">
                        <div class="block3-list__tx">Hair Growth Spray deluje na ubrzavanje rasta dlake u <span
                                class="blue">područjima sa malom gustoćom</span>
    ...
    <div class="block4">
        <div class="container">
            <h3 class="block4__heading">HAIR GROWTH SPRAY SADRŽI <span class="blue">NAJMOĆNIJE SASTOJKE</span> ZA
                JAČANJE KOSE</h3>
            ...
            <ul class="review-list">
                ...
                <li class="review-list__item">
                    ...
                    <div class="review-list__tx">Nakon 35. godine počele su mi se pojavljivati površine na glavi sa
                        proređenom kosom. Igrom slučaja sam dobila ovaj sprej i odlučila sam da pokušam sa njim.
                        <span class="bold">Nakon 4 meseca korišćenja, moji prijatelji su primetili da mi je kosa bujnija i lepša.</span>
                        Nisam odustala, evo već godinu dana koristim ovaj sprej i nemam nikakvih problema,
            ...
            <div class="block9__wrap">
                ...
                <div class="block9-right">
                    <div class="block9-pack">
                        ...
                        <img src="{{ asset('/') }}purplerelaxFiles/hairgrowthspray/pack_m.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <ul class="block10-list">
                <li class="block10-list__item">
                    <div class="block10-list__img">
                        <img src="{{ asset('/') }}purplerelaxFiles/hairgrowthspray/b10_i1.png" alt="">
                    </div>
    ...
    <div class="block1 block11">
        <div class="container">
            ...
            <form class="orderForm form desktop" action="{{$orderRoute}}" method="POST">
                ...
                <div class="form__wrapper">
                    ...
                    <div class="form__main">
                        ...
                        <div class="form__element">
                            <div class="input-group tooltip-hide">
                                <select name="quantity" id="quantity2" class="form-input order_data quantity" required>
                                    @foreach($prices as $singlePrice)
                                        <option value="{{ $singlePrice['quantity'] }}"
                                                data-free-shipping="{{ $singlePrice['is_free_shipping'] ? 'true' : 'false' }}"
                                                @if($singlePrice['is_default']) selected @endif
                        ...
                        <div class="timer">
                            <div class="timer__container">
                                <div class="timer__item">
                                    ...
                                    @endforeach
                                    <div class="form-price__new freeShippingHolder" style='font-size: 1.2em; white-space: nowrap'>
                                        + BESPLATNA DOSTAVA
                                    </div>
                                </div>
                            </div>
            ...
            <form class="orderForm js-scroll-form form mobile" action="{{$orderRoute}}" method="POST">
                ...
                @include('lander.naturapharm.components.form_hidden_fields')
                <div class="form__wrapper">
                    <div class="form__header">Izaberite koLičinu i poručite sa popustom!</div>
                    <div class="pack-img">
                        <img src="{{ asset('/') }}purplerelaxFiles/hairgrowthspray/pack.png" alt="">
                    </div>
                    @foreach($prices as $q => $singlePrice)
                        <div class="form-price price_holder" data-quantity="{{$q}}">
                            <div class="form-price__old old" style='font-size: 2em; white-space: nowrap'>
                    ...
                    @endforeach
                    <div class="form-price__new freeShippingHolder" style='font-size: 1.2em; white-space: nowrap; text-align: center'>
                        + BESPLATNA DOSTAVA
                    </div>
                    <div class="form__main">
                        <div class="form__element">
                        ...
                        <div class="form__element">
                            <div class="input-group tooltip-hide">
                                <select name="quantity" id="quantity3" class="form-input order_data quantity" style="width: 100%;" required>
                                    @foreach($prices as $singlePrice)
                                        <option value="{{ $singlePrice['quantity'] }}"
                                                data-free-shipping="{{ $singlePrice['is_free_shipping'] ? 'true' : 'false' }}"
                                                @if($singlePrice['is_default']) selected @endif
