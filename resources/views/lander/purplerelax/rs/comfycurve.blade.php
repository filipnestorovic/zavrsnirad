...
<style>
    .section-2 {
        background: url({{ asset('/') }}purplerelaxFiles/comfycurve/jastukBaner_mb.png) top center/cover no-repeat;
        padding: 90% 0 100%
    }
    @media (min-width:768px) {
        .section-2 {
            padding: 30px 0;
            background: url({{ asset('/') }}purplerelaxFiles/comfycurve/jastukBaner_dt.png) top center/cover no-repeat
        }
    }
    .section-8 {
        padding: 15px 0;
        background: url({{ asset('/') }}purplerelaxFiles/comfycurve/jastuk3_mb.png) center center/cover no-repeat
    }
    @media (min-width:768px) {
        .section-8 {
            padding: 50px 0;
            background-image: url({{ asset('/') }}purplerelaxFiles/comfycurve/jastuk3_dt.png);
    ...
    @media (min-width:768px) {
        .section-10 {
            padding: 50px 0;
            background-image: url({{ asset('/') }}purplerelaxFiles/comfycurve/jastuk4_dt.png);
            background-position-x: 35%
        }
    }
    .section-12 {
        background: url({{ asset('/') }}purplerelaxFiles/comfycurve/jastuk5_mb.png) center bottom/cover no-repeat;
        padding: 35px 0 170vw
    }
    @media (min-width:768px) {
        .section-12 {
            padding: 40px 0;
            background: url({{ asset('/') }}purplerelaxFiles/comfycurve/jastuk5_dt.png) right center/cover no-repeat;
                    ...
                    <div class="wrap-inner layt-50-50">
                        <div class="columns col-left">
                            <div class="wrap-col">
                                ...
                                <p>Jastuk koji će Vam pomoći da se budite odmorni!</p>
                            </div>
                        </div>
    ...
    <section class="section-5">
        <div class="container">
            <div class="wysiwyg-content middle-banner ">
                <p>
                    <img src="{{ asset('/') }}purplerelaxFiles/comfycurve/jastuk1_dt.png" alt="thumb1">
                    <img src="{{ asset('/') }}purplerelaxFiles/comfycurve/jastuk1_mb.png" alt="thumb1">
                </p>
            </div>
        </div> <!--/container-->
    </section> <!-- /row-wrapper-->
                    ...
                    <div class="wrap-inner layt-50-50">
                        <div class="columns col-left">
                            <div class="wrap-col">
                                ...
                                <p>Comfy Curve jastuk je savšen u otklanjanju bolova u leđima i vratu koji se javljaju usled dugog sedenja i fizičke nekativnosti.
                        ...
                        <div class="columns col-right">
                            <div class="wrap-col">
                                <p><img src="{{ asset('/') }}purplerelaxFiles/comfycurve/jastuk_gif1.gif" alt="img-1"></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="wrap-inner layt-50-50">
                        <div class="columns col-left">
                            <div class="wrap-col">
                                ...
                                <p>Kada spavate na leđima ili na boku, ne spavate savršeno ravno. Leđa su vam iskrivljena i telo zauzima potpuno nepravilan položaj zbog čega trpe mišići i zglobovi, što uzrokuje bol.
                                    Comfy Curve jastuk najbolji je za one koji traže olakšanje, jer udobno podupire leđa i osigurava pravilno držanje, položaj spavanja i uklanja bolne tačke pritiska.</p>
                            </div>
                        </div>
                        <div class="columns col-right">
                            <div class="wrap-col">
                                <p><img src="{{ asset('/') }}purplerelaxFiles/comfycurve/jastuk_gif2.gif" alt="img-2"></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w_outer">
                    <div class="w_inner">
                        ...
                        <div class="w_item ">
                            ...
                            <div class="w_thumb">
                                <img src="{{ asset('/') }}purplerelaxFiles/comfycurve/jastuk2_dt.png" alt="step3" class="img-view">
                            </div>
                            <div class="w_desc">
                        ...
                        <div class="w_item ">
                            ...
                            <div class="w_desc">
                                <p>Još kao mala imala sam problem sa leđima i od tada povremeno imam bolove usled nepravilnog držanja.
                                    Na nagovor majke kupila sam Comfy Curve jastuk i od kako ga koristim znatno manje problema imam.</p>
                            </div>
                        </div>
                    </div>
                </div>
