...
<header class="header">
    <div class="wrapper">
        <h1 class="header__title">HIGHLIGHT POWDER</h1>
        <div class="sale">
...
<main>
    <section class="sect1">
        <img src="{{ asset('/') }}purplerelaxFiles/highlightpowder/top.png" alt class="sect1__img">
        <div class="txt">
            <div class="txt__text">
    ...
    <section class="sect1_2">
        <div class="wrapper">
            <img src="{{ asset('/') }}purplerelaxFiles/highlightpowder/gif.gif" alt class="gif">
        </div>
    </section>
    <section class="sect2">
        <div class="wrapper">
    ...
    <section class="sect3">
        <img src="{{ asset('/') }}purplerelaxFiles/highlightpowder/middle.png" alt class="sect3__img">
        <div class="sect3__txt">
            <div class="sect3__txt__text">
                HIGHLIGHT POWDER <br/> TO JE ONO <br/> ŠTO VAM TREBA
            </div>
        </div>
        <div class="wrapper">
            <p>
    ...
    <section class="sect5">
        <img src="{{ asset('/') }}purplerelaxFiles/highlightpowder/bottom.png" alt class="sect1__img">
        <div class="txt">
            <div class="txt__text">
                <span class="txt__text-bold">Puder za sjajno i podmlađeno lice</span>
                <br>
