...
<section id="osob">
    ...
    <div class="box-osob">
        <div class="img-toptop">
            <img src="{{ asset('/') }}purplerelaxFiles/multifunctionalcurler/box-1-1.jpg" class="img-my-top">
        </div>
        <div class="img-toptop">
            <div class="main-text">
...
<section class="use_section" id="use_section">
    <div class="wrapper">
        ...
        <div class="use_list">
            ...
            <div class="use_item">
                <img src="{{ asset('/') }}purplerelaxFiles/multifunctionalcurler/use__use2_image.jpg" alt="">
            ...
            <div class="use_item">
                <img src="{{ asset('/') }}purplerelaxFiles/multifunctionalcurler/use__use4_image.jpg" alt="">
                <h4>Eliminiše elektricitet sa kose</h4>
            </div>
            <div class="use_item">
                <img src="{{ asset('/') }}purplerelaxFiles/multifunctionalcurler/use__use5_image.jpg" alt="">
                <h4>Turmalniski sloj grejnih elemenata štiti kosu od oštećenja</h4>
            </div>
            <div class="use_item">
                <img src="{{ asset('/') }}purplerelaxFiles/multifunctionalcurler/use__use6_image.jpg" alt="">
                <h4>Trajaće mnogo godina jer ima kućište visokog kvaliteta i čvrstoće</h4>
            </div>
            <div class="use_item">
                <img src="{{ asset('/') }}purplerelaxFiles/multifunctionalcurler/use__use7_image.jpg" alt="">
                <h4>Jednostavan za korišćenje</h4>
            </div>
            <div class="use_item">
                <img src="{{ asset('/') }}purplerelaxFiles/multifunctionalcurler/use__use8_image.jpg" alt="">
                <h4>Možete sami kontrolisati zagrevanje</h4>
            </div>
            <div class="use_item">
                <img src="{{ asset('/') }}purplerelaxFiles/multifunctionalcurler/use__use9_image.jpg" alt="">
...
<section id="about">
    ...
    <div class="box-osob-2">
        ...
        <div class="img-toptop flex-left">
            <img src="{{ asset('/') }}purplerelaxFiles/multifunctionalcurler/box-32_ver1.jpg" class="img-my-top">
        </div>
    </div>
</section>
<section class="gallery_sect" style="padding-top: 5px;">
    <img src="{{ asset('/') }}purplerelaxFiles/multifunctionalcurler/gallery.jpg" alt="" class="panorama" height="323" width="1968">
</section>
<section>
    ...
    <div class="box-osob">
        <div class="img-toptop">
            <!--left-img-->
            <img src="{{ asset('/') }}purplerelaxFiles/multifunctionalcurler/box-4_ver1.jpg" class="img-my-top">
        </div>
        <div class="img-toptop">
            <div class="main-text">
                <div class="box__body-text">
