...
<style>
    @media (min-width:768px) {
        .section-1 {
            background: url({{ asset('/') }}purplerelaxFiles/powerfloss/jaderollerbanner_dt.png) bottom right 47%/cover no-repeat
        }
    }
    @media (max-width:767px) {
        .common-block .item-1 {
            ...
            text-align: center;
            background: url({{ asset('/') }}purplerelaxFiles/powerfloss/jaderoller4_mb.png) bottom center/cover no-repeat
        }
        .block-1 .item-1 {
            margin: 0 -15px 20px;
            padding: 30px 15px 80%;
            text-align: center;
            background: url({{ asset('/') }}purplerelaxFiles/powerfloss/jaderollerbanner_mb.png) bottom center/100% no-repeat
        }
    }
    @media (min-width:768px) {
        .section-9 {
            background: url({{ asset('/') }}purplerelaxFiles/powerfloss/jaderoller4_dt.png) center right 47%/cover no-repeat
        }
    }
    @media (max-width:767px) {
        .foot-block .item-1 {
                        ...
                        <div class="w_item ">
                            <div class="w_content_wrap">
                                <div class="w_desc">
                                    ...
                                    <p><a class="btn" href="{{$checkoutView}}">PORUČI SVOJ POWER FLOSS</a></p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="block-2 ">
                <div class="w_outer">
                    <div class="w_inner">
                        <div class="w_item ">
                            <div class="w_thumb">
                                <img src="{{ asset('/') }}purplerelaxFiles/powerfloss/jaderoller1.png" alt="product1" class="img-view">
                            </div>
                            <div class="w_content_wrap">
                                <div class="w_desc">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Nijedno sredstvo do sada nije bilo toliko efikasno kao Power Floss, zahvaljujući kome ćete održati
                                        ...
                                        <li>
                                            ...
                                            Power Floss će konačno rešiti taj problem.
                                        </li>
                                        <li>
                                            <strong>
    ...
    <section class="section-4">
        <div class="container">
            <div class="ct_image_wrap ">
                <picture>
                    <source media="(max-width: 767px)" srcset="{{ asset('/') }}purplerelaxFiles/powerfloss/jaderoller2_mb.png" class="no-lazy">
                    <img src="{{ asset('/') }}purplerelaxFiles/powerfloss/jaderoller2_dt.png" alt="product2" class="no-lazy">
                </picture>
            </div>
        </div> <!--/container-->
    </section> <!-- /row-wrapper-->
            ...
            <div class="block-3 ">
                <div class="w_outer">
                    <div class="w_inner">
                        <div class="w_item ">
                            <div class="w_thumb">
                                <img src="{{ asset('/') }}purplerelaxFiles/powerfloss/jaderoller3.png" alt="product3" class="img-view">
                            </div>
                            <div class="w_content_wrap">
                                <div class="w_desc">
                                    <h2 style="text-transform: uppercase;">DO BELIH I ČISTIH ZUBA I ZDRAVIH DESNI NA BRZ I EFIKASAN NAČIN</h2>
                                    <p>Za razliku od većine proizvoda koji se mogu nabaviti u apotekama, Power Floss je do sada najbolji i efikasniji. Ne može se kupiti
    ...
    <section class="section-6">
        <div class="container">
            <div class="wysiwyg-content block-4 ">
                ...
                <p style="text-align: center;"><a class="btn" href="{{$checkoutView}}">PORUČI SVOJ POWER FLOSS</a></p>
            </div>
        </div> <!--/container-->
    </section> <!-- /row-wrapper-->
                    ...
                    <div class="w_inner">
                        ...
                        <div class="w_item ">
                            <div class="w_content_wrap">
                                ...
                                <div class="w_desc">
                                    <p><span class="star" style="color: #993300;">Star</span><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i></p>
                                    <p>Nakon ručka nema potrebe više da koristim čačkalice i da se mučim sa koncem koji mi povređuje desne. Sa ovim čudom izbacim perfektno sve ostatke hrane! Toplo preporučujem ovaj proizvod.</p>
                                </div>
                            </div>
                        </div>
                    </div>
