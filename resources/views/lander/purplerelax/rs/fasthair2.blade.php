        ...
        <div class=banner>
            <div class=b-left>
                <div class=banner-title>
                    <h2>
                        ČETKA ZA BRZO UVIJANJE KOSE - FAST HAIR
                    </h2>
                    <p>
                        Savršeno uvijena kosa za par minuta, bez specijalne pripreme sa Fast Hair četkom
                    </p>
                    <p>
                        Napravite savršenu frizuru sopstvenim rukama, bez gorenja kose
                    </p>
                </div>
                <img alt="" class=banner-img src="{{asset('/')}}purplerelaxFiles/fasthair2/pic1.png"/>
            </div>
            <div class=b-right>
...
<section class=info1>
    <div class=container>
        ...
        <div class=descr>
            ...
            <p>
                Električna četka za brzo uvijanje kose sa jonizirajućim efektom, napravljena je specijalno za žene koje
                ne žele da gube vreme po salonima. Sa ovim uređajem, za samo 5-10 minuta kosa postaje sjajna, glatka i mekana,
                bez gubljenja vremena i novca.
            </p>
            <p>
                Ovo je prva električna četka na tržištu. Kombinuje četku i uvijač za kosu u jednom uređaju tako da možete i da uvijate i da omekšate vašu kosu, jednostavnim četkanjem. Sjajno, zar ne?
            </p>
            <p>
                Četka ima krajeve od turmalina. Kada se zagreje stvaraju se negativni joni koji imaju pozitivan efekat na kosu i čine da ona izgleda lepše i bujnije.
                Takođe zahvaljjujući turmalinskim krajevina, četka se zagreva jednako celom površinom, tako da se kosa ne oštećuje i ne gori.
            </p>
...
<section class=features>
    <div class=container>
        ...
        <div class=descr>
            <ul>
                <li>
                    Za razliku od drugih proizvoda za uvijanje, veoma je laka za upotrebu i ne isušuje kosu pošto radi na nižoj temperaturi
                </li>
                <li>
                ...
                <li>
                    Za uvijanje kose je potrebno samo 5-10 minuta
                </li>
                <li>
        ...
        <div class=b-img>
            <img class=result data-speed=0.2 src="{{asset('/')}}purplerelaxFiles/fasthair2/pic2.jpg"   />
        </div>
    </div>
</section>
<section class=benefits>
    ...
    <img alt="" class=woman-img src="{{asset('/')}}purplerelaxFiles/fasthair2/pic3.jpg"   />
</section>
<section class=how-to-use>
    <div class=container>
        ...
        <div class="row left">
            <div class=b-img>
                <img alt="" src="{{asset('/')}}purplerelaxFiles/fasthair2/pic4.jpg"   />
            </div>
            <div class=b-descr>
                <ul>
                    <li>
            ...
            <div class=b-descr>
                <ul>
                    <li>
                        ...
                        <span>
                            Uvijte kosu prema sopstevnoj želji
                        </span>
                    </li>
                    <li>
                        <i>
        ...
        <div class=reviews-row>
            <div class=reviews-box>
                ...
                <div class=reviews-box-descr>
                    <p>
                        Imam prirodno ravnu kosu, i inače mi treba dosta vremena i još više strpljenja da je učinim talasastom.
                        Slučajno sam videla reklamu za ovu četku, naručila sam i sad mi treba 4-5 minuta i moja kosa je fenomenalna.
                    </p>
                </div>
            </div>
            <div class=reviews-box>
...
<section class=b-order>
    <div class=container>
        <div class=order-img>
            <img alt="" src="{{asset('/')}}purplerelaxFiles/fasthair2/pic1.png"/>
        </div>
