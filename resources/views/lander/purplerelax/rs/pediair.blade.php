...
<head>
    ...
    <style>
        .offer_section {
            padding: 25px 0 40px;
            background: url({{ asset('/') }}purplerelaxFiles/pediair/desctop__offer_bg.png) center top no-repeat;
        }
...
<section class=offer_section>
    <div class=wrapper>
        <h1 class=main_title>PEDI AIR - ZA NEŽNA I LEPA STOPALA</h1>
...
<section class=about_section>
    <div class=wrapper>
        <h2>PEDI AIR JE VRLO JEDNOSTAVAN I PRAKTIČAN ZA KORIŠĆENJE</h2>
...
<section class=benefits_section>
    <div class="wrapper clearfix">
        <h2>PEDI AIR - UREĐAJ NOVE GENERACIJE</h2>
        <div class=benefits_list>
            ...
            <div class=benefit_item>
                ...
                <div class=text_block>
                    <h4>KOMPAKTAN</h4>
                    <p>Pedi Air ne zauzima puno prostora, lako ga možete poneti sa sobom bilo gde</p>
                </div>
            </div>
        </div>
        <div class=order_block>
            <img src="{{ asset('/') }}purplerelaxFiles/pediair/benefits__image.png" alt="PediAir">
            <a href="#order_form" class=button>Poruči odmah</a>
        </div>
    </div>
</section>
<section class=use_steps_section>
    <div class=wrapper>
        <h2>UČINITE STOPALA SAVRŠENO GLATKIM POMOĆU PEDI AIR UREĐAJA U SAMO 3 KORAKA!</h2>
        <div class="steps_list clearfix">
            <div class=step_item>
                <img src="{{ asset('/') }}purplerelaxFiles/pediair/use_steps__step1_image.png" alt="PediAir">
                <h4>KORAK 1</h4>
                <p>Koristite osnovni nastavak za uklanjanje grube kože, zadebljanja i žuljeva</p>
            </div>
            <div class=step_item>
                <img src="{{ asset('/') }}purplerelaxFiles/pediair/use_steps__step2_image.png" alt="PediAir">
                <h4>KORAK 2</h4>
...
<section class=comparison_section>
    <div class=wrapper>
        <h2>PEDI AIR JE NAJBOLJI NAČIN ZA NEGU STOPALA</h2>
        <p class=description>Za razliku od skupih i složenih postupaka u kozmetičkim salonima, <b>Pedi Air je jeftin i potpuno jednostavan za upotrebu.</b>
            U odnosu na kućne tretmane Pedi Air je potpuno praktičan, jer postupak uklanjanja grube kože traje i do <b>5 puta kraće.</b></p>
        <div class="products_list owl-carousel">
            <div class="product_item first">
                <h4>UREĐAJ<br>PEDI AIR</h4>
                <div class=image_block>
                    <img src="{{ asset('/') }}purplerelaxFiles/pediair/comparison__product1_image.png" alt="PediAir">
                </div>
                <ul>
...
<section class=opinion_section>
    <div class="wrapper clearfix">
        ...
        <div class=text_block>
            ...
            <p>Već dugo preporučujemo "Pedi Air". <b>Jedinstvenost ovog uređaja leži u činjenici da se učinkovito uklanjanju mrtve ćelije kože bezbolno i za vrlo kratko vreme.</b></p>
            <p>Pedi Air je u stanju da se izbori čak i sa kurijim očima, bez uklanjanja zamrzavanjem i ostalim laserskim i hirurškim procedurama.</p>
    ...
    <div class=wrapper>
        ...
        <div class="reviews_list owl-carousel">
            <div class=review_item>
                <img src="{{ asset('/') }}purplerelaxFiles/pediair/review1.png" alt="PediAir">
            ...
            <div class=review_item>
                <img src="{{ asset('/') }}purplerelaxFiles/pediair/review2.png" alt="PediAir">
            ...
            <div class=review_item>
                <img src="{{ asset('/') }}purplerelaxFiles/pediair/review3.png" alt="PediAir">
                <div class=author_info>Natalija, 61 godina</div>
                <p>Pete su mi bile ukočene i ispucale, ali Pedi Air mi je rešio problem.
...
<section class=order_section>
    <div class=title_block>
        <div class=wrapper>
            <h4>Naručite Pedi Air po promotivnoj ceni, akcija može trajati još samo malo!</h4>
        </div>
    </div>
