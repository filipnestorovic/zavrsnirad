...
<section class="section-10">
    <div class="container">
        <div class="floating-bar floating-top floating-ft" data-class=".button-m" data-ticktopelm=".offer_section" data-tickbottomelm="">
            <div class="container">
                <div class="inner">
        ...
        <style>
            .btn,
            .floating-bar .floating-desc .right-ft a {
