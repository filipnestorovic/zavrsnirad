...
<header class="header">
    <div class="wrapper">
        <h1 class="header__title">DIFUMAN - WATER SHINE</h1>
        <div class="sale">
...
<main>
    <section class="sect1">
        <img src="{{ asset('/') }}purplerelaxFiles/difuman/top.png" alt class="sect1__img">
        <div class="txt">
            <div class="txt__text">
        ...
        <div class="price">
            <div class="price__old">
                <p style="font-size: 24px;">Redovna cena:</p>
                {{ $prices[1]['originalPrice'] }}
                {{ $prices[1]['currency'] }}
            </div>
            <div class="price__new">
                <p style="font-size: 24px;">Cena sada:</p>
                {{ $prices[1]['amount'] }}
                {{ $prices[1]['currency'] }}
            </div>
        </div>
    ...
    <section class="sect3">
        <img src="{{ asset('/') }}purplerelaxFiles/difuman/middle.png" alt class="sect3__img">
        <div class="sect3__txt">
            <div class="sect3__txt__text">
                DIFUMAN WATER SHINE <br/> TO JE ONO <br/> ŠTO VAM TREBA
            </div>
        </div>
        <div class="wrapper">
            <p>
    ...
    <section class="sect5">
        <img src="{{ asset('/') }}purplerelaxFiles/difuman/bottom.png" alt class="sect1__img">
        <div class="txt">
            <div class="txt__text">
                <span class="txt__text-bold">Puder za sjajno i podmlađeno lice</span>
                <br>
