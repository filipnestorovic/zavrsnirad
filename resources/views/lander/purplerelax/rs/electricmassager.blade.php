...
<div class="wrap">
    ...
    <section class="b1">
        <h1> ELECTRIC <span>MASSAGER</span></h1>
    ...
    <section class="b2">
        ...
        <p>Electric Massager je inteligentni vibracioni masažer koji deluje električnim impulsima poboljšavajući
        ...
        <p>Electric Massager <b>brzo ublažava napetost, bol i umor, kod kuće, u kancelariji ili na putovanju.</b>
    ...
    <section class="b3 gradient">
        ...
        <div class="best__item">
            ...
            <p><b>POGODAN I KOMPAKTAN</b>
                Ne zauzima mnogo prostora, napaja se na usb ili na baterije, tako da ga možete poneti sa sobom gde god da krenete.
            </p>
        </div>
        <a href="#order_form" class="btn">PORUČITE ODMAH</a>
    </section>
    ...
    <section class="b8 gradient">
        ...
        <div class="reviews__item">
            ...
            <p><b>Vrat me je dugo boleo, ponekad bolovi nisu ni prestajali.</b>
                ...
                Prijatelji su mi preporučili kupovinu Electric Massagera. Koristim ga više od mesec dana,
        ...
        <div class="reviews__item">
            ...
            <p>Electric Massager je jeftin, a donosi mnogo zadovoljstva i koristi! Patio sam od bolova u leđima,
