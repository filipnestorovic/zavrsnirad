...
<head>
    ...
    <style>
        .b1 {
            padding: 0 0 10px;
            background: #f8faf5 url({{ asset('/') }}purplerelaxFiles/joyout/offer.jpg) no-repeat center 139px;
            position: relative;
        }
        ...
        .use li:nth-child(1) {
            background: #fff url({{ asset('/') }}purplerelaxFiles/joyout/use1.jpg) no-repeat 0 -5px;
            padding: 30px 0px 30px 240px;
        }

        .use li:nth-child(2) {
            background: #fff url({{ asset('/') }}purplerelaxFiles/joyout/use2.jpg) no-repeat right -10px;
            padding: 15px 240px 13px 0;
        }

        .use li:nth-child(3) {
            background: #fff url({{ asset('/') }}purplerelaxFiles/joyout/use3.jpg) no-repeat 0 0;
            padding: 30px 0px 21px 240px;
        }

        .use li:nth-child(4) {
            background: #fff url({{ asset('/') }}purplerelaxFiles/joyout/use4.jpg) no-repeat right -10px;
...
<div class="wrap">
    ...
    <section class="b1">
        <h1> JOY <span>OUT</span></h1>
        <h2 class="gradient">Vibracioni masažer <br> za celo telo</h2>
    ...
    <section class="b2">
        ...
        <img src="{{ asset('/') }}purplerelaxFiles/joyout/b2.jpg" alt>
        <p>Joy Out je inteligentni vibracioni masažer koji deluje električnim impulsima poboljšavajući
            mikrocirkulaciju krvi.
            <b>Elektro impulsi pokreću mišiće, normalizuju cirkulaciju krvi, zasićuju ćelije i tkiva kiseonikom i
                pozitivno utiču na nervni sistem.</b></p>
        <p>Joy Out <b>brzo ublažava napetost, bol i umor, kod kuće, u kancelariji ili na putovanju.</b>
            Istovremeno, dobićete prijatnu, duboku i opuštajuću masažu,
    ...
    <section class="b3 gradient">
        ...
        <div class="best__item">
            <img src="{{ asset('/') }}purplerelaxFiles/joyout/best1.jpg" alt>
            <p><b>20 PROGRAMA MASAŽE I 8 BRZINA</b>
                Omogućavaju vam da prilagodite udoban režim masaže, pogodan za svaku priliku
            </p>
        </div>
        <div class="best__item">
            <img src="{{ asset('/') }}purplerelaxFiles/joyout/best2.jpg" alt>
            <p><b>DUBINSKO PRODIRANJE U MIŠIĆE</b>
                Električni impulsi duboko prodiru u mišiće i u potpunosti ih pokreću
            </p>
        </div>
        <div class="best__item">
            <img src="{{ asset('/') }}purplerelaxFiles/joyout/best3.jpg" alt>
            <p><b>UNIVERZALAN</b>
                Za masažu bilo kog dela tela: ramena, leđa, noge, ruke, bokovi
            </p>
        </div>
        <div class="best__item">
            <img src="{{ asset('/') }}purplerelaxFiles/joyout/best4.jpg" alt>
            <p><b>POGODAN I KOMPAKTAN</b>
                Ne zauzima mnogo prostora i puni se na USB, tako da ga možete poneti sa sobom gde god da krenete.
            </p>
        </div>
        <a href="#order_form" class="btn">PORUČITE ODMAH</a>
    </section>
    <section class="b4">
        <h2 class="title"><span>Kome treba</span><br> Joy Out?</h2>
        <p>Zahvaljujući svojoj svestranosti, Joy Out preporučuje se svima ali je posebno koristan za sledeće
            kategorije ljudi:</p>
        <div class="body">
    ...
    <section class="b5 gradient">
        ...
        <img src="{{ asset('/') }}purplerelaxFiles/joyout/body_grad.jpg" alt>
        <p>JoyOut masažer efikasno ublažava bol u mišićima: <b>kod modrica, grčeva, uganuća, a doprinose i njihovom jačanju.</b>
    ...
    <section class="b6">
        ...
        <ul class="use">
            ...
            <li><span>4</span> Možete da odaberete brzinu i intenzitet <br> koji vam odgovara</li>
        </ul>
        <a href="#order_form" class="btn">PORUČITE MASAŽER</a>
    </section>
    <section class="b7">
        <h2 class="title"><span>SPECIFIKACIJA</span> PROIZVODA</h2>
        <img src="{{ asset('/') }}purplerelaxFiles/joyout/char.jpg" alt>
        <ul class="char">
            <li><b> Joy Out </b> <span> 1 komad</span></li>
            <li><b> Kabl za punjenje </b> <span> 1 komad</span></li>
            <li><b> Uputstvo </b> <span> 1 komad</span></li>
            <li><b> Način masaže </b> <span> 20 režima</span></li>
            <li><b> Nivoi brzina </b> <span> 8</span></li>
        </ul>
        <a href="#order_form" class="btn">PORUČITE ODMAH</a>
    </section>
    <section class="b8 gradient">
        ...
        <div class="reviews__item">
            <img src="{{ asset('/') }}purplerelaxFiles/joyout/rev1.jpg" alt>
            <p><b>Vrat me je dugo boleo, ponekad bolovi nisu ni prestajali.</b>
                ...
                Prijatelji su mi preporučili kupovinu Joy Outa. Koristim ga više od mesec dana,
                par puta dnevno po nekoliko minuta i imama znatno olakšanje, super se osećam.</p>
            <div class="person">
        ...
        <div class="reviews__item">
            <img src="{{ asset('/') }}purplerelaxFiles/joyout/rev2.jpg" alt>
            <p>Joy Out masažer je jeftin, a donosi mnogo zadovoljstva i koristi! Patio sam od bolova u leđima,
                pa sam počeo da koristim ovaj masažer. <b>Pre kupovine sam sumnjao, ali sada vidim
                    da je u pitanju jedan odličan proizvod.</b> Opušta i ne stvara neprijatnosti. Ovo svakome
                preporučujem!</p>
            <div class="person">
        ...
        <div class="reviews__item">
            <p>Veoma korisna stvar u automobilu, <b>posebno kada idem na duge relacije.</b> Uvek ga nosim sa sobom, vrlo
                je praktičan i lako se koristi.
                Nisam verovala da za tako malo novca mogu dobiti ovako dobar efekat.</p>
            <div class="person">
                <img src="{{ asset('/') }}purplerelaxFiles/vratnimasazermobile/ava1.jpg" alt>
                <p>Anđela<br> Beograd</p>
            </div>
        </div>
        <a href="#order_form" class="btn">PORUČITE SA POPUSTOM</a>
    </section>
    <section class="b9">
        ...
        <ul class="delivery">
            ...
            <li>
                ...
                <p><b>100% garancija kvaliteta</b> Proizvod se pakuje u diskretno pakovanje i garantujemo za kvalitet</p>
            </li>
        </ul>
    </section>
