...
<header>
    <div class="header-body">
        <div class="header-pack">
            <div class="header-pack-body"><img src="{{ asset('/') }}purplerelaxFiles/jaysuingcream/header-pack.png"
                                               alt=""/></div>
        ...
        <div class="header-info">
            <div class="header-head">
                ...
                <div class="header-text">
                    <p><span>KREMA "JAYSUING" <br>ZA VEČNU MLADOST </span>
                        <br>
...
<div class="main">
    <div class="strong-block">
        <div class="strong-block-note">
            <div class="sbn-name">
                <h2><span>U ČEMU JE TAJNA</span> JAYSUING KREME?</h2>
            </div>
            <div class="sbn-img">
        ...
        <div class="strong-block-text">
            <img src="{{ asset('/') }}purplerelaxFiles/jaysuingcream/header-pack.png" alt=""/>
            ...
            <p>JAYSUING KREMA ne samo da će momentalno izgladiti mimičke bore, već će i sprečiti pojavu novih zbog kumulativnog
                efekta.
                Nanesite JAYSUING KREMA na problematična područja i ostvarite vidljive rezultate za samo 5 dana!</p>
        </div>
    </div>
    <div class="pay-block">
        <div class="pay-block-name">
            <h2>
                ...
                <p>Instant JAYSUING krema brzo i bezbolno uklanja bore sa lica!</p>
            </h2>
        </div>
        <div class="pay-block-info">
            <div class="pay-block-video"><img style="max-width: 100%"
                                              src="{{ asset('/') }}purplerelaxFiles/jaysuingcream/header-pack.png" alt=""/>
            </div>
    ...
    <div class="contrast-block">
        <div class="contrast-block-body">
            <div class="contrast-block-name">
                <h2>PO ČEMU SE <span>RAZLIKUJE</span> JAYSUING KREMA OD DRUGIH PROIZVODA?</h2>
            </div>
            <div class="contrast-block-info">
                <div class="contrast-block-text">
                    <p>
                        Formula inovativne kreme JAYSUING KREMA rezultat je dugogodišnjeg istraživanja. Zasnovana je na <span>potpuno prirodnim sastojcima i vitaminima.</span>
                        Zahvaljujući tome JAYSUING KREMA <span>zaglađuje bore i trajno eliminiše uzrok starenja kože preokretom autoimunih procesa.</span>
                    </p>
                    <p>
                ...
                <div class="contrast-block-img"><img src="{{ asset('/') }}purplerelaxFiles/jaysuingcream/header-pack.png"
                                                     alt=""/></div>
            </div>
    ...
    <div class="feedback">
        <div class="feedback-name">
            <h2><span>Utisci žena</span> koje su već koristile JAYSUING kremu</h2>
        </div>
        <div class="owl-carousel owl-theme">
            <div class="item">
                ...
                <div class="feed-text">
                    ...
                    <p>Krema JAYSUING je fenomenalna, prosto sam zadivljena!
            ...
            <div class="item">
                ...
                <div class="feed-text">
                    ...
                    <p>Volim kada kozmetika ne samo obećava već i radi! JAYSUING KREMA vidno zaglađuje bore, eliminiše tamne
    ...
    <div class="take-block">
        <div class="take-block-name">
            <h2><span>Kako naneti</span> JAYSUING kremu?</h2>
        </div>
        <div class="take-block-list">
            <ul>
                ...
                <li id="t2">
                    ...
                    <div class="tbl-info">
                        <h3>NANETI KREMU</h3>
                        <p>Nanesite JAYSUING kremu po celom licu i dekolteu</p>
                    </div>
                </li>
                <li id="t3">
    ...
    <div class="order-block">
        <div class="order-block-name">
            <h2><span>Kako poručiti</span> JAYSUING kremu?</h2>
        </div>
    ...
    <div class="header-body">
        ...
        <div class="header-info">
            <div class="header-head">
                ...
                <div class="header-text">
                    <p><span>KREMA "JAYSUING" ZA VEČNU MLADOST</span>
                        <br>
