                    ...
                    <div class="p_and_count">
                        <div class="price">
                            <div class="old_price">
                                ...
                                <div class="numb">
                                    {{ $prices[1]['originalPrice'] }}<span class="cur"> KM</span>
                                </div>
                            </div>
                            <div class="new_price">
                                <div class="title">
                                ...
                                <div class="numb">
                                    {{ $prices[1]['amount'] }}<span class="cur"> KM</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="leika">
            <div class="container">
                ...
                <div class="leika_block">
                    ...
                    <div class="text">
                        <p>Da li su vam koža i kosa previše suvi? Stižu vam veliki računi za vodu? Ovi problemi mogu da imaju isti uzrok i vrijeme je da učinite nešto po tom pitanju.
                        ...
                        <p class="white"><b>Zahvaljujući posebnom filteru koji se sastoji od granula turmalina i uglja i 340 sićušnih rupica, </b> glava tuša
                            <b>uklanja teške metale, hrđu i hlor iz vode.</b> Djeluje antibakterijski.</p>
                        <p><b>Jednostavno zavrnite Neoshower tuš bateriju i zauvijek ćete zaboraviti na suvu kožu, neugodan miris vode i zastrašujuće račune za vodu!</b></p>
                ...
                <div class="preim_block">
                    <div class="preim_item">
                        ...
                        <div class="text">
                            ...
                            <p>Idealno za uštedu vode. Pritisak je jači za 200% zahvaljujući inovativnoj strukturi tuš baterije koja posjeduje 2 sloja minerala za prečišćavanje vode.</p>
                        </div>
                    </div>
                    <div class="preim_item preim_item2">
                        ...
                        <div class="text">
                            <b>NJEGUJTE ZDRAVLJE</b>
                            <p>Čini kožu mekšom, smanjuje lučenje sebuma, povećava aktivnost ćelija i spriječava gubitak kose.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="diff_block">
                    <div class="diff_item diff_item1">
                        <b>PRUŽA UŽITAK</b>
                        <p>Snažan protok vode <br>ne iritira kožu i <br> djeluje kao masažer</p>
                    </div>
        ...
        <section class="use">
            <div class="container">
                ...
                <div class="use_item imgItem">
                    ...
                    <p>Ovakav sadržaj ispada iz crijeva starog samo dvije godine.</p>
                </div>
            </div>
        </section>
                ...
                <div class="expert_block">
                    <div class="text">
                        ...
                        <p style="line-height: 26px;">Voda u bojleru vrlo često dugo stoji i pod visokom temperaturom sklona je izuzetno velikom taloženju teških metala i kamenca,
                            kojih svakako ima u visokom procentu u gradskim cjevovodima.
                            Za sve koji nisu sigurni u kvalitet vode iz slavine, preporučujem tuš "Neoshower".</p>
                        <p style="line-height: 30px; padding-top: 10px;">Rješava problem pretjeranog hlorisanja vode, uklanja ostatke rđe iz cijevi i teške metale koji se nalaze u vodi.
                            Pored toga, poseban raspored rupica na tuš bateriji omogućava mlazovima vode da obavljaju masažnu funkciju i na taj način pored prečišćavanja vode, opuštaju i tijelo.</p>
                    </div>
                    <div class="name">
                        <div class="text">
                            <b>Lidija Zvonko</b>
                ...
                <div class="rev_block">
                    <div class="rev_item">
                        ...
                        <div class="text">
                            ...
                            <p>Godinama imam dermatitis. Probala sam kreme za kožu, mijenjala način ishrane, pa čak sam probala i istočnu medicinu, ali pomogao mi je samo ovaj tuš.
                                Sada moja koža nije toliko suha i ne svrbi me, sem kada je izuzetno vruće napolju. I konačno mogu ponovo da trčim!</p>
                        </div>
                    </div>
                    <div class="rev_item">
                        <div class="image">
                        ...
                        <div class="text">
                            ...
                            <p>Kupio sam ovaj tuš jer mi je neko rekao da će mi dosta uštediti na računu za vodu.
                                Bio sam malo skeptičan na početku, ali od kada ga koristimo naš račun za vodu je manji za skoro 40%,
                                tako da se tuš isplatio posle jednog mjeseca.</p>
                        </div>
                    </div>
                    <div class="rev_item">
                        <div class="image">
                        ...
                        <div class="text">
                            ...
                            <p>Nikada nisam imala bolji tuš od ovog! Moja djeca obožavaju da se tuširaju njime, a ja sam primijetila da mi je kosa mekša, kao i koža.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="order_bottom">
                <div class="container">
                    <div class="ob_block">
                        <div class="ob_item">
                            <b>DOSTAVA<br>
                                <span>BILO GDJE U ZEMLJI</span><br>
                                <br class="pvis">
