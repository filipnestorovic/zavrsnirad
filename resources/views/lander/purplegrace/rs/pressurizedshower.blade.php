...
<head>
    ...
    <style>
        .header_bottom {
            padding-top: 55px;
            background: url("{{ asset('/') }}purplegraceFiles/pressurizedshower/main_bg.jpg") no-repeat top center;
            height: 720px;
            position: relative;
            z-index: 2
        }
        ...
        .diff {
            background: url("{{ asset('/') }}purplegraceFiles/pressurizedshower/diff_bg.jpg") no-repeat top center;
            height: 493px
        }
        ...
        @media (max-width: 665px) {
            .header_bottom {
                background: url("{{ asset('/') }}purplegraceFiles/pressurizedshower/main_bg_m.jpg") no-repeat top center;
                height: 1116px;
                padding-top: 20px
            }

            .diff {
                background: url("{{ asset('/') }}purplegraceFiles/pressurizedshower/diff_bg_m.jpg") no-repeat top center;
                height: 820px;
                padding-top: 40px
            }
        ...
        <div class="header_bottom">
            <div class="container">
                <div class="main_title">
                    <h1>SHOWER <br> <span>«PRESSURIZED»</span></h1>
                    <div class="subtitle">
                ...
                <ul class="list">
                    <li>MASAŽNA SILIKONSKA GLAVA</li>
    ...
    <main>
                ...
                <div class="container">
                    <div class="nature_slider">
                        <div class="ns_item"><img alt=""
                                                  src="{{ asset('/') }}purplegraceFiles/pressurizedshower/ns1.jpg">
                        </div>
                        <div class="ns_item"><img alt=""
                                                  src="{{ asset('/') }}purplegraceFiles/pressurizedshower/ns2.jpg">
                        </div>
                        <div class="ns_item"><img alt=""
                                                  src="{{ asset('/') }}purplegraceFiles/pressurizedshower/ns3.jpg">
                        </div>
                        <div class="ns_item"><img alt=""
                                                  src="{{ asset('/') }}purplegraceFiles/pressurizedshower/ns4.jpg">
                        </div>
                        <div class="ns_item"><img alt=""
                                                  src="{{ asset('/') }}purplegraceFiles/pressurizedshower/ns5.jpg">
                        </div>
                        <div class="ns_item"><img alt=""
                                                  src="{{ asset('/') }}purplegraceFiles/pressurizedshower/ns6.jpg">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="leika">
            <div class="container">
                <div class="stitle grey">
                    <h2>
                        Zašto
                        <nobr>«Pressurized Shower Head»?</nobr>
                    </h2>
                </div>
                <div class="leika_block">
                    <img src="{{ asset('/') }}purplegraceFiles/pressurizedshower/leika_img2.png" class="leika_img2"
                         alt="">
                    <img src="{{ asset('/') }}purplegraceFiles/pressurizedshower/leika_img3.png" class="leika_img3"
                         alt="">
                    <div class="text">
                        ...
                        <p class="white">Zahvaljujući <b>inovativnoj glavi tuša</b> možete da pružite sebi vrhunsko uživanje i tuširanje.</p>
                        <p><b>Jednostavno zavrnite <b>Pressurized Shower Head</b> tuš bateriju i zauvek ćete zaboraviti na
                                suvu kožu,
                                neugodno jake mlazove i zastrašujuće račune za vodu!</b></p>
                        <a href="{{$checkoutView}}" class="btn">Poruči odmah</a>
                    </div>
                    <img src="{{ asset('/') }}purplegraceFiles/pressurizedshower/leika_img.png" class="leika_img"
                         alt="">
                </div>
            </div>
        </section>
        <section class="preim">
            <div class="container">
                <div class="stitle blue">
                    <h2>
                        Prednosti dvostranog "Pressurized Shower Head"
                    </h2>
                </div>
                <div class="preim_block">
                    <div class="preim_item">
                        <div class="image">
                            <img src="{{ asset('/') }}purplegraceFiles/pressurizedshower/preim1.png" alt="">
                        </div>
                        <div class="text">
                            <b>PRVA STRANA</b>
                            <p>Pruža prijatan i opuštajući osećaj, masira kožu i čini je lepšom.</p>
                        </div>
                    </div>
                    <div class="preim_item preim_item2">
                        <div class="image">
                            <img src="{{ asset('/') }}purplegraceFiles/pressurizedshower/preim2.png" alt="">
                        </div>
                        <div class="text">
                            <b>DRUGA STRANA</b>
        ...
        <section class="diff">
            <div class="container">
                <div class="stitle">
                    <h2>
                        Savremena tuš baterija <span>«Pressurized Shower Head»</span>
                    </h2>
                </div>
                ...
                <div class="expert_block">
                    <div class="text">
                        ...
                        <p style="line-height: 26px;">Voda u bojleru vrlo često dugo stoji i pod visokom temperaturom
                            ...
                            Za sve koji nisu sigurni u kvalitet vode iz slavine, preporučujem "Pressurized Shower
                            Head".</p>
