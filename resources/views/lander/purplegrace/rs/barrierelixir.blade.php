        ...
        <div class="header-info">
            <div class="header-head">
                ...
                <div class="header-text">
                    <p><span>BARRIER ELIXIR <br>ZA VEČNU MLADOST </span>
                        <br>
...
<div class="main">
    <div class="strong-block">
        <div class="strong-block-note">
            <div class="sbn-name">
                <h2><span>U ČEMU JE TAJNA</span> BARRIER ELIXIRA?</h2>
            </div>
            <div class="sbn-img">
        ...
        <div class="strong-block-text">
            ...
            <p>BARRIER ELIXIR ne samo da će momentalno izgladiti mimičke bore, već će i sprečiti pojavu novih zbog kumulativnog
                efekta.
                Nanesite BARRIER ELIXIR na problematična područja i ostvarite vidljive rezultate za samo 5 dana!</p>
        </div>
    </div>
    <div class="pay-block">
        <div class="pay-block-name">
            <h2>
                ...
                <p>Instant BARRIER ELIXIR brzo i bezbolno uklanja bore sa lica!</p>
            </h2>
        </div>
    ...
    <div class="contrast-block">
        <div class="contrast-block-body">
            <div class="contrast-block-name">
                <h2>PO ČEMU SE <span>RAZLIKUJE</span> BARRIER ELIXIR OD DRUGIH PROIZVODA?</h2>
            </div>
            <div class="contrast-block-info">
                <div class="contrast-block-text">
                    <p>
                        Formula inovativnog BARRIER ELIXIRA zasnovana je na <span>potpuno prirodnim sastojcima i vitaminima.</span>
                        Zahvaljujući tome BARRIER ELIXIR <span>zaglađuje bore i trajno eliminiše uzrok starenja kože preokretom autoimunih procesa.</span>
                    </p>
                    <p>
    ...
    <div class="feedback">
        <div class="feedback-name">
            <h2><span>Utisci žena</span> koje su već koristile BARRIER ELIXIR</h2>
        </div>
        <div class="owl-carousel owl-theme">
            <div class="item">
                ...
                <div class="feed-text">
                    ...
                    <p>BARRIER ELIXIR je fenomenalan, prosto sam zadivljena!
                        Nikada nisam probala ovako nešto. Eliksir hidrira i zateže kožu. Ujutru sam se probula i nanela
                        ...
                        raspoloženje! Hvala vam za ovaj divni eliksir, preporučila sam ga svim
            ...
            <div class="item">
                ...
                <div class="feed-text">
                    ...
                    <p>Volim kada kozmetika ne samo obećava već i radi! BARRIER ELIXIR vidno zaglađuje bore, eliminiše tamne
                        kolutove oko očiju i osvežava ten za 5 minuta!
                        Čudesno eliksir, ovo je čista magija! Koža je elastična, glatka i svilenkasta! Nanosim ga na vrat
            ...
            <div class="item">
                ...
                <div class="feed-text">
                    ...
                    <p>Idealna stvar, nanesite tanak sloj i lice se menja pred vašim očima! Koža postaje zategnuta a
                        ...
                        filere. Svi su u šoku kada kažem da je to rezultat ovog eliksira!
    ...
    <div class="take-block">
        <div class="take-block-name">
            <h2><span>Kako naneti</span> BARRIER ELIXIR?</h2>
        </div>
        <div class="take-block-list">
            <ul>
                ...
                <li id="t2">
                    ...
                    <div class="tbl-info">
                        <h3>NANETI ELIKSIR</h3>
                        <p>Nanesite BARRIER ELIXIR po celom licu i dekolteu</p>
                    </div>
                </li>
                <li id="t3">
                    ...
                    <div class="tbl-info">
                        ...
                        <p>Koristite proizvod 28 dana dok se koža potpuno ne obnovi</p>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="order-block">
        <div class="order-block-name">
            <h2><span>Kako poručiti</span> BARRIER ELIXIR?</h2>
        </div>
    ...
    <div class="header-body">
        ...
        <div class="header-info">
            <div class="header-head">
                ...
                <div class="header-text">
                    <p><span>BARRIER ELIXIR ZA VEČNU MLADOST</span>
                        <br>
