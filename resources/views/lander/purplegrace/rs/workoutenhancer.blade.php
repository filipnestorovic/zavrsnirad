...
<div class="s__main">
    ...
    <section class="block4">
        <div class="wrap">
            <h2 class="title">WORKOUT ENHANCER IDEALAN JE ZA SVE:</h2>
            <ul class="ideal">
                <li>
    ...
    <section class="block5">
        <div class="wrap">
            <h2>ŠTA JE <span>WORKOUT ENHANCER</span></h2>
            <p>
            ...
            <h3>WORKOUT ENHANCER</h3>
        </div>
    </section>
    <section class="gallery">
        <div class="wrap">
            <div class="galleries">
                <div><img alt="" src="{{ asset('/') }}purplegraceFiles/workoutenhancer/g1.jpg"/></div>
                <div><img alt="" src="{{ asset('/') }}purplegraceFiles/workoutenhancer/g2.jpg"/></div>
                <div><img alt="" src="{{ asset('/') }}purplegraceFiles/workoutenhancer/g3.jpg"/></div>
                ...
                <div><img alt="" src="{{ asset('/') }}purplegraceFiles/workoutenhancer/g6.jpg"/></div>
                <div><img alt="" src="{{ asset('/') }}purplegraceFiles/workoutenhancer/g7.jpg"/></div>
    ...
    <section class="block6">
        <div class="wrap">
            <h2 class="title">ŠTA VAM PRUŽA WORKOUT ENHANCER</h2>
            <ul class="what">
                <li>
        ...
        <div class="wrap">
            ...
            <div class="reviews">
                ...
                <div>
                    ...
                    <p>
                        Sveukupno, rezultat ove kreme je iznad mojih očekivanja. Nisam mogao da zamislim da je tako dobro. Kao što vidite, moje telo je doživelo transformaciju. WORKOUT ENHANCER je top stvar!
