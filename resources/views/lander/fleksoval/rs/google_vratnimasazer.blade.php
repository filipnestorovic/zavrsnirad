...
<section class="offer_section">
    <div class="wrapper">
        <h1 class="main_title">
            <span><span class="green">Purple</span> Relax</span> <b>-</b> pulsni masažer za leđa i vrat
        </h1>
        ...
        <div class="action_block">
            <div class="price clearfix">
                <p>Cena:</p>
                <div class="number">
                    <div class="old"><span>{{ $prices[1]['originalPrice'] }}</span><small> {{ $prices[1]['currency'] }}</small>
                    </div>
                    <div class="new"><span>{{ $prices[1]['amount'] }}</span><small> {{ $prices[1]['currency'] }}</small>
                    </div>
                </div>
            </div>
...
<section class="sect3">
    <div class="wrapper">
        ...
        <p class="subtitle">Purple Relax je jednostavan i učinkovit način za otklanjanje napetosti i bola u vratu i leđima!</p>
...
<section class="sect6">
    <div class="wrapper">
        <h2 class="title"><span>3 jednostavna koraka</span> za korišćenje Purple Relax masažera</h2>
...
<section class="sect8">
    <div class="wrapper">
        <h2 class="title">Utisci kupaca kojima je<br> <span>Purple Relax već pomogao</span></h2>
        <div class="reviews owl-carousel">
            <div class="rev_item">
                ...
                <p>Vrat me je dugo boleo, ponekad bolovi nisu ni prestajali.
                    ...
                    Prijateolji su mi preporučili kupovinu Purple Relax pulsnog masažera. Koristim ga više od mesec dana, 2-3 puta dnevno po nekoliko minuta.</p>
            ...
            <div class="rev_item">
                ...
                <p>Pola godine sam išao na masaže, nakon čega sam se osećao bolje ali su se bolovi ubrzo vratili.
                    Tada sam odlučio da poručim Purple Relax. Inačne, mnogo vremena provodim za volanom, a umor i glavobolja su mi bili dosadašnji pratioci.
            ...
            <div class="rev_item">
                ...
                <p>U našoj kancelariji svi obožavaju Purple Relax masažer, i svi su ga poručili. Čak smo i dobili popust na više komada.
...
<section class="sect9">
    <div class="wrapper">
        <h2 class="title">Kako do <span>Purple Relax masažera?</span></h2>
        <ul class="order_list">
            <li>
